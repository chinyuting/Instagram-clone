  ...
  <div class="row mx-0">
    ...
    <!-- stories -->
      <div class="stories overflow-scroll w-md-75 mx-auto flex-nowrap mt-md-2 position-relative">
        ...
        <!-- 向左按鈕 傳入1 -->
        <button type="button" class="position-absolute top-50 start-0 translate-middle-y btn" @click.prevent="positionCount(1)" v-if="isShownToLeft">
        ...
        @click.prevent="positionCount(-1)" v-if="isShownToRight ">
