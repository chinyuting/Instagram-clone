import{f as me,h as zc,s as Gc,r as ae,j as Kc,_ as la,o as ni,k as ca,a as $,c as H,b,p as oe,m as Or,t as Mn,i as ua,v as ha,l as Qt,F as Jt,z as da,A as fa,B as ks,w as Un,d as Yc,x as xr,C as Qc,e as Ns,D as Lr,E as Jc}from"./index-zt3WAD09.js";var Mr={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function n_(n,e,t){let s=1,i=null,r=null,o=!1,a=0;function l(){return a===2}let c=!1;function h(...y){c||(c=!0,e.apply(null,y))}function u(y){i=setTimeout(()=>{i=null,n(f,l())},y)}function d(){r&&clearTimeout(r)}function f(y,...E){if(c){d();return}if(y){d(),h.call(null,y,...E);return}if(l()||o){d(),h.call(null,y,...E);return}s<64&&(s*=2);let g;a===1?(a=2,g=0):g=(s+Math.random())*1e3,u(g)}let _=!1;function v(y){_||(_=!0,d(),!c&&(i!==null?(y||(a=2),clearTimeout(i),u(0)):y||(a=1)))}return u(0),r=setTimeout(()=>{o=!0,v(!0)},t),v}function s_(n){n(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
