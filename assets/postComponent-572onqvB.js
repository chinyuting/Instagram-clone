import{f as _e,h as qa,s as za,r as oe,j as Ga,_ as Or,o as rs,k as Pr,a as B,c as W,b as C,p as re,m as bi,t as sn,i as Mr,v as Lr,l as Tt,F as It,z as Fr,A as Ur,B as Mn,w as rn,d as Ka,x as Ci,C as Ya,e as Ln,D as wi}from"./index-BCj194DL.js";var Ti={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qr=function(n){let e={},t={},s={},i="";try{const r=n.split(".");e=Dt(os(r[0])||""),t=Dt(os(r[1])||""),i=r[2],s=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:s,signature:i}},dl=function(n){const e=Qr(n),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},fl=function(n){const e=Qr(n).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var H;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(H||(H={}));const bl={debug:H.DEBUG,verbose:H.VERBOSE,info:H.INFO,warn:H.WARN,error:H.ERROR,silent:H.SILENT},Cl=H.INFO,wl={[H.DEBUG]:"log",[H.VERBOSE]:"log",[H.INFO]:"info",[H.WARN]:"warn",[H.ERROR]:"error"},Tl=(n,e,...t)=>{if(e<n.logLevel)return;const s=new Date().toISOString(),i=wl[e];if(i)console[i](`[${s}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Xr{constructor(e){this.name=e,this._logLevel=Cl,this._logHandler=Tl,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in H))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?bl[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,H.DEBUG,...e),this._logHandler(this,H.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,H.VERBOSE,...e),this._logHandler(this,H.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,H.INFO,...e),this._logHandler(this,H.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,H.WARN,...e),this._logHandler(this,H.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,H.ERROR,...e),this._logHandler(this,H.ERROR,...e)}}const Il=(n,e)=>e.some(t=>n instanceof t);let Ni,Ri;function Sl(){return Ni||(Ni=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Nl(){return Ri||(Ri=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Jr=new WeakMap,ls=new WeakMap,Zr=new WeakMap,Fn=new WeakMap,ks=new WeakMap;function Rl(n){const e=new Promise((t,s)=>{const i=()=>{n.removeEventListener("success",r),n.removeEventListener("error",o)},r=()=>{t(De(n.result)),i()},o=()=>{s(n.error),i()};n.addEventListener("success",r),n.addEventListener("error",o)});return e.then(t=>{t instanceof IDBCursor&&Jr.set(t,n)}).catch(()=>{}),ks.set(e,n),e}function Al(n){if(ls.has(n))return;const e=new Promise((t,s)=>{const i=()=>{n.removeEventListener("complete",r),n.removeEventListener("error",o),n.removeEventListener("abort",o)},r=()=>{t(),i()},o=()=>{s(n.error||new DOMException("AbortError","AbortError")),i()};n.addEventListener("complete",r),n.addEventListener("error",o),n.addEventListener("abort",o)});ls.set(n,e)}let cs={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return ls.get(n);if(e==="objectStoreNames")return n.objectStoreNames||Zr.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return De(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function kl(n){cs=n(cs)}function Dl(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const s=n.call(Un(this),e,...t);return Zr.set(s,e.sort?e.sort():[e]),De(s)}:Nl().includes(n)?function(...e){return n.apply(Un(this),e),De(Jr.get(this))}:function(...e){return De(n.apply(Un(this),e))}}function xl(n){return typeof n=="function"?Dl(n):(n instanceof IDBTransaction&&Al(n),Il(n,Sl())?new Proxy(n,cs):n)}function De(n){if(n instanceof IDBRequest)return Rl(n);if(Fn.has(n))return Fn.get(n);const e=xl(n);return e!==n&&(Fn.set(n,e),ks.set(e,n)),e}const Un=n=>ks.get(n);function Ol(n,e,{blocked:t,upgrade:s,blocking:i,terminated:r}={}){const o=indexedDB.open(n,e),a=De(o);return s&&o.addEventListener("upgradeneeded",l=>{s(De(o.result),l.oldVersion,l.newVersion,De(o.transaction),l)}),t&&o.addEventListener("blocked",l=>t(l.oldVersion,l.newVersion,l)),a.then(l=>{r&&l.addEventListener("close",()=>r()),i&&l.addEventListener("versionchange",c=>i(c.oldVersion,c.newVersion,c))}).catch(()=>{}),a}const Pl=["get","getKey","getAll","getAllKeys","count"],Ml=["put","add","delete","clear"],Bn=new Map;function Ai(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(Bn.get(e))return Bn.get(e);const t=e.replace(/FromIndex$/,""),s=e!==t,i=Ml.includes(t);if(!(t in(s?IDBIndex:IDBObjectStore).prototype)||!(i||Pl.includes(t)))return;const r=async function(o,...a){const l=this.transaction(o,i?"readwrite":"readonly");let c=l.store;return s&&(c=c.index(a.shift())),(await Promise.all([c[t](...a),i&&l.done]))[0]};return Bn.set(e,r),r}kl(n=>({...n,get:(e,t,s)=>Ai(e,t)||n.get(e,t,s),has:(e,t)=>!!Ai(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ll{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Fl(t)){const s=t.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(t=>t).join(" ")}}function Fl(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const us="@firebase/app",ki="0.10.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bc(n){xt(new ot("platform-logger",e=>new Ll(e),"PRIVATE")),xt(new ot("heartbeat",e=>new yc(e),"PRIVATE")),Oe(us,ki,n),Oe(us,ki,"esm2017"),Oe("fire-js","")}bc("");var Cc="firebase",wc="10.11.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fn(){return{value:null,children:new Map}}function Uo(n,e,t){if(P(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const s=D(e);n.children.has(s)||n.children.set(s,fn());const i=n.children.get(s);e=V(e),Uo(i,e,t)}}function gs(n,e,t){n.value!==null?t(e,n.value):Uu(n,(s,i)=>{const r=new F(e.toString()+"/"+s);gs(i,r,t)})}function Uu(n,e){n.children.forEach((t,s)=>{e(s,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class de{constructor(e,t){this.bucket=e,this.path_=t}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,t){let s;try{s=de.makeFromUrl(e,t)}catch{return new de(e,"")}if(s.path==="")return s;throw qd(e)}static makeFromUrl(e,t){let s=null;const i="([A-Za-z0-9.\\-_]+)";function r(I){I.path.charAt(I.path.length-1)==="/"&&(I.path_=I.path_.slice(0,-1))}const o="(/(.*))?$",a=new RegExp("^gs://"+i+o,"i"),l={bucket:1,path:3};function c(I){I.path_=decodeURIComponent(I.path)}const h="v[A-Za-z0-9_]+",u=t.replace(/[.]/g,"\\."),d="(/([^?#]*).*)?$",f=new RegExp(`^https?://${u}/${h}/b/${i}/o${d}`,"i"),p={bucket:1,path:3},y=t===ba?"(?:storage.googleapis.com|storage.cloud.google.com)":t,E="([^?#]*)",v=new RegExp(`^https?://${y}/${i}/${E}`,"i"),m=[{regex:a,indices:l,postModify:r},{regex:f,indices:p,postModify:c},{regex:v,indices:{bucket:1,path:2},postModify:c}];for(let I=0;I<m.length;I++){const k=m[I],b=k.regex.exec(e);if(b){const w=b[k.indices.bucket];let A=b[k.indices.path];A||(A=""),s=new de(w,A),k.postModify(s);break}}if(s==null)throw jd(e);return s}}class Xd{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oa(n){if(!n)throw fi()}function Nf(n,e){function t(s,i){const r=Da(n,i,e);return Oa(r!==null),r}return t}function Rf(n,e){function t(s,i){const r=Da(n,i,e);return Oa(r!==null),If(r,i,n.host,n._protocol)}return t}function Pa(n){function e(t,s){let i;return t.getStatus()===401?t.getErrorText().includes("Firebase App Check token is invalid")?i=Wd():i=Bd():t.getStatus()===402?i=Ud(n.bucket):t.getStatus()===403?i=$d(n.path):i=s,i.status=t.getStatus(),i.serverResponse=s.serverResponse,i}return e}function Af(n){const e=Pa(n);function t(s,i){let r=e(s,i);return s.getStatus()===404&&(r=Fd(n.path)),r.serverResponse=i.serverResponse,r}return t}function kf(n,e,t){const s=e.fullServerUrl(),i=mi(s,n.host,n._protocol),r="GET",o=n.maxOperationRetryTime,a=new xa(i,r,Rf(n,t),o);return a.errorHandler=Af(e),a}function Df(n,e){return n&&n.contentType||e&&e.type()||"application/octet-stream"}function xf(n,e,t){const s=Object.assign({},t);return s.fullPath=n.path,s.size=e.size(),s.contentType||(s.contentType=Df(null,e)),s}function Of(n,e,t,s,i){const r=e.bucketOnlyServerUrl(),o={"X-Goog-Upload-Protocol":"multipart"};function a(){let m="";for(let I=0;I<2;I++)m=m+Math.random().toString().slice(2);return m}const l=a();o["Content-Type"]="multipart/related; boundary="+l;const c=xf(e,s,i),h=Sf(c,t),u="--"+l+`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qe{constructor(e,t){this._service=e,t instanceof de?this._location=t:this._location=de.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new Qe(e,t)}get root(){const e=new de(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Aa(this._location.path)}get storage(){return this._service}get parent(){const e=vf(this._location.path);if(e===null)return null;const t=new de(this._location.bucket,e);return new Qe(this._service,t)}_throwIfRoot(e){if(this._location.path==="")throw Qd(e)}}function Lf(n,e,t){n._throwIfRoot("uploadBytes");const s=Of(n.storage,n._location,ka(),new Ae(e,!0),t);return n.storage.makeRequestWithTokens(s,Ma).then(i=>({metadata:i,ref:n}))}function Ff(n){n._throwIfRoot("getDownloadURL");const e=kf(n.storage,n._location,ka());return n.storage.makeRequestWithTokens(e,Ma).then(t=>{if(t===null)throw Kd();return t})}function Uf(n,e){const t=Ef(n._location.path,e),s=new de(n._location.bucket,t);return new Qe(n.storage,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
