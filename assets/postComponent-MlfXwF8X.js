import{f as et,h as JI,s as ZI,r as Ke,j as eC,_ as Dp,o as tc,k as Lp,a as Ne,c as ke,b as V,p as ut,w as ui,z as ao,m as _o,t as lo,i as Mp,v as Up,l as co,F as Pr,A as Fp,B as Bp,C as lf,d as tC,x as nC,D as iC,e as Nl}from"./index-j_l0GbQq.js";var cf={};/**
 * @license
 ...
 */const Xk=5*60,Jk=Kp("authIdTokenMaxAge")||Xk;let bp=null;const Zk=n=>async e=>{const t=e&&await e.getIdTokenResult(),r=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(r&&r>Jk)return;const o=t==null?void 0:t.token;bp!==o&&(bp=o,await fetch(n,{method:o?"POST":"DELETE",headers:o?{Authorization:`Bearer ${o}`}:{}}))};function eO(n=xc()){const e=Ho(n,"auth");if(e.isInitialized())return e.getImmediate();const t=O1(n,{popupRedirectResolver:Kk,persistence:[rk,z1,om]}),r=Kp("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const a=new URL(r,location.origin);if(location.origin===a.origin){const c=Zk(a.toString());$1(t,c,()=>c(t.currentUser)),H1(t,h=>c(h))}}const o=qp("auth");return o&&P1(t,`http://${o}`),t}function tO(){var n,e;return(e=(n=document.getElementsByTagName("head"))===null||n===void 0?void 0:n[0])!==null&&e!==void 0?e:document}A1({loadJS(n){return new Promise((e,t)=>{const r=document.createElement("script");r.setAttribute("src",n),r.onload=e,r.onerror=o=>{const a=Zt("internal-error");a.customData=o,t(a)},r.type="text/javascript",r.charset="UTF-8",tO().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Qk("Browser");const nO={apiKey:"AIzaSyD1bUd4QHmDnXtuA1SZgvxiaRcmuEVLpWo",authDomain:"instagram-imitation-180e8.firebaseapp.com",databaseURL:"https://instagram-imitation-180e8-default-rtdb.firebaseio.com",projectId:"instagram-imitation-180e8",storageBucket:"instagram-imitation-180e8.appspot.com",messagingSenderId:"266282768545",appId:"1:266282768545:web:07dbf92d25e2a93b3078e0"},ra=e_(nO),Ax=eO(ra),Xr=HR(ra);Dg(ra);const iO="/Instagram-Imitation/assets/Instagram_logo_light-WGj1KLTg.png";var fm={exports:{}},so={exports:{}};/*!
  ...
  * Copyright 2011-2022 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
  */(function(n,e){(function(t,r){n.exports=r(Xn(),as(),Ru(),rO(),oO(),aO(),lO(),cO())})(et,function(t,r,o,a,c,h,d,p){const y=nn=>nn&&typeof nn=="object"&&"default"in nn?nn:{default:nn},v=y(r),b=y(o),C=y(a),A=y(c),U=y(h),P=y(d),Y="modal",B=".bs.modal",L=".data-api",q="Escape",x=`hide${B}`,D=`hidePrevented${B}`,$=`hidden${B}`,J=`show${B}`,me=`shown${B}`,ve=`resize${B}`,R=`click.dismiss${B}`,z=`mousedown.dismiss${B}`,Z=`keydown.dismiss${B}`,Ae=`click${B}${L}`,be="modal-open",Ie="fade",Pe="show",Mt="modal-static",Tn=".modal.show",$e=".modal-dialog",sa=".modal-body",oa='[data-bs-toggle="modal"]',aa={backdrop:!0,focus:!0,keyboard:!0},Sn={backdrop:"(boolean|string)",focus:"boolean",keyboard:"boolean"};class St extends A.default{constructor(ue,Oe){super(ue,Oe),this._dialog=b.default.findOne($e,this._element),this._backdrop=this._initializeBackDrop(),this._focustrap=this._initializeFocusTrap(),this._isShown=!1,this._isTransitioning=!1,this._scrollBar=new C.default,this._addEventListeners()}static get Default(){return aa}static get DefaultType(){return Sn}static get NAME(){return Y}toggle(ue){return this._isShown?this.hide():this.show(ue)}show(ue){this._isShown||this._isTransitioning||v.default.trigger(this._element,J,{relatedTarget:ue}).defaultPrevented||(this._isShown=!0,this._isTransitioning=!0,this._scrollBar.hide(),document.body.classList.add(be),this._adjustDialog(),this._backdrop.show(()=>this._showElement(ue)))}hide(){!this._isShown||this._isTransitioning||v.default.trigger(this._element,x).defaultPrevented||(this._isShown=!1,this._isTransitioning=!0,this._focustrap.deactivate(),this._element.classList.remove(Pe),this._queueCallback(()=>this._hideModal(),this._element,this._isAnimated()))}dispose(){for(const ue of[window,this._dialog])v.default.off(ue,B);this._backdrop.dispose(),this._focustrap.deactivate(),super.dispose()}handleUpdate(){this._adjustDialog()}_initializeBackDrop(){return new U.default({isVisible:!!this._config.backdrop,isAnimated:this._isAnimated()})}_initializeFocusTrap(){return new P.default({trapElement:this._element})}_showElement(ue){document.body.contains(this._element)||document.body.append(this._element),this._element.style.display="block",this._element.removeAttribute("aria-hidden"),this._element.setAttribute("aria-modal",!0),this._element.setAttribute("role","dialog"),this._element.scrollTop=0;const Oe=b.default.findOne(sa,this._dialog);Oe&&(Oe.scrollTop=0),t.reflow(this._element),this._element.classList.add(Pe);const vt=()=>{this._config.focus&&this._focustrap.activate(),this._isTransitioning=!1,v.default.trigger(this._element,me,{relatedTarget:ue})};this._queueCallback(vt,this._dialog,this._isAnimated())}_addEventListeners(){v.default.on(this._element,Z,ue=>{if(ue.key===q){if(this._config.keyboard){ue.preventDefault(),this.hide();return}this._triggerBackdropTransition()}}),v.default.on(window,ve,()=>{this._isShown&&!this._isTransitioning&&this._adjustDialog()}),v.default.on(this._element,z,ue=>{v.default.one(this._element,R,Oe=>{if(!(this._element!==ue.target||this._element!==Oe.target)){if(this._config.backdrop==="static"){this._triggerBackdropTransition();return}this._config.backdrop&&this.hide()}})})}_hideModal(){this._element.style.display="none",this._element.setAttribute("aria-hidden",!0),this._element.removeAttribute("aria-modal"),this._element.removeAttribute("role"),this._isTransitioning=!1,this._backdrop.hide(()=>{document.body.classList.remove(be),this._resetAdjustments(),this._scrollBar.reset(),v.default.trigger(this._element,$)})}_isAnimated(){return this._element.classList.contains(Ie)}_triggerBackdropTransition(){if(v.default.trigger(this._element,D).defaultPrevented)return;const Oe=this._element.scrollHeight>document.documentElement.clientHeight,vt=this._element.style.overflowY;vt==="hidden"||this._element.classList.contains(Mt)||(Oe||(this._element.style.overflowY="hidden"),this._element.classList.add(Mt),this._queueCallback(()=>{this._element.classList.remove(Mt),this._queueCallback(()=>{this._element.style.overflowY=vt},this._dialog)},this._dialog),this._element.focus())}_adjustDialog(){const ue=this._element.scrollHeight>document.documentElement.clientHeight,Oe=this._scrollBar.getWidth(),vt=Oe>0;if(vt&&!ue){const Kt=t.isRTL()?"paddingLeft":"paddingRight";this._element.style[Kt]=`${Oe}px`}if(!vt&&ue){const Kt=t.isRTL()?"paddingRight":"paddingLeft";this._element.style[Kt]=`${Oe}px`}}_resetAdjustments(){this._element.style.paddingLeft="",this._element.style.paddingRight=""}static jQueryInterface(ue,Oe){return this.each(function(){const vt=St.getOrCreateInstance(this,ue);if(typeof ue=="string"){if(typeof vt[ue]>"u")throw new TypeError(`No method named "${ue}"`);vt[ue](Oe)}})}}return v.default.on(document,Ae,oa,function(nn){const ue=t.getElementFromSelector(this);["A","AREA"].includes(this.tagName)&&nn.preventDefault(),v.default.one(ue,J,Kt=>{Kt.defaultPrevented||v.default.one(ue,$,()=>{t.isVisible(this)&&this.focus()})});const Oe=b.default.findOne(Tn);Oe&&St.getInstance(Oe).hide(),St.getOrCreateInstance(ue).toggle(this)}),p.enableDismissTrigger(St),t.defineJQueryPlugin(St),St})})(fm);var uO=fm.exports;const hO=JI(uO),dO=ZI("userDataList",()=>{const n=Ke(null);async function e(){try{const o=localStorage.getItem("long-lived-access-token"),a=localStorage.getItem("user_id");if(!o||!a)throw new Error("Access token or user ID is missing.");const c=await eC.get(`https://graph.instagram.com/${a}?fields=account_type,id,media_count,username&access_token=${o}`);n.value=c.data,t(c.data.id)}catch(o){console.error("Error fetching user data:",o)}}async function t(o){const a=jr(Xr,"userData");gg(a,async c=>{const h=[];c.forEach(p=>{const y=p.key,v=p.val();h.push({key:y,...v})});const d=h.find(p=>p.id===o);d||await r(o),n.value={...n.value,...d}})}async function r(o){const a=jr(Xr,"userData");if(!n.value){console.error("User data is null.");return}const c={id:o.toString(),media_url:"https://firebasestorage.googleapis.com/v0/b/instagram-imitation-180e8.appspot.com/o/user%2Fkarsten-winegeart-NE0XGVKTmcA-unsplash.jpg?alt=media&token=9f250d7f-e2e5-46fa-bad9-bcae3001951f",username:n.value.username};try{await _g(a,c),console.log("Data successfully written to Firebase!")}catch(h){console.error("Error writing data to Firebase:",h)}}return{userData:n,getUserData:e}}),ls=n=>(Fp("data-v-0fe499d0"),n=n(),Bp(),n),fO=ls(()=>V("button",{type:"button",class:"btn-close btn-close-white position-absolute top-0 end-0 m-3","data-bs-dismiss":"modal","aria-label":"Close"},null,-1)),pO={class:"modal-content my-5"},_O={class:"modal-header d-flex justify-content-center"},gO=ls(()=>V("h5",{class:"modal-title",id:"exampleModalLabel"},"建立新貼文",-1)),mO={class:"d-flex flex-sm-column flex-md-row"},vO=ls(()=>V("i",{class:"bi bi-image pic-icon"},null,-1)),yO=ls(()=>V("span",null,"將相片和影片拖曳到這裡",-1)),wO=ls(()=>V("label",{for:"file-input",class:"file-input-button btn btn-primary m-3"},"從電腦選擇",-1)),EO={key:1,class:"modal-body d-flex flex-column align-items-center input-img-area p-0"},bO=["src"],IO={key:2,class:"border-start p-2 w-100"},CO={class:"d-flex align-self-center align-middle"},TO={class:"rounded-circle user-pic"},SO=["src"],AO={class:"align-middle my-auto ms-2 fw-bold"},RO={__name:"addNewModalComponent",setup(n,{expose:e}){const t=Ke(!1),r=Ke(null),o=Ke(null);e({showModal:function(){r.value.show(),c.value="",A.value=!1,C.value.style.maxWidth="700px",h.value=null}}),tc(()=>{r.value=new hO(o.value)});const c=Ke(null),h=Ke(null),d=function(q){t.value=!0;let x=q;if(h.value=q.files[0],x.files){let D=new FileReader;D.onload=$=>{c.value=$.target.result,t.value=!1},D.readAsDataURL(x.files[0])}},p=Ke(!1),y=q=>{q.dataTransfer.dropEffect="copy",p.value=!0,q.preventDefault()},v=q=>{p.value=!1,q.preventDefault(),console.log("DragLeave")},b=q=>{q.preventDefault(),d(q.dataTransfer)},C=Ke(null),A=Ke(!1),U=function(){A.value===!0?Y():(C.value.style.maxWidth="1000px",A.value=!0)},P=()=>{A.value===!0&&(C.value.style.maxWidth="700px",A.value=!1),c.value=null},Y=async()=>{t.value=!0;const q=h.value;if(!q){console.error("No file selected.");return}const x=Dg(ra),D=ZN(x,"posts/"+q.name);try{await XN(D,q);const $=await JN(D);console.log($),$&&L($)}catch($){t.value=!1,console.error("Error uploading image:",$)}},W=dO(),B=Ke(""),L=function(q){const x=Date.now(),D=jr(Xr,"postsData"),$={caption:B.value,id:x+W.userData.id,isThumb:!1,media_type:"IMAGE",media_url:[q],permalink:"",postownerid:W.userData.id,timestamp:new Date().toISOString(),username:W.userData.username};_g(D,$).then(()=>{console.log("Data successfully written to Firebase!"),r.value.hide(),B.value="",t.value=!1}).catch(J=>{t.value=!1,console.error("Error writing data to Firebase:",J)})};return(q,x)=>{const D=Lp("loading-overlay");return Ne(),ke(Pr,null,[V("div",{class:"modal fade",id:"exampleModal",tabindex:"-1","aria-labelledby":"exampleModalLabel","aria-hidden":"true",ref_key:"addNewModal",ref:o},[fO,V("div",{class:"modal-dialog",ref_key:"modalDialog",ref:C},[V("div",pO,[V("div",_O,[c.value?(Ne(),ke("button",{key:0,class:"btn position-absolute start-0 mx-3 text-primary",onClick:P}," 上一步 ")):ut("",!0),gO,c.value?(Ne(),ke("button",{key:1,class:"btn position-absolute end-0 mx-3 text-primary",onClick:U}," 下一步 ")):ut("",!0)]),V("div",mO,[c.value?(Ne(),ke("div",EO,[V("img",{src:c.value,alt:"",class:"input-img"},null,8,bO)])):(Ne(),ke("div",{key:0,class:"modal-body align-items-center p-5",onDragover:ui(y,["prevent"]),onDragleave:ui(v,["prevent"]),onDrop:ui(b,["prevent"])},[V("div",{class:ao(["d-flex flex-column align-items-center justify-content-center",p.value?"text-primary":""])},[vO,yO,wO,V("input",{type:"file",id:"file-input",accept:"audio/*,video/*,image/*",onChange:x[0]||(x[0]=$=>d($.target))},null,32)],2)],32)),A.value?(Ne(),ke("div",IO,[V("div",CO,[V("div",TO,[V("img",{src:_o(W).userData.media_url,alt:""},null,8,SO)]),V("p",AO,lo(_o(W).userData.username),1)]),Mp(V("textarea",{type:"text",placeholder:"撰寫說明文字......",class:"postDescriptionInput py-2 w-100","onUpdate:modelValue":x[1]||(x[1]=$=>B.value=$)},null,512),[[Up,B.value]])])):ut("",!0)])])],512)],512),co(D,{active:t.value,"is-full-page":!0},null,8,["active"])],64)}}},NO=Dp(RO,[["__scopeId","data-v-0fe499d0"]]),kO={class:"col-md-1 col-lg-2 nav-all p-md-3 overflow-hidden position-relative"},OO=V("div",{class:"navbar navbar-light header-nav width-inherit start-0"},[V("img",{src:iO,alt:"",class:"header-logo d-md-none d-lg-block d-sm-block ms-md-3"}),V("div",{class:"header-logo-icon-wrapper"},[V("svg",{"aria-label":"Instagram",class:"d-none d-lg-none d-md-block header-logo headerLogoIcon",fill:"currentColor",height:"24",role:"img",viewBox:"0 0 24 24",width:"24"},[V("title",null,"Instagram"),V("path",{d:"M12 2.982c2.937 0 3.285.011 4.445.064a6.087 6.087 0 0 1 2.042.379 3.408 3.408 0 0 1 1.265.823 3.408 3.408 0 0 1 .823 1.265 6.087 6.087 0 0 1 .379 2.042c.053 1.16.064 1.508.064 4.445s-.011 3.285-.064 4.445a6.087 6.087 0 0 1-.379 2.042 3.643 3.643 0 0 1-2.088 2.088 6.087 6.087 0 0 1-2.042.379c-1.16.053-1.508.064-4.445.064s-3.285-.011-4.445-.064a6.087 6.087 0 0 1-2.043-.379 3.408 3.408 0 0 1-1.264-.823 3.408 3.408 0 0 1-.823-1.265 6.087 6.087 0 0 1-.379-2.042c-.053-1.16-.064-1.508-.064-4.445s.011-3.285.064-4.445a6.087 6.087 0 0 1 .379-2.042 3.408 3.408 0 0 1 .823-1.265 3.408 3.408 0 0 1 1.265-.823 6.087 6.087 0 0 1 2.042-.379c1.16-.053 1.508-.064 4.445-.064M12 1c-2.987 0-3.362.013-4.535.066a8.074 8.074 0 0 0-2.67.511 5.392 5.392 0 0 0-1.949 1.27 5.392 5.392 0 0 0-1.269 1.948 8.074 8.074 0 0 0-.51 2.67C1.012 8.638 1 9.013 1 12s.013 3.362.066 4.535a8.074 8.074 0 0 0 .511 2.67 5.392 5.392 0 0 0 1.27 1.949 5.392 5.392 0 0 0 1.948 1.269 8.074 8.074 0 0 0 2.67.51C8.638 22.988 9.013 23 12 23s3.362-.013 4.535-.066a8.074 8.074 0 0 0 2.67-.511 5.625 5.625 0 0 0 3.218-3.218 8.074 8.074 0 0 0 .51-2.67C22.988 15.362 23 14.987 23 12s-.013-3.362-.066-4.535a8.074 8.074 0 0 0-.511-2.67 5.392 5.392 0 0 0-1.27-1.949 5.392 5.392 0 0 0-1.948-1.269 8.074 8.074 0 0 0-2.67-.51C15.362 1.012 14.987 1 12 1Zm0 5.351A5.649 5.649 0 1 0 17.649 12 5.649 5.649 0 0 0 12 6.351Zm0 9.316A3.667 3.667 0 1 1 15.667 12 3.667 3.667 0 0 1 12 15.667Zm5.872-10.859a1.32 1.32 0 1 0 1.32 1.32 1.32 1.32 0 0 0-1.32-1.32Z"})])])],-1),xO={class:"bg-body d-flex flex-md-column position-fixed nav-selection bottom-0 start-0 justify-content-evenly justify-content-md-start width-inherit"},PO={class:"nav-item rounded px-2 mx-md-3"},DO=V("div",null,[V("i",{class:"bi bi-house-door icon-size m-0"})],-1),LO=V("div",{class:"position-absolute ms-4"},[V("span",{class:"d-none d-lg-inline p-2"},"首頁")],-1),MO={class:"nav-item rounded px-2 mx-md-3"},UO=V("div",null,[V("i",{class:"bi bi-plus-square icon-size m-0"})],-1),FO=V("div",{class:"position-absolute ms-4"},[V("span",{class:"d-none d-lg-inline p-2"},"建立")],-1),BO=[UO,FO],WO={class:"nav-item rounded px-2 mx-md-3"},HO=V("div",null,[V("i",{class:"bi bi-person-circle icon-size m-0"})],-1),$O=V("div",{class:"position-absolute ms-4"},[V("span",{class:"d-none d-lg-inline p-2"},"個人檔案")],-1),Rx={__name:"navComponent",setup(n){const e=Ke(null),t=function(){e.value.showModal()};return(r,o)=>{const a=Lp("RouterLink");return Ne(),ke(Pr,null,[V("nav",kO,[OO,V("div",xO,[V("div",PO,[co(a,{to:"/",class:"text-decoration-none text-secondary d-flex text-dark justify-content-md-center justify-content-lg-start"},{default:lf(()=>[DO,LO]),_:1})]),V("div",MO,[V("a",{href:"#",class:"text-decoration-none text-secondary d-flex text-dark justify-content-md-center justify-content-lg-start",onClick:ui(t,["prevent"])},BO)]),V("div",WO,[co(a,{to:"/profile",class:"text-decoration-none text-secondary d-flex text-dark justify-content-md-center justify-content-lg-start"},{default:lf(()=>[HO,$O]),_:1})])])]),co(NO,{ref_key:"addNewModal",ref:e},null,512)],64)}}};var Fo={exports:{}};/**
 * @license
...
`:`;
`)+O+`return __p
}`;var re=sf(function(){return fe(g,G+"return "+O).apply(t,m)});if(re.source=O,vl(re))throw re;return re}function sI(i){return _e(i).toLowerCase()}function oI(i){return _e(i).toUpperCase()}function aI(i,s,l){if(i=_e(i),i&&(l||s===t))return fh(i);if(!i||!(s=Et(s)))return i;var u=Bt(i),f=Bt(s),g=ph(u,f),m=_h(u,f)+1;return Dn(u,g,m).join("")}function lI(i,s,l){if(i=_e(i),i&&(l||s===t))return i.slice(0,mh(i)+1);if(!i||!(s=Et(s)))return i;var u=Bt(i),f=_h(u,Bt(s))+1;return Dn(u,0,f).join("")}function cI(i,s,l){if(i=_e(i),i&&(l||s===t))return i.replace(va,"");if(!i||!(s=Et(s)))return i;var u=Bt(i),f=ph(u,Bt(s));return Dn(u,f).join("")}function uI(i,s){var l=me,u=ve;if(De(s)){var f="separator"in s?s.separator:f;l="length"in s?ie(s.length):l,u="omission"in s?Et(s.omission):u}i=_e(i);var g=i.length;if(Ai(i)){var m=Bt(i);g=m.length}if(l>=g)return i;var w=l-Ri(u);if(w<1)return u;var I=m?Dn(m,0,w).join(""):i.slice(0,w);if(f===t)return I+u;if(m&&(w+=I.length-w),yl(f)){if(i.slice(w).search(f)){var N,k=I;for(f.global||(f=La(f.source,_e(Lu.exec(f))+"g")),f.lastIndex=0;N=f.exec(k);)var O=N.index;I=I.slice(0,O===t?w:O)}}else if(i.indexOf(Et(f),w)!=w){var F=I.lastIndexOf(f);F>-1&&(I=I.slice(0,F))}return I+u}function hI(i){return i=_e(i),i&&bm.test(i)?i.replace(xu,Wv):i}var dI=Li(function(i,s,l){return i+(l?" ":"")+s.toUpperCase()}),bl=sd("toUpperCase");function rf(i,s,l){return i=_e(i),s=l?t:s,s===t?Lv(i)?Vv(i):Sv(i):i.match(s)||[]}var sf=se(function(i,s){try{return yt(i,t,s)}catch(l){return vl(l)?l:new te(l)}}),fI=cn(function(i,s){return Rt(s,function(l){l=Qt(l),an(i,l,gl(i[l],i))}),i});function pI(i){var s=i==null?0:i.length,l=K();return i=s?xe(i,function(u){if(typeof u[1]!="function")throw new Nt(c);return[l(u[0]),u[1]]}):[],se(function(u){for(var f=-1;++f<s;){var g=i[f];if(yt(g[0],this,u))return yt(g[1],this,u)}})}function _I(i){return Wy(Ot(i,v))}function Il(i){return function(){return i}}function gI(i,s){return i==null||i!==i?s:i}var mI=ad(),vI=ad(!0);function _t(i){return i}function Cl(i){return Uh(typeof i=="function"?i:Ot(i,v))}function yI(i){return Bh(Ot(i,v))}function wI(i,s){return Wh(i,Ot(s,v))}var EI=se(function(i,s){return function(l){return Er(l,i,s)}}),bI=se(function(i,s){return function(l){return Er(i,l,s)}});function Tl(i,s,l){var u=Ge(s),f=Ds(s,u);l==null&&!(De(s)&&(f.length||!u.length))&&(l=s,s=i,i=this,f=Ds(s,Ge(s)));var g=!(De(l)&&"chain"in l)||!!l.chain,m=hn(i);return Rt(f,function(w){var I=s[w];i[w]=I,m&&(i.prototype[w]=function(){var N=this.__chain__;if(g||N){var k=i(this.__wrapped__),O=k.__actions__=dt(this.__actions__);return O.push({func:I,args:arguments,thisArg:i}),k.__chain__=N,k}return I.apply(i,Rn([this.value()],arguments))})}),i}function II(){return Xe._===this&&(Xe._=jv),this}function Sl(){}function CI(i){return i=ie(i),se(function(s){return Hh(s,i)})}var TI=il(xe),SI=il(lh),AI=il(Ra);function of(i){return ul(i)?Na(Qt(i)):iw(i)}function RI(i){return function(s){return i==null?t:ii(i,s)}}var NI=cd(),kI=cd(!0);function Al(){return[]}function Rl(){return!1}function OI(){return{}}function xI(){return""}function PI(){return!0}function DI(i,s){if(i=ie(i),i<1||i>Pe)return[];var l=$e,u=nt(i,$e);s=K(s),i-=$e;for(var f=xa(u,s);++l<i;)s(l);return f}function LI(i){return ne(i)?xe(i,Qt):bt(i)?[i]:dt(Td(_e(i)))}function MI(i){var s=++Kv;return _e(i)+s}var UI=Ws(function(i,s){return i+s},0),FI=rl("ceil"),BI=Ws(function(i,s){return i/s},1),WI=rl("floor");function HI(i){return i&&i.length?Ps(i,_t,Va):t}function $I(i,s){return i&&i.length?Ps(i,K(s,2),Va):t}function VI(i){return hh(i,_t)}function qI(i,s){return hh(i,K(s,2))}function GI(i){return i&&i.length?Ps(i,_t,Ka):t}function zI(i,s){return i&&i.length?Ps(i,K(s,2),Ka):t}var KI=Ws(function(i,s){return i*s},1),YI=rl("round"),jI=Ws(function(i,s){return i-s},0);function QI(i){return i&&i.length?Oa(i,_t):0}function XI(i,s){return i&&i.length?Oa(i,K(s,2)):0}return _.after=y0,_.ary=Md,_.assign=ob,_.assignIn=Qd,_.assignInWith=Zs,_.assignWith=ab,_.at=lb,_.before=Ud,_.bind=gl,_.bindAll=fI,_.bindKey=Fd,_.castArray=O0,_.chain=Pd,_.chunk=Ww,_.compact=Hw,_.concat=$w,_.cond=pI,_.conforms=_I,_.constant=Il,_.countBy=QE,_.create=cb,_.curry=Bd,_.curryRight=Wd,_.debounce=Hd,_.defaults=ub,_.defaultsDeep=hb,_.defer=w0,_.delay=E0,_.difference=Vw,_.differenceBy=qw,_.differenceWith=Gw,_.drop=zw,_.dropRight=Kw,_.dropRightWhile=Yw,_.dropWhile=jw,_.fill=Qw,_.filter=JE,_.flatMap=t0,_.flatMapDeep=n0,_.flatMapDepth=i0,_.flatten=Nd,_.flattenDeep=Xw,_.flattenDepth=Jw,_.flip=b0,_.flow=mI,_.flowRight=vI,_.fromPairs=Zw,_.functions=vb,_.functionsIn=yb,_.groupBy=r0,_.initial=tE,_.intersection=nE,_.intersectionBy=iE,_.intersectionWith=rE,_.invert=Eb,_.invertBy=bb,_.invokeMap=o0,_.iteratee=Cl,_.keyBy=a0,_.keys=Ge,_.keysIn=pt,_.map=Ks,_.mapKeys=Cb,_.mapValues=Tb,_.matches=yI,_.matchesProperty=wI,_.memoize=js,_.merge=Sb,_.mergeWith=Xd,_.method=EI,_.methodOf=bI,_.mixin=Tl,_.negate=Qs,_.nthArg=CI,_.omit=Ab,_.omitBy=Rb,_.once=I0,_.orderBy=l0,_.over=TI,_.overArgs=C0,_.overEvery=SI,_.overSome=AI,_.partial=ml,_.partialRight=$d,_.partition=c0,_.pick=Nb,_.pickBy=Jd,_.property=of,_.propertyOf=RI,_.pull=lE,_.pullAll=Od,_.pullAllBy=cE,_.pullAllWith=uE,_.pullAt=hE,_.range=NI,_.rangeRight=kI,_.rearg=T0,_.reject=d0,_.remove=dE,_.rest=S0,_.reverse=pl,_.sampleSize=p0,_.set=Ob,_.setWith=xb,_.shuffle=_0,_.slice=fE,_.sortBy=v0,_.sortedUniq=wE,_.sortedUniqBy=EE,_.split=tI,_.spread=A0,_.tail=bE,_.take=IE,_.takeRight=CE,_.takeRightWhile=TE,_.takeWhile=SE,_.tap=HE,_.throttle=R0,_.thru=zs,_.toArray=Kd,_.toPairs=Zd,_.toPairsIn=ef,_.toPath=LI,_.toPlainObject=jd,_.transform=Pb,_.unary=N0,_.union=AE,_.unionBy=RE,_.unionWith=NE,_.uniq=kE,_.uniqBy=OE,_.uniqWith=xE,_.unset=Db,_.unzip=_l,_.unzipWith=xd,_.update=Lb,_.updateWith=Mb,_.values=Fi,_.valuesIn=Ub,_.without=PE,_.words=rf,_.wrap=k0,_.xor=DE,_.xorBy=LE,_.xorWith=ME,_.zip=UE,_.zipObject=FE,_.zipObjectDeep=BE,_.zipWith=WE,_.entries=Zd,_.entriesIn=ef,_.extend=Qd,_.extendWith=Zs,Tl(_,_),_.add=UI,_.attempt=sf,_.camelCase=Hb,_.capitalize=tf,_.ceil=FI,_.clamp=Fb,_.clone=x0,_.cloneDeep=D0,_.cloneDeepWith=L0,_.cloneWith=P0,_.conformsTo=M0,_.deburr=nf,_.defaultTo=gI,_.divide=BI,_.endsWith=$b,_.eq=Ht,_.escape=Vb,_.escapeRegExp=qb,_.every=XE,_.find=ZE,_.findIndex=Ad,_.findKey=db,_.findLast=e0,_.findLastIndex=Rd,_.findLastKey=fb,_.floor=WI,_.forEach=Dd,_.forEachRight=Ld,_.forIn=pb,_.forInRight=_b,_.forOwn=gb,_.forOwnRight=mb,_.get=wl,_.gt=U0,_.gte=F0,_.has=wb,_.hasIn=El,_.head=kd,_.identity=_t,_.includes=s0,_.indexOf=eE,_.inRange=Bb,_.invoke=Ib,_.isArguments=oi,_.isArray=ne,_.isArrayBuffer=B0,_.isArrayLike=ft,_.isArrayLikeObject=We,_.isBoolean=W0,_.isBuffer=Ln,_.isDate=H0,_.isElement=$0,_.isEmpty=V0,_.isEqual=q0,_.isEqualWith=G0,_.isError=vl,_.isFinite=z0,_.isFunction=hn,_.isInteger=Vd,_.isLength=Xs,_.isMap=qd,_.isMatch=K0,_.isMatchWith=Y0,_.isNaN=j0,_.isNative=Q0,_.isNil=J0,_.isNull=X0,_.isNumber=Gd,_.isObject=De,_.isObjectLike=Le,_.isPlainObject=Ar,_.isRegExp=yl,_.isSafeInteger=Z0,_.isSet=zd,_.isString=Js,_.isSymbol=bt,_.isTypedArray=Ui,_.isUndefined=eb,_.isWeakMap=tb,_.isWeakSet=nb,_.join=sE,_.kebabCase=Gb,_.last=Pt,_.lastIndexOf=oE,_.lowerCase=zb,_.lowerFirst=Kb,_.lt=ib,_.lte=rb,_.max=HI,_.maxBy=$I,_.mean=VI,_.meanBy=qI,_.min=GI,_.minBy=zI,_.stubArray=Al,_.stubFalse=Rl,_.stubObject=OI,_.stubString=xI,_.stubTrue=PI,_.multiply=KI,_.nth=aE,_.noConflict=II,_.noop=Sl,_.now=Ys,_.pad=Yb,_.padEnd=jb,_.padStart=Qb,_.parseInt=Xb,_.random=Wb,_.reduce=u0,_.reduceRight=h0,_.repeat=Jb,_.replace=Zb,_.result=kb,_.round=YI,_.runInContext=E,_.sample=f0,_.size=g0,_.snakeCase=eI,_.some=m0,_.sortedIndex=pE,_.sortedIndexBy=_E,_.sortedIndexOf=gE,_.sortedLastIndex=mE,_.sortedLastIndexBy=vE,_.sortedLastIndexOf=yE,_.startCase=nI,_.startsWith=iI,_.subtract=jI,_.sum=QI,_.sumBy=XI,_.template=rI,_.times=DI,_.toFinite=dn,_.toInteger=ie,_.toLength=Yd,_.toLower=sI,_.toNumber=Dt,_.toSafeInteger=sb,_.toString=_e,_.toUpper=oI,_.trim=aI,_.trimEnd=lI,_.trimStart=cI,_.truncate=uI,_.unescape=hI,_.uniqueId=MI,_.upperCase=dI,_.upperFirst=bl,_.each=Dd,_.eachRight=Ld,_.first=kd,Tl(_,function(){var i={};return Yt(_,function(s,l){ge.call(_.prototype,l)||(i[l]=s)}),i}(),{chain:!1}),_.VERSION=r,Rt(["bind","bindKey","curry","curryRight","partial","partialRight"],function(i){_[i].placeholder=_}),Rt(["drop","take"],function(i,s){he.prototype[i]=function(l){l=l===t?1:qe(ie(l),0);var u=this.__filtered__&&!s?new he(this):this.clone();return u.__filtered__?u.__takeCount__=nt(l,u.__takeCount__):u.__views__.push({size:nt(l,$e),type:i+(u.__dir__<0?"Right":"")}),u},he.prototype[i+"Right"]=function(l){return this.reverse()[i](l).reverse()}}),Rt(["filter","map","takeWhile"],function(i,s){var l=s+1,u=l==Z||l==be;he.prototype[i]=function(f){var g=this.clone();return g.__iteratees__.push({iteratee:K(f,3),type:l}),g.__filtered__=g.__filtered__||u,g}}),Rt(["head","last"],function(i,s){var l="take"+(s?"Right":"");he.prototype[i]=function(){return this[l](1).value()[0]}}),Rt(["initial","tail"],function(i,s){var l="drop"+(s?"":"Right");he.prototype[i]=function(){return this.__filtered__?new he(this):this[l](1)}}),he.prototype.compact=function(){return this.filter(_t)},he.prototype.find=function(i){return this.filter(i).head()},he.prototype.findLast=function(i){return this.reverse().find(i)},he.prototype.invokeMap=se(function(i,s){return typeof i=="function"?new he(this):this.map(function(l){return Er(l,i,s)})}),he.prototype.reject=function(i){return this.filter(Qs(K(i)))},he.prototype.slice=function(i,s){i=ie(i);var l=this;return l.__filtered__&&(i>0||s<0)?new he(l):(i<0?l=l.takeRight(-i):i&&(l=l.drop(i)),s!==t&&(s=ie(s),l=s<0?l.dropRight(-s):l.take(s-i)),l)},he.prototype.takeRightWhile=function(i){return this.reverse().takeWhile(i).reverse()},he.prototype.toArray=function(){return this.take($e)},Yt(he.prototype,function(i,s){var l=/^(?:filter|find|map|reject)|While$/.test(s),u=/^(?:head|last)$/.test(s),f=_[u?"take"+(s=="last"?"Right":""):s],g=u||/^find/.test(s);f&&(_.prototype[s]=function(){var m=this.__wrapped__,w=u?[1]:arguments,I=m instanceof he,N=w[0],k=I||ne(m),O=function(le){var de=f.apply(_,Rn([le],w));return u&&F?de[0]:de};k&&l&&typeof N=="function"&&N.length!=1&&(I=k=!1);var F=this.__chain__,G=!!this.__actions__.length,j=g&&!F,re=I&&!G;if(!g&&k){m=re?m:new he(this);var Q=i.apply(m,w);return Q.__actions__.push({func:zs,args:[O],thisArg:t}),new kt(Q,F)}return j&&re?i.apply(this,w):(Q=this.thru(O),j?u?Q.value()[0]:Q.value():Q)})}),Rt(["pop","push","shift","sort","splice","unshift"],function(i){var s=vs[i],l=/^(?:push|sort|unshift)$/.test(i)?"tap":"thru",u=/^(?:pop|shift)$/.test(i);_.prototype[i]=function(){var f=arguments;if(u&&!this.__chain__){var g=this.value();return s.apply(ne(g)?g:[],f)}return this[l](function(m){return s.apply(ne(m)?m:[],f)})}}),Yt(he.prototype,function(i,s){var l=_[s];if(l){var u=l.name+"";ge.call(xi,u)||(xi[u]=[]),xi[u].push({name:s,func:l})}}),xi[Bs(t,Y).name]=[{name:"wrapper",func:t}],he.prototype.clone=hy,he.prototype.reverse=dy,he.prototype.value=fy,_.prototype.at=$E,_.prototype.chain=VE,_.prototype.commit=qE,_.prototype.next=GE,_.prototype.plant=KE,_.prototype.reverse=YE,_.prototype.toJSON=_.prototype.valueOf=_.prototype.value=jE,_.prototype.first=_.prototype.head,pr&&(_.prototype[pr]=zE),_},Ni=qv();Jn?((Jn.exports=Ni)._=Ni,Ca._=Ni):Xe._=Ni}).call(et)})(Fo,Fo.exports);var VO=Fo.exports;const cs=n=>(Fp("data-v-81bb7911"),n=n(),Bp(),n),qO=["id"],GO={class:"card-header bg-body px-1 d-flex align-items-center px-2 px-md-0"},zO={class:"rounded-circle user-pic"},KO=["src"],YO={class:"ms-2 fw-bold"},jO=["id","onDblclick"],QO=cs(()=>V("svg",{xmlns:"http://www.w3.org/2000/svg",width:"50",height:"50",fill:"currentColor",class:"bi bi-heart-fill text-danger",viewBox:"0 0 16 16"},[V("path",{"fill-rule":"evenodd",d:"M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314"})],-1)),XO=[QO],JO={key:0,class:"carousel-indicators"},ZO=["data-bs-target","data-bs-slide-to","aria-current","aria-label"],ex=["src"],tx=["src"],nx={controls:"",class:"d-block w-100"},ix=["src"],rx=["data-bs-target"],sx=cs(()=>V("span",{class:"carousel-control-prev-icon","aria-hidden":"true"},null,-1)),ox=cs(()=>V("span",{class:"visually-hidden"},"Previous",-1)),ax=[sx,ox],lx=["data-bs-target"],cx=cs(()=>V("span",{class:"carousel-control-next-icon","aria-hidden":"true"},null,-1)),ux=cs(()=>V("span",{class:"visually-hidden"},"Next",-1)),hx=[cx,ux],dx={class:"card-body px-sm-0 py-1 mb-1"},fx=["onClick"],px={key:0,class:"bi bi-heart icon-size text-danger"},_x={key:1,class:"bi bi-heart-fill icon-size text-danger"},gx={key:0},mx={class:"card-text d-inline fw-bold"},vx={class:"card-text ms-2 d-inline"},yx=["onClick"],wx={class:"position-relative"},Ex=["id","onUpdate:modelValue"],bx=["onClick"],Ix={key:0,class:"m-0"},Cx={__name:"postComponent",props:{postDataList:Array,postIdDirection:String},setup(n){const e=n,t=Ke(e.postDataList),r=tC(()=>{const W=[...t.value];return W.sort((B,L)=>new Date(L.timestamp)-new Date(B.timestamp)),W});nC(()=>e.postDataList,(W,B)=>{t.value=W});const o=Ke(new Set),a=W=>{o.value.has(W)?o.value.delete(W):o.value.add(W)},c=W=>o.value.has(W),h=(W,B)=>{if(W)return c(B)?W:W.slice(0,20)},d=Ke(window.innerWidth>=768),p=()=>{d.value=window.innerWidth>=768};tc(()=>{window.addEventListener("resize",p)}),iC(()=>{window.removeEventListener("resize",p)});const y=Ke([]);tc(()=>{const W=jr(Xr,"userData");gg(W,B=>{const L=[];B.forEach(q=>{const x=q.key,D=q.val();L.push({key:x,...D})}),y.value=L})});let v=!1;const b=W=>{for(const B in y.value)if(v=y.value[B].id===W.postownerid,v)return y.value[B].media_url;return""},C=Ke({}),A=W=>{console.log(W),console.log(C.value[W])},U=Ke({}),P=Ke({}),Y=VO.debounce(function(W){W.isThumb=!W.isThumb;const B=jr(Xr,`postsData/${W.key}`);xR(B,W).then(()=>{console.log("Data updated successfully!")}).catch(L=>{console.error("Error updating data:",L)}),U.value[W.id]=W.isThumb,P.value[W.id]&&clearTimeout(P.value[W.id]),P.value[W.id]=setTimeout(()=>{U.value[W.id]=!1},2e3)},300);return(W,B)=>(Ne(!0),ke(Pr,null,Nl(r.value,(L,q)=>(Ne(),ke("div",{class:"card mt-3 post-card w-100 border-0",key:L.id,id:L.id},[V("div",GO,[V("div",zO,[V("img",{src:b(L),alt:""},null,8,KO)]),V("div",YO,lo(L.username),1)]),V("div",{id:"post"+L.id,class:"carousel slide post-pic-area position-relative",onDblclick:x=>_o(Y)(L)},[V("div",{class:ao(["position-absolute heartAnimationDefault",U.value[L.id]?"heartAnimation":""])},XO,2),L.media_type==="CAROUSEL_ALBUM"?(Ne(),ke("div",JO,[(Ne(!0),ke(Pr,null,Nl(L.media_children,(x,D)=>(Ne(),ke("div",{key:D},[V("button",{class:ao({active:D===0}),type:"button","data-bs-target":"#post"+L.id,"data-bs-slide-to":D,"aria-current":D===1,"aria-label":"Slide"+D},null,10,ZO)]))),128))])):ut("",!0),L.media_type==="IMAGE"?(Ne(),ke("div",{key:1,class:"carousel-inner position-relative",ref_for:!0,ref:"postImg"},[V("img",{src:L.media_url,class:"d-block w-100",alt:"..."},null,8,ex)],512)):ut("",!0),L.media_type==="CAROUSEL_ALBUM"?(Ne(),ke("div",{key:2,class:"carousel-inner position-relative",ref_for:!0,ref:"postImg"},[(Ne(!0),ke(Pr,null,Nl(L.media_children,(x,D)=>(Ne(),ke("div",{class:ao(["carousel-item",{active:D===0}]),key:D},[V("img",{src:x,class:"d-block w-100",alt:"..."},null,8,tx)],2))),128))],512)):ut("",!0),L.media_type==="VIDEO"?(Ne(),ke("div",{key:3,class:"carousel-inner position-relative",ref_for:!0,ref:"postImg"},[V("video",nx,[V("source",{src:L.media_url,type:"video/webm"},null,8,ix)])],512)):ut("",!0),L.media_type==="CAROUSEL_ALBUM"?(Ne(),ke("button",{key:4,class:"carousel-control-prev",type:"button","data-bs-target":"#post"+L.id,"data-bs-slide":"prev"},ax,8,rx)):ut("",!0),L.media_type==="CAROUSEL_ALBUM"?(Ne(),ke("button",{key:5,class:"carousel-control-next",type:"button","data-bs-target":"#post"+L.id,"data-bs-slide":"next"},hx,8,lx)):ut("",!0)],40,jO),V("div",dx,[V("a",{href:"",onClick:ui(x=>_o(Y)(L),["prevent"])},[L.isThumb?ut("",!0):(Ne(),ke("i",px)),L.isThumb?(Ne(),ke("i",_x)):ut("",!0)],8,fx),L.caption?(Ne(),ke("div",gx,[V("span",mx,lo(L.username),1),V("div",vx,lo(h(L.caption,L.id)),1),!c(L.id)&&L.caption&&L.caption.length>20?(Ne(),ke("a",{key:0,class:"text-decoration-none text-secondary fs-6",onClick:ui(x=>a(L.id),["prevent"]),href:"#"}," ...更多 ",8,yx)):ut("",!0)])):ut("",!0),V("div",wx,[Mp(V("input",{type:"text",placeholder:"留言...",class:"w-100 border-0 my-1 py-1 postMessage",id:"#message"+L.id,"onUpdate:modelValue":x=>C.value[L.id]=x},null,8,Ex),[[Up,C.value[L.id]]]),C.value[L.id]?(Ne(),ke("a",{key:0,type:"button",class:"position-absolute top-50 end-0 translate-middle-y text-decoration-none",onClick:ui(x=>A(L.id),["prevent"])},"發布",8,bx)):ut("",!0)])]),q!=t.value.length-1&&d.value?(Ne(),ke("hr",Ix)):ut("",!0)],8,qO))),128))}},Nx=Dp(Cx,[["__scopeId","data-v-81bb7911"]]);export{hO as M,Rx as _,Ax as a,Xr as d,gg as o,Nx as p,jr as r,Sx as s,dO as u};
