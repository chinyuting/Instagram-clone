import{k as ue,l as Aa,y as Da,r as Ee,p as ka,_ as xa,o as Oa,a as Fe,c as Ue,b as R,g as Rn,t as Pa,s as Ma,m as La,v as Fa,A as Ua,B as Ba,C as Wa,q as qt,D as An,h as Ha,F as $a}from"./index-WKi0o-qy.js";var pi={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qa(n){return Nr(void 0,n)}function Nr(n,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const t=e;return new Date(t.getTime());case Object:n===void 0&&(n={});break;case Array:n=[];break;default:return e}for(const t in e)!e.hasOwnProperty(t)||!za(t)||(n[t]=Nr(n[t],e[t]));return n}function za(n){return n!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ja(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function xr(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(Ja())}function Za(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Or(){return Tr.NODE_ADMIN===!0}function el(){try{return typeof indexedDB=="object"}catch{return!1}}function tl(){return new Promise((n,e)=>{try{let t=!0;const s="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(s);i.onsuccess=()=>{i.result.close(),t||self.indexedDB.deleteDatabase(s),n(!0)},i.onupgradeneeded=()=>{t=!1},i.onerror=()=>{var r;e(((r=i.error)===null||r===void 0?void 0:r.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nl="FirebaseError";class ft extends Error{constructor(e,t,s){super(t),this.code=e,this.customData=s,this.name=nl,Object.setPrototypeOf(this,ft.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Pr.prototype.create)}}class Pr{constructor(e,t,s){this.service=e,this.serviceName=t,this.errors=s}create(e,...t){const s=t[0]||{},i=`${this.service}/${e}`,r=this.errors[e],o=r?sl(r,s):"Error",a=`${this.serviceName}: ${o} (${i}).`;return new ft(i,a,s)}}function sl(n,e){return n.replace(il,(t,s)=>{const i=e[s];return i!=null?String(i):`<${s}?>`})}const il=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mr=function(n){let e={},t={},s={},i="";try{const r=n.split(".");e=At(Jn(r[0])||""),t=At(Jn(r[1])||""),i=r[2],s=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:s,signature:i}},rl=function(n){const e=Mr(n),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},ol=function(n){const e=Mr(n).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _c(n){Dt(new rt("platform-logger",e=>new Al(e),"PRIVATE")),Dt(new rt("heartbeat",e=>new hc(e),"PRIVATE")),De(ns,bi,n),De(ns,bi,"esm2017"),De("fire-js","")}_c("");var pc="firebase",mc="10.11.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vc{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return ge(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zr=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new yc(e)}}catch{}return new vc},He=zr("localStorage"),rs=zr("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mc{constructor(){this.counters_={}}incrementCounter(e,t=1){ge(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return qa(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Eo,bo;function gu(n){Eo=n}function yu(n){bo=n}class vu extends mn{compare(e,t){const s=e.node.getPriority(),i=t.node.getPriority(),r=s.compareTo(i);return r===0?Qe(e.name,t.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return D.MIN}maxPost(){return new D(qe,new X("[PRIORITY-POST]",bo))}makePost(e,t){const s=Eo(e);return new D(t,new X("[PRIORITY-POST]",s))}toString(){return".priority"}}const z=new vu;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function on(){return{value:null,children:new Map}}function wo(n,e,t){if(x(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const s=A(e);n.children.has(s)||n.children.set(s,on());const i=n.children.get(s);e=H(e),wo(i,e,t)}}function cs(n,e,t){n.value!==null?t(e,n.value):ku(n,(s,i)=>{const r=new L(e.toString()+"/"+s);cs(i,r,t)})}function ku(n,e){n.children.forEach((t,s)=>{e(s,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qi=10*1e3,Ou=30*1e3,Pu=5*60*1e3;class Mu{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new xu(e);const s=qi+(Ou-qi)*Math.random();Tt(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),t={};let s=!1;ne(e,(i,r)=>{r>0&&ge(this.statsToReport_,i)&&(t[i]=r,s=!0)}),s&&this.server_.reportStats(t),Tt(this.reportStats_.bind(this),Math.floor(Math.random()*2*Pu))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let dn;function wh(n){m(!dn,"__referenceConstructor has already been defined"),dn=n}function Th(){return m(dn,"Reference.ts has not been loaded"),dn}let Ih=1;class er{constructor(e){this.listenProvider_=e,this.syncPointTree_=new B(null),this.pendingWriteTree_=Zu(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Lo(n,e,t,s,i){return Hu(n.pendingWriteTree_,e,t,s,i),i?pt(n,new ze(Ls(),e,t)):[]}function Sh(n,e,t,s){$u(n.pendingWriteTree_,e,t,s);const i=B.fromObject(t);return pt(n,new lt(Ls(),e,i))}function Ne(n,e,t=!1){const s=Vu(n.pendingWriteTree_,e);if(ju(n.pendingWriteTree_,e)){let r=new B(null);return s.snap!=null?r=r.set(P(),!0):ne(s.children,o=>{r=r.set(new L(o),!0)}),pt(n,new an(s.path,r,t))}else return[]}function vn(n,e,t){return pt(n,new ze(Fs(),e,t))}function Nh(n,e,t){const s=B.fromObject(t);return pt(n,new lt(Fs(),e,s))}function Rh(n,e){return pt(n,new Ft(Fs(),e))}function Ah(n,e,t){const s=qs(n,t);if(s){const i=zs(s),r=i.path,o=i.queryId,a=oe(r,e),l=new Ft(Us(o),a);return Gs(n,r,l)}else return[]}function ms(n,e,t,s,i=!1){const r=e._path,o=n.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||Mo(o,e))){const l=Ch(o,e,t,s);vh(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const c=l.removed;if(a=l.events,!i){const h=c.findIndex(d=>d._queryParams.loadsAllData())!==-1,u=n.syncPointTree_.findOnPath(r,(d,f)=>Oe(f));if(h&&!u){const d=n.syncPointTree_.subtree(r);if(!d.isEmpty()){const f=xh(d);for(let p=0;p<f.length;++p){const g=f[p],y=g.query,T=Bo(n,g);n.listenProvider_.startListening(Nt(y),fn(n,y),T.hashFn,T.onComplete)}}}!u&&c.length>0&&!s&&(h?n.listenProvider_.stopListening(Nt(e),null):c.forEach(d=>{const f=n.queryToTagMap.get(En(d));n.listenProvider_.stopListening(Nt(d),f)}))}Oh(n,c)}return a}function Dh(n,e,t,s){const i=qs(n,s);if(i!=null){const r=zs(i),o=r.path,a=r.queryId,l=oe(o,e),c=new ze(Us(a),l,t);return Gs(n,o,c)}else return[]}function kh(n,e,t,s){const i=qs(n,s);if(i){const r=zs(i),o=r.path,a=r.queryId,l=oe(o,e),c=B.fromObject(t),h=new lt(Us(a),l,c);return Gs(n,o,h)}else return[]}function tr(n,e,t,s=!1){const i=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(i,(d,f)=>{const p=oe(d,i);r=r||st(f,p),o=o||Oe(f)});let a=n.syncPointTree_.get(i);a?(o=o||Oe(a),r=r||st(a,P())):(a=new mh,n.syncPointTree_=n.syncPointTree_.set(i,a));let l;r!=null?l=!0:(l=!1,r=w.EMPTY_NODE,n.syncPointTree_.subtree(i).foreachChild((f,p)=>{const g=st(p,P());g&&(r=r.updateImmediateChild(f,g))}));const c=Mo(a,e);if(!c&&!e._queryParams.loadsAllData()){const d=En(e);m(!n.queryToTagMap.has(d),"View does not exist, but we have a tag");const f=Ph();n.queryToTagMap.set(d,f),n.tagToQueryMap.set(f,d)}const h=Bs(n.pendingWriteTree_,i);let u=bh(a,e,t,h,r,l);if(!c&&!o&&!s){const d=Po(a,e);u=u.concat(Mh(n,e,d))}return u}function js(n,e,t){const i=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const l=oe(o,e),c=st(a,l);if(c)return c});return No(i,e,r,t,!0)}function pt(n,e){return Fo(e,n.syncPointTree_,null,Bs(n.pendingWriteTree_,P()))}function Fo(n,e,t,s){if(x(n.path))return Uo(n,e,t,s);{const i=e.get(P());t==null&&i!=null&&(t=st(i,P()));let r=[];const o=A(n.path),a=n.operationForChild(o),l=e.children.get(o);if(l&&a){const c=t?t.getImmediateChild(o):null,h=Ro(s,o);r=r.concat(Fo(a,l,c,h))}return i&&(r=r.concat(Vs(i,n,s,t))),r}}function Uo(n,e,t,s){const i=e.get(P());t==null&&i!=null&&(t=st(i,P()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=t?t.getImmediateChild(o):null,c=Ro(s,o),h=n.operationForChild(o);h&&(r=r.concat(Uo(h,a,l,c)))}),i&&(r=r.concat(Vs(i,n,s,t))),r}function Bo(n,e){const t=e.query,s=fn(n,t);return{hashFn:()=>(dh(e)||w.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return s?Ah(n,t._path,s):Rh(n,t._path);{const r=Nc(i,t);return ms(n,t,null,r)}}}}function fn(n,e){const t=En(e);return n.queryToTagMap.get(t)}function En(n){return n._path.toString()+"$"+n._queryIdentifier}function qs(n,e){return n.tagToQueryMap.get(e)}function zs(n){const e=n.indexOf("$");return m(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new L(n.substr(0,e))}}function Gs(n,e,t){const s=n.syncPointTree_.get(e);m(s,"Missing sync point for query tag that we're tracking");const i=Bs(n.pendingWriteTree_,e);return Vs(s,t,i,null)}function xh(n){return n.fold((e,t,s)=>{if(t&&Oe(t))return[yn(t)];{let i=[];return t&&(i=Oo(t)),ne(s,(r,o)=>{i=i.concat(o)}),i}})}function Nt(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(Th())(n._repo,n._path):n}function Oh(n,e){for(let t=0;t<e.length;++t){const s=e[t];if(!s._queryParams.loadsAllData()){const i=En(s),r=n.queryToTagMap.get(i);n.queryToTagMap.delete(i),n.tagToQueryMap.delete(r)}}}function Ph(){return Ih++}function Mh(n,e,t){const s=e._path,i=fn(n,e),r=Bo(n,t),o=n.listenProvider_.startListening(Nt(e),i,r.hashFn,r.onComplete),a=n.syncPointTree_.subtree(s);if(i)m(!Oe(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,h,u)=>{if(!x(c)&&h&&Oe(h))return[yn(h).query];{let d=[];return h&&(d=d.concat(Oo(h).map(f=>f.query))),ne(u,(f,p)=>{d=d.concat(p)}),d}});for(let c=0;c<l.length;++c){const h=l[c];n.listenProvider_.stopListening(Nt(h),fn(n,h))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qh{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function wn(n,e){let t=null;for(let s=0;s<e.length;s++){const i=e[s],r=i.getPath();t!==null&&!ks(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(i)}t&&n.eventLists_.push(t)}function Yo(n,e,t){wn(n,t),Qo(n,s=>ks(s,e))}function pe(n,e,t){wn(n,t),Qo(n,s=>ce(s,e)||ce(e,s))}function Qo(n,e){n.recursionDepth_++;let t=!0;for(let s=0;s<n.eventLists_.length;s++){const i=n.eventLists_[s];if(i){const r=i.path;e(r)?(Xh(n.eventLists_[s]),n.eventLists_[s]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function Xh(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const s=t.getEventRunner();$e&&te("event: "+t.toString()),_t(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ud(n){let e="";const t=n.split("/");for(let s=0;s<t.length;s++)if(t[s].length>0){let i=t[s];try{i=decodeURIComponent(i.replace(/\+/g," "))}catch{}e+="/"+i}return e}function hd(n){const e={};n.charAt(0)==="?"&&(n=n.substring(1));for(const t of n.split("&")){if(t.length===0)continue;const s=t.split("=");s.length===2?e[decodeURIComponent(s[0])]=decodeURIComponent(s[1]):ie(`Invalid query segment '${t}' in query '${n}'`)}return e}const or=function(n,e){const t=dd(n),s=t.namespace;t.domain==="firebase.com"&&we(t.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!s||s==="undefined")&&t.domain!=="localhost"&&we("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),t.secure||Cc();const i=t.scheme==="ws"||t.scheme==="wss";return{repoInfo:new ro(t.host,t.secure,s,i,e,"",s!==t.subdomain),path:new L(t.pathString)}},dd=function(n){let e="",t="",s="",i="",r="",o=!0,a="https",l=443;if(typeof n=="string"){let c=n.indexOf("//");c>=0&&(a=n.substring(0,c-1),n=n.substring(c+2));let h=n.indexOf("/");h===-1&&(h=n.length);let u=n.indexOf("?");u===-1&&(u=n.length),e=n.substring(0,Math.min(h,u)),h<u&&(i=ud(n.substring(h,u)));const d=hd(n.substring(Math.min(n.length,u)));c=e.indexOf(":"),c>=0?(o=a==="https"||a==="wss",l=parseInt(e.substring(c+1),10)):c=e.length;const f=e.slice(0,c);if(f.toLowerCase()==="localhost")t="localhost";else if(f.split(".").length<=2)t=f;else{const p=e.indexOf(".");s=e.substring(0,p).toLowerCase(),t=e.substring(p+1),r=s}"ns"in d&&(r=d.ns)}return{host:e,port:l,domain:t,subdomain:s,secure:o,scheme:a,pathString:i,namespace:r}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ii{constructor(e,t,s,i){this._repo=e,this._path=t,this._queryParams=s,this._orderByCalled=i}get key(){return x(this._path)?null:Ds(this._path)}get ref(){return new Te(this._repo,this._path)}get _queryIdentifier(){const e=ji(this._queryParams),t=Ss(e);return t==="{}"?"default":t}get _queryObject(){return ji(this._queryParams)}isEqual(e){if(e=ye(e),!(e instanceof ii))return!1;const t=this._repo===e._repo,s=ks(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+ru(this._path)}}class Te extends ii{constructor(e,t){super(e,t,new Ms,!1)}get parent(){const e=po(this._path);return e===null?null:new Te(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Ut{constructor(e,t,s){this._node=e,this.ref=t,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new L(e),s=ht(this.ref,e);return new Ut(this._node.getChild(t),s,z)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,i)=>e(new Ut(i,ht(this.ref,s),z)))}hasChild(e){const t=new L(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function vs(n,e){return n=ye(n),n._checkNotDeleted("ref"),e!==void 0?ht(n._root,e):n._root}function ht(n,e){return n=ye(n),A(n._path)===null?Kh("child","path",e,!1):Go("child","path",e,!1),new Te(n._repo,q(n._path,e))}function ia(n,e){n=ye(n),Ko("push",n._path),zo("push",e,n._path,!0);const t=Xo(n._repo),s=fd(t),i=ht(n,s),r=ht(n,s);let o;return e!=null?o=pd(r,e).then(()=>r):o=Promise.resolve(r),i.then=o.then.bind(o),i.catch=o.then.bind(o,void 0),i}function pd(n,e){n=ye(n),Ko("set",n._path),zo("set",e,n._path,!1);const t=new Bt;return sd(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function k_(n,e){Gh("update",e,n._path,!1);const t=new Bt;return id(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}class ri{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const s=t._queryParams.getIndex();return new na("value",this,new Ut(e.snapshotNode,new Te(t._repo,t._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new sa(this,e,t):null}matches(e){return e instanceof ri?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class oi{constructor(e,t){this.eventType=e,this.callbackContext=t}respondsTo(e){let t=e==="children_added"?"child_added":e;return t=t==="children_removed"?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new sa(this,e,t):null}createEvent(e,t){m(e.childName!=null,"Child events should have a childName.");const s=ht(new Te(t._repo,t._path),e.childName),i=t._queryParams.getIndex();return new na(e.type,this,new Ut(e.snapshotNode,s,i),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof oi?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function md(n,e,t,s,i){let r;if(typeof s=="object"&&(r=void 0,i=s),typeof s=="function"&&(r=s),i&&i.onlyOnce){const l=t,c=(h,u)=>{rr(n._repo,n,a),l(h,u)};c.userCallback=t.userCallback,c.context=t.context,t=c}const o=new _d(t,r||void 0),a=e==="value"?new ri(o):new oi(e,o);return od(n._repo,n,a),()=>rr(n._repo,n,a)}function gd(n,e,t,s){return md(n,"value",e,t,s)}gh(Te);wh(Te);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nd(n){gc(Wr),Dt(new rt("database",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return bd(s,i,r,t)},"PUBLIC").setMultipleInstances(!0)),De(Ni,Ri,n),De(Ni,Ri,"esm2017")}Ce.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};Ce.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};Nd();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ra="firebasestorage.googleapis.com",oa="storageBucket",Rd=2*60*1e3,Ad=10*60*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const me={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class $n{constructor(e,t){this.data=e,this.contentType=t||null}}function af(n,e){switch(n){case me.RAW:return new $n(ca(e));case me.BASE64:case me.BASE64URL:return new $n(ua(n,e));case me.DATA_URL:return new $n(cf(e),uf(e))}throw ai()}function ca(n){const e=[];for(let t=0;t<n.length;t++){let s=n.charCodeAt(t);if(s<=127)e.push(s);else if(s<=2047)e.push(192|s>>6,128|s&63);else if((s&64512)===55296)if(!(t<n.length-1&&(n.charCodeAt(t+1)&64512)===56320))e.push(239,191,189);else{const r=s,o=n.charCodeAt(++t);s=65536|(r&1023)<<10|o&1023,e.push(240|s>>18,128|s>>12&63,128|s>>6&63,128|s&63)}else(s&64512)===56320?e.push(239,191,189):e.push(224|s>>12,128|s>>6&63,128|s&63)}return new Uint8Array(e)}function lf(n){let e;try{e=decodeURIComponent(n)}catch{throw Rt(me.DATA_URL,"Malformed data URL.")}return ca(e)}function ua(n,e){switch(n){case me.BASE64:{const i=e.indexOf("-")!==-1,r=e.indexOf("_")!==-1;if(i||r)throw Rt(n,"Invalid character '"+(i?"-":"_")+"' found: is it base64url encoded?");break}case me.BASE64URL:{const i=e.indexOf("+")!==-1,r=e.indexOf("/")!==-1;if(i||r)throw Rt(n,"Invalid character '"+(i?"+":"/")+"' found: is it base64 encoded?");e=e.replace(/-/g,"+").replace(/_/g,"/");break}}let t;try{t=of(e)}catch(i){throw i.message.includes("polyfill")?i:Rt(n,"Invalid character found")}const s=new Uint8Array(t.length);for(let i=0;i<t.length;i++)s[i]=t.charCodeAt(i);return s}class ha{constructor(e){this.base64=!1,this.contentType=null;const t=e.match(/^data:([^,]+)?,/);if(t===null)throw Rt(me.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const s=t[1]||null;s!=null&&(this.base64=hf(s,";base64"),this.contentType=this.base64?s.substring(0,s.length-7):s),this.rest=e.substring(e.indexOf(",")+1)}}function cf(n){const e=new ha(n);return e.base64?ua(me.BASE64,e.rest):lf(e.rest)}function uf(n){return new ha(n).contentType}function hf(n,e){return n.length>=e.length?n.substring(n.length-e.length)===e:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function da(n){let e;try{e=JSON.parse(n)}catch{return null}return Kd(e)?e:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function df(n){if(n.length===0)return null;const e=n.lastIndexOf("/");return e===-1?"":n.slice(0,e)}function ff(n,e){const t=e.split("/").filter(s=>s.length>0).join("/");return n.length===0?t:n+"/"+t}function fa(n){const e=n.lastIndexOf("/",n.length-2);return e===-1?n:n.slice(e+1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _f(n,e){return e}class se{constructor(e,t,s,i){this.server=e,this.local=t||e,this.writable=!!s,this.xform=i||_f}}let Yt=null;function pf(n){return!li(n)||n.length<2?n:fa(n)}function _a(){if(Yt)return Yt;const n=[];n.push(new se("bucket")),n.push(new se("generation")),n.push(new se("metageneration")),n.push(new se("name","fullPath",!0));function e(r,o){return pf(o)}const t=new se("name");t.xform=e,n.push(t);function s(r,o){return o!==void 0?Number(o):o}const i=new se("size");return i.xform=s,n.push(i),n.push(new se("timeCreated")),n.push(new se("updated")),n.push(new se("md5Hash",null,!0)),n.push(new se("cacheControl",null,!0)),n.push(new se("contentDisposition",null,!0)),n.push(new se("contentEncoding",null,!0)),n.push(new se("contentLanguage",null,!0)),n.push(new se("contentType",null,!0)),n.push(new se("metadata","customMetadata",!0)),Yt=n,Yt}function mf(n,e){function t(){const s=n.bucket,i=n.fullPath,r=new le(s,i);return e._makeStorageReference(r)}Object.defineProperty(n,"ref",{get:t})}function gf(n,e,t){const s={};s.type="file";const i=t.length;for(let r=0;r<i;r++){const o=t[r];s[o.local]=o.xform(s,e[o.server])}return mf(s,n),s}function pa(n,e,t){const s=da(e);return s===null?null:gf(n,s,t)}function yf(n,e,t,s){const i=da(e);if(i===null||!li(i.downloadTokens))return null;const r=i.downloadTokens;if(r.length===0)return null;const o=encodeURIComponent;return r.split(",").map(c=>{const h=n.bucket,u=n.fullPath,d="/b/"+o(h)+"/o/"+o(u),f=ui(d,t,s),p=la({alt:"media",token:c});return f+p})[0]}function vf(n,e){const t={},s=e.length;for(let i=0;i<s;i++){const r=e[i];r.writable&&(t[r.server]=n[r.local])}return JSON.stringify(t)}class ma{constructor(e,t,s,i){this.url=e,this.method=t,this.handler=s,this.timeout=i,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ga(n){if(!n)throw ai()}function Ef(n,e){function t(s,i){const r=pa(n,i,e);return ga(r!==null),r}return t}function bf(n,e){function t(s,i){const r=pa(n,i,e);return ga(r!==null),yf(r,i,n.host,n._protocol)}return t}function ya(n){function e(t,s){let i;return t.getStatus()===401?t.getErrorText().includes("Firebase App Check token is invalid")?i=Od():i=xd():t.getStatus()===402?i=kd(n.bucket):t.getStatus()===403?i=Pd(n.path):i=s,i.status=t.getStatus(),i.serverResponse=s.serverResponse,i}return e}function Cf(n){const e=ya(n);function t(s,i){let r=e(s,i);return s.getStatus()===404&&(r=Dd(n.path)),r.serverResponse=i.serverResponse,r}return t}function wf(n,e,t){const s=e.fullServerUrl(),i=ui(s,n.host,n._protocol),r="GET",o=n.maxOperationRetryTime,a=new ma(i,r,bf(n,t),o);return a.errorHandler=Cf(e),a}function Tf(n,e){return n&&n.contentType||e&&e.type()||"application/octet-stream"}function If(n,e,t){const s=Object.assign({},t);return s.fullPath=n.path,s.size=e.size(),s.contentType||(s.contentType=Tf(null,e)),s}function Sf(n,e,t,s,i){const r=e.bucketOnlyServerUrl(),o={"X-Goog-Upload-Protocol":"multipart"};function a(){let C="";for(let N=0;N<2;N++)C=C+Math.random().toString().slice(2);return C}const l=a();o["Content-Type"]="multipart/related; boundary="+l;const c=If(e,s,i),h=vf(c,t),u="--"+l+`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ye{constructor(e,t){this._service=e,t instanceof le?this._location=t:this._location=le.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new Ye(e,t)}get root(){const e=new le(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return fa(this._location.path)}get storage(){return this._service}get parent(){const e=df(this._location.path);if(e===null)return null;const t=new le(this._location.bucket,e);return new Ye(this._service,t)}_throwIfRoot(e){if(this._location.path==="")throw Vd(e)}}function Af(n,e,t){n._throwIfRoot("uploadBytes");const s=Sf(n.storage,n._location,_a(),new Se(e,!0),t);return n.storage.makeRequestWithTokens(s,va).then(i=>({metadata:i,ref:n}))}function Df(n){n._throwIfRoot("getDownloadURL");const e=wf(n.storage,n._location,_a());return n.storage.makeRequestWithTokens(e,va).then(t=>{if(t===null)throw Hd();return t})}function kf(n,e){const t=ff(n._location.path,e),s=new le(n._location.bucket,t);return new Ye(n.storage,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ba="storage";function Lf(n,e,t){return n=ye(n),Af(n,e,t)}function Ff(n){return n=ye(n),Df(n)}function Uf(n,e){return n=ye(n),Pf(n,e)}function Ca(n=$r(),e){n=ye(n);const s=Br(n,ba).getImmediate({identifier:e}),i=Ar("storage");return i&&Bf(s,...i),s}function Bf(n,e,t,s={}){Mf(n,e,t,s)}function Wf(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),s=n.getProvider("auth-internal"),i=n.getProvider("app-check-internal");return new hi(t,s,i,e,Wr)}function Hf(){Dt(new rt(ba,Wf,"PUBLIC").setMultipleInstances(!0)),De(hr,dr,""),De(hr,dr,"esm2017")}Hf();const $f={apiKey:"AIzaSyD1bUd4QHmDnXtuA1SZgvxiaRcmuEVLpWo",authDomain:"instagram-imitation-180e8.firebaseapp.com",databaseURL:"https://instagram-imitation-180e8-default-rtdb.firebaseio.com",projectId:"instagram-imitation-180e8",storageBucket:"instagram-imitation-180e8.appspot.com",messagingSenderId:"266282768545",appId:"1:266282768545:web:07dbf92d25e2a93b3078e0"},di=Hr($f),Cs=Id(di);Ca(di);const Vf="/Instagram-Imitation/assets/Instagram_logo_light-WGj1KLTg.png";var wa={exports:{}},Qt={exports:{}};/*!
