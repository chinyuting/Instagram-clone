import{f as et,h as JI,q as ZI,r as Ke,j as eC,_ as Dp,o as nc,k as Lp,a as Ne,c as ke,b as q,m as ut,w as ui,y as lo,u as _o,t as co,i as Mp,v as Up,l as Pr,F as Dr,z as Fp,A as Bp,B as Nl,d as tC,s as nC,C as iC,e as kl}from"./index-KmnQRUYI.js";var cf={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rt(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function kc(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(rt())}function dC(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function jp(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function fC(){const n=rt();return n.indexOf("MSIE ")>=0||n.indexOf("Trident/")>=0}function Qp(){return Wp.NODE_ADMIN===!0}function pC(){try{return typeof indexedDB=="object"}catch{return!1}}function _C(){return new Promise((n,e)=>{try{let t=!0;const r="validate-browser-context-for-indexeddb-analytics-module",o=self.indexedDB.open(r);o.onsuccess=()=>{o.result.close(),t||self.indexedDB.deleteDatabase(r),n(!0)},o.onupgradeneeded=()=>{t=!1},o.onerror=()=>{var a;e(((a=o.error)===null||a===void 0?void 0:a.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hr(n){return JSON.parse(n)}function Qe(n){return JSON.stringify(n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xp=function(n){let e={},t={},r={},o="";try{const a=n.split(".");e=Hr(mo(a[0])||""),t=Hr(mo(a[1])||""),o=a[2],r=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:r,signature:o}},yC=function(n){const e=Xp(n),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},wC=function(n){const e=Xp(n).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class GC{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(zC(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function zC(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const oc="@firebase/app",pf="0.10.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wo=new Map,yT=new Map,lc=new Map;function _f(n,e){try{n.container.addComponent(e)}catch(t){fi.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function pi(n){const e=n.name;if(lc.has(e))return fi.debug(`There were multiple attempts to register component ${e}.`),!1;lc.set(e,n);for(const t of wo.values())_f(t,n);for(const t of yT.values())_f(t,n);return!0}function Ho(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function pn(n){return n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ei=mT;function e_(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r=Object.assign({name:ac,automaticDataCollectionEnabled:!1},e),o=r.name;if(typeof o!="string"||!o)throw qn.create("bad-app-name",{appName:String(o)});if(t||(t=zp()),!t)throw qn.create("no-options");const a=wo.get(o);if(a){if(yo(t,a.options)&&yo(r,a.config))return a;throw qn.create("duplicate-app",{appName:o})}const c=new NC(o);for(const d of lc.values())c.addComponent(d);const h=new ET(t,r,c);return wo.set(o,h),h}function Pc(n=ac){const e=wo.get(n);if(!e&&n===ac&&zp())return e_();if(!e)throw qn.create("no-app",{appName:n});return e}function Jt(n,e,t){var r;let o=(r=vT[n])!==null&&r!==void 0?r:n;t&&(o+=`-${t}`);const a=o.match(/\s|\//),c=e.match(/\s|\//);if(a||c){const h=[`Unable to register library "${o}" with version "${e}":`];a&&h.push(`library name "${o}" contains illegal characters (whitespace or "/")`),a&&c&&h.push("and"),c&&h.push(`version name "${e}" contains illegal characters (whitespace or "/")`),fi.warn(h.join(" "));return}pi(new Kn(`${o}-version`,()=>({library:o,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bT="firebase-heartbeat-database",IT=1,$r="firebase-heartbeat-store";let Ll=null;function t_(){return Ll||(Ll=$C(bT,IT,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore($r)}catch(t){console.warn(t)}}}}).catch(n=>{throw qn.create("idb-open",{originalErrorMessage:n.message})})),Ll}async function CT(n){try{const t=(await t_()).transaction($r),r=await t.objectStore($r).get(n_(n));return await t.done,r}catch(e){if(e instanceof In)fi.warn(e.message);else{const t=qn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});fi.warn(t.message)}}}async function gf(n,e){try{const r=(await t_()).transaction($r,"readwrite");await r.objectStore($r).put(e,n_(n)),await r.done}catch(t){if(t instanceof In)fi.warn(t.message);else{const r=qn.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});fi.warn(r.message)}}}function n_(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kT(n){pi(new Kn("platform-logger",e=>new GC(e),"PRIVATE")),pi(new Kn("heartbeat",e=>new AT(e),"PRIVATE")),Jt(oc,pf,n),Jt(oc,pf,"esm2017"),Jt("fire-js","")}kT("");var OT="firebase",xT="10.11.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const r_=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new DT(e)}}catch{}return new LT},ci=r_("localStorage"),cc=r_("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mc="5",l_="v",c_="s",u_="r",h_="f",d_=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,f_="ls",p_="p",hc="ac",__="websocket",g_="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bo extends T_{constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!kc()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new bo}getInitialEvent(e){return M(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hc extends T_{constructor(){super(["visible"]);let e,t;typeof document<"u"&&typeof document.addEventListener<"u"&&(typeof document.hidden<"u"?(t="visibilitychange",e="hidden"):typeof document.mozHidden<"u"?(t="mozvisibilitychange",e="mozHidden"):typeof document.msHidden<"u"?(t="msvisibilitychange",e="msHidden"):typeof document.webkitHidden<"u"&&(t="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,t&&document.addEventListener(t,()=>{const r=!document[e];r!==this.visible_&&(this.visible_=r,this.trigger("visible",r))},!1)}static getInstance(){return new Hc}getInitialEvent(e){return M(e==="visible","Unknown event type: "+e),[this.visible_]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,`
FIREBASE: `))}restoreState_(){this.tryAuth(),this.tryAppCheck();for(const e of this.listens.values())for(const t of e.values())this.sendListen_(t);for(let e=0;e<this.outstandingPuts_.length;e++)this.outstandingPuts_[e]&&this.sendPut_(e);for(;this.onDisconnectRequestQueue_.length;){const e=this.onDisconnectRequestQueue_.shift();this.sendOnDisconnect_(e.action,e.pathString,e.data,e.onComplete)}for(let e=0;e<this.outstandingGets_.length;e++)this.outstandingGets_[e]&&this.sendGet_(e)}sendConnectStats_(){const e={};let t="js";e["sdk."+t+"."+i_.replace(/\./g,"-")]=1,kc()?e["framework.cordova"]=1:jp()&&(e["framework.reactnative"]=1),this.reportStats(e)}shouldReconnect_(){const e=bo.getInstance().currentlyOnline();return ic(this.interruptReasons_)&&e}}yn.nextPersistentConnectionId_=0;yn.nextConnectionId_=0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let to;class R_ extends $o{static get __EMPTY_NODE(){return to}static set __EMPTY_NODE(e){to=e}compare(e,t){return bi(e.name,t.name)}isDefinedOn(e){throw nr("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return ae.MIN}maxPost(){return new ae(_i,to)}makePost(e,t){return M(typeof e=="string","KeyIndex indexValue must always be a string."),new ae(e,to)}toString(){return".key"}}const qi=new R_;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let dc;function xS(n){dc=n}const N_=function(n){return typeof n=="number"?"number:"+a_(n):"string:"+n},k_=function(n){if(n.isLeafNode()){const e=n.val();M(typeof e=="string"||typeof e=="number"||typeof e=="object"&&tn(e,".sv"),"Priority must be a string or number.")}else M(n===dc||n.isEmpty(),"priority of unexpected type.");M(n===dc||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const MS=Math.log(2);class US{constructor(e){const t=a=>parseInt(Math.log(a)/MS,10),r=a=>parseInt(Array(a+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const o=r(this.count);this.bits_=e+1&o}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const Io=function(n,e,t,r){n.sort(e);const o=function(d,p){const y=p-d;let v,b;if(y===0)return null;if(y===1)return v=n[d],b=t?t(v):v,new Ye(b,v.node,Ye.BLACK,null,null);{const C=parseInt(y/2,10)+d,A=o(d,C),U=o(C+1,p);return v=n[C],b=t?t(v):v,new Ye(b,v.node,Ye.BLACK,A,U)}},a=function(d){let p=null,y=null,v=n.length;const b=function(A,U){const P=v-A,Y=v;v-=A;const W=o(P+1,Y),B=n[P],L=t?t(B):B;C(new Ye(L,B.node,U,null,W))},C=function(A){p?(p.left=A,p=A):(y=A,p=A)};for(let A=0;A<d.count;++A){const U=d.nextBitIsOne(),P=Math.pow(2,d.count-(A+1));U?b(P,Ye.BLACK):(b(P,Ye.BLACK),b(P,Ye.RED))}return y},c=new US(n.length),h=a(c);return new mt(r||e,h)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yr{constructor(e,t){this.source=e,this.path=t,this.type=qt.LISTEN_COMPLETE}operationForChild(e){return ce(this.path)?new Yr(this.source,pe()):new Yr(this.source,Se(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gi{constructor(e,t,r){this.source=e,this.path=t,this.snap=r,this.type=qt.OVERWRITE}operationForChild(e){return ce(this.path)?new gi(this.source,pe(),this.snap.getImmediateChild(e)):new gi(this.source,Se(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ji{constructor(e,t,r){this.source=e,this.path=t,this.children=r,this.type=qt.MERGE}operationForChild(e){if(ce(this.path)){const t=this.children.subtree(new we(e));return t.isEmpty()?null:t.value?new gi(this.source,pe(),t.value):new Ji(this.source,pe(),t)}else return M(oe(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Ji(this.source,Se(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Wl;const nA=()=>(Wl||(Wl=new mt(WT)),Wl);class Te{constructor(e,t=nA()){this.value=e,this.children=t}static fromObject(e){let t=new Te(null);return tt(e,(r,o)=>{t=t.set(new we(r),o)}),t}isEmpty(){return this.value===null&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(this.value!=null&&t(this.value))return{path:pe(),value:this.value};if(ce(e))return null;{const r=oe(e),o=this.children.get(r);if(o!==null){const a=o.findRootMostMatchingPathAndValue(Se(e),t);return a!=null?{path:Me(new we(r),a.path),value:a.value}:null}else return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,()=>!0)}subtree(e){if(ce(e))return this;{const t=oe(e),r=this.children.get(t);return r!==null?r.subtree(Se(e)):new Te(null)}}set(e,t){if(ce(e))return new Te(t,this.children);{const r=oe(e),a=(this.children.get(r)||new Te(null)).set(Se(e),t),c=this.children.insert(r,a);return new Te(this.value,c)}}remove(e){if(ce(e))return this.children.isEmpty()?new Te(null):new Te(null,this.children);{const t=oe(e),r=this.children.get(t);if(r){const o=r.remove(Se(e));let a;return o.isEmpty()?a=this.children.remove(t):a=this.children.insert(t,o),this.value===null&&a.isEmpty()?new Te(null):new Te(this.value,a)}else return this}}get(e){if(ce(e))return this.value;{const t=oe(e),r=this.children.get(t);return r?r.get(Se(e)):null}}setTree(e,t){if(ce(e))return t;{const r=oe(e),a=(this.children.get(r)||new Te(null)).setTree(Se(e),t);let c;return a.isEmpty()?c=this.children.remove(r):c=this.children.insert(r,a),new Te(this.value,c)}}fold(e){return this.fold_(pe(),e)}fold_(e,t){const r={};return this.children.inorderTraversal((o,a)=>{r[o]=a.fold_(Me(e,o),t)}),t(e,this.value,r)}findOnPath(e,t){return this.findOnPath_(e,pe(),t)}findOnPath_(e,t,r){const o=this.value?r(t,this.value):!1;if(o)return o;if(ce(e))return null;{const a=oe(e),c=this.children.get(a);return c?c.findOnPath_(Se(e),Me(t,a),r):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,pe(),t)}foreachOnPath_(e,t,r){if(ce(e))return this;{this.value&&r(t,this.value);const o=oe(e),a=this.children.get(o);return a?a.foreachOnPath_(Se(e),Me(t,o),r):new Te(null)}}foreach(e){this.foreach_(pe(),e)}foreach_(e,t){this.children.inorderTraversal((r,o)=>{o.foreach_(Me(e,r),t)}),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal((t,r)=>{r.value&&e(t,r.value)})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yc(n,e){return W_(e,n)}function iA(n,e,t,r,o){M(r>n.lastWriteId,"Stacking an older write on top of newer ones"),o===void 0&&(o=!0),n.allWrites.push({path:e,snap:t,writeId:r,visible:o}),o&&(n.visibleWrites=Ur(n.visibleWrites,e,t)),n.lastWriteId=r}function rA(n,e,t,r){M(r>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:r,visible:!0}),n.visibleWrites=_c(n.visibleWrites,e,t),n.lastWriteId=r}function sA(n,e){for(let t=0;t<n.allWrites.length;t++){const r=n.allWrites[t];if(r.writeId===e)return r}return null}function oA(n,e){const t=n.allWrites.findIndex(h=>h.writeId===e);M(t>=0,"removeWrite called with nonexistent writeId.");const r=n.allWrites[t];n.allWrites.splice(t,1);let o=r.visible,a=!1,c=n.allWrites.length-1;for(;o&&c>=0;){const h=n.allWrites[c];h.visible&&(c>=t&&aA(h,r.path)?o=!1:Lt(r.path,h.path)&&(a=!0)),c--}if(o){if(a)return lA(n),!0;if(r.snap)n.visibleWrites=Bf(n.visibleWrites,r.path);else{const h=r.children;tt(h,d=>{n.visibleWrites=Bf(n.visibleWrites,Me(r.path,d))})}return!0}else return!1}function aA(n,e){if(n.snap)return Lt(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&Lt(Me(n.path,t),e))return!0;return!1}function lA(n){n.visibleWrites=U_(n.allWrites,cA,pe()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function cA(n){return n.visible}function U_(n,e,t){let r=Gt.empty();for(let o=0;o<n.length;++o){const a=n[o];if(e(a)){const c=a.path;let h;if(a.snap)Lt(t,c)?(h=gt(t,c),r=Ur(r,h,a.snap)):Lt(c,t)&&(h=gt(c,t),r=Ur(r,pe(),a.snap.getChild(h)));else if(a.children){if(Lt(t,c))h=gt(t,c),r=_c(r,h,a.children);else if(Lt(c,t))if(h=gt(c,t),ce(h))r=_c(r,pe(),a.children);else{const d=ji(a.children,oe(h));if(d){const p=d.getChild(Se(h));r=Ur(r,pe(),p)}}}else throw nr("WriteRecord should have .snap or .children")}}return r}function F_(n,e,t,r,o){if(!r&&!o){const a=Ii(n.visibleWrites,e);if(a!=null)return a;{const c=Gn(n.visibleWrites,e);if(mc(c))return t;if(t==null&&!gc(c,pe()))return null;{const h=t||X.EMPTY_NODE;return Zi(c,h)}}}else{const a=Gn(n.visibleWrites,e);if(!o&&mc(a))return t;if(!o&&t==null&&!gc(a,pe()))return null;{const c=function(p){return(p.visible||o)&&(!r||!~r.indexOf(p.writeId))&&(Lt(p.path,e)||Lt(e,p.path))},h=U_(n.allWrites,c,e),d=t||X.EMPTY_NODE;return Zi(h,d)}}}function uA(n,e,t){let r=X.EMPTY_NODE;const o=Ii(n.visibleWrites,e);if(o)return o.isLeafNode()||o.forEachChild(Ue,(a,c)=>{r=r.updateImmediateChild(a,c)}),r;if(t){const a=Gn(n.visibleWrites,e);return t.forEachChild(Ue,(c,h)=>{const d=Zi(Gn(a,new we(c)),h);r=r.updateImmediateChild(c,d)}),Wf(a).forEach(c=>{r=r.updateImmediateChild(c.name,c.node)}),r}else{const a=Gn(n.visibleWrites,e);return Wf(a).forEach(c=>{r=r.updateImmediateChild(c.name,c.node)}),r}}function hA(n,e,t,r,o){M(r||o,"Either existingEventSnap or existingServerSnap must exist");const a=Me(e,t);if(gc(n.visibleWrites,a))return null;{const c=Gn(n.visibleWrites,a);return mc(c)?o.getChild(t):Zi(c,o.getChild(t))}}function dA(n,e,t,r){const o=Me(e,t),a=Ii(n.visibleWrites,o);if(a!=null)return a;if(r.isCompleteForChild(t)){const c=Gn(n.visibleWrites,o);return Zi(c,r.getNode().getImmediateChild(t))}else return null}function fA(n,e){return Ii(n.visibleWrites,e)}function pA(n,e,t,r,o,a,c){let h;const d=Gn(n.visibleWrites,e),p=Ii(d,pe());if(p!=null)h=p;else if(t!=null)h=Zi(d,t);else return[];if(h=h.withIndex(c),!h.isEmpty()&&!h.isLeafNode()){const y=[],v=c.getCompare(),b=a?h.getReverseIteratorFrom(r,c):h.getIteratorFrom(r,c);let C=b.getNext();for(;C&&y.length<o;)v(C,r)!==0&&y.push(C),C=b.getNext();return y}else return[]}function _A(){return{visibleWrites:Gt.empty(),allWrites:[],lastWriteId:-1}}function Ao(n,e,t,r){return F_(n.writeTree,n.treePath,e,t,r)}function jc(n,e){return uA(n.writeTree,n.treePath,e)}function Hf(n,e,t,r){return hA(n.writeTree,n.treePath,e,t,r)}function Ro(n,e){return fA(n.writeTree,Me(n.treePath,e))}function gA(n,e,t,r,o,a){return pA(n.writeTree,n.treePath,e,t,r,o,a)}function Qc(n,e,t){return dA(n.writeTree,n.treePath,e,t)}function B_(n,e){return W_(Me(n.treePath,e),n.writeTree)}function W_(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yA(n){return{filter:n}}function wA(n,e){M(e.eventCache.getNode().isIndexed(n.filter.getIndex()),"Event snap not indexed"),M(e.serverCache.getNode().isIndexed(n.filter.getIndex()),"Server snap not indexed")}function EA(n,e,t,r,o){const a=new mA;let c,h;if(t.type===qt.OVERWRITE){const p=t;p.source.fromUser?c=vc(n,e,p.path,p.snap,r,o,a):(M(p.source.fromServer,"Unknown source."),h=p.source.tagged||e.serverCache.isFiltered()&&!ce(p.path),c=No(n,e,p.path,p.snap,r,o,h,a))}else if(t.type===qt.MERGE){const p=t;p.source.fromUser?c=IA(n,e,p.path,p.children,r,o,a):(M(p.source.fromServer,"Unknown source."),h=p.source.tagged||e.serverCache.isFiltered(),c=yc(n,e,p.path,p.children,r,o,h,a))}else if(t.type===qt.ACK_USER_WRITE){const p=t;p.revert?c=SA(n,e,p.path,r,o,a):c=CA(n,e,p.path,p.affectedTree,r,o,a)}else if(t.type===qt.LISTEN_COMPLETE)c=TA(n,e,t.path,r,a);else throw nr("Unknown operation type: "+t.type);const d=a.getChanges();return bA(e,c,d),{viewCache:c,changes:d}}function bA(n,e,t){const r=e.eventCache;if(r.isFullyInitialized()){const o=r.getNode().isLeafNode()||r.getNode().isEmpty(),a=pc(n);(t.length>0||!n.eventCache.isFullyInitialized()||o&&!r.getNode().equals(a)||!r.getNode().getPriority().equals(a.getPriority()))&&t.push(P_(pc(e)))}}function $_(n,e,t,r,o,a){const c=e.eventCache;if(Ro(r,t)!=null)return e;{let h,d;if(ce(t))if(M(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const p=vi(e),y=p instanceof X?p:X.EMPTY_NODE,v=jc(r,y);h=n.filter.updateFullNode(e.eventCache.getNode(),v,a)}else{const p=Ao(r,vi(e));h=n.filter.updateFullNode(e.eventCache.getNode(),p,a)}else{const p=oe(t);if(p===".priority"){M(Yn(t)===1,"Can't have a priority with additional path components");const y=c.getNode();d=e.serverCache.getNode();const v=Hf(r,t,y,d);v!=null?h=n.filter.updatePriority(y,v):h=c.getNode()}else{const y=Se(t);let v;if(c.isCompleteForChild(p)){d=e.serverCache.getNode();const b=Hf(r,t,c.getNode(),d);b!=null?v=c.getNode().getImmediateChild(p).updateChild(y,b):v=c.getNode().getImmediateChild(p)}else v=Qc(r,p,e.serverCache);v!=null?h=n.filter.updateChild(c.getNode(),p,v,y,o,a):h=c.getNode()}}return Mr(e,h,c.isFullyInitialized()||ce(t),n.filter.filtersNodes())}}function No(n,e,t,r,o,a,c,h){const d=e.serverCache;let p;const y=c?n.filter:n.filter.getIndexedFilter();if(ce(t))p=y.updateFullNode(d.getNode(),r,null);else if(y.filtersNodes()&&!d.isFiltered()){const C=d.getNode().updateChild(t,r);p=y.updateFullNode(d.getNode(),C,null)}else{const C=oe(t);if(!d.isCompleteForPath(t)&&Yn(t)>1)return e;const A=Se(t),P=d.getNode().getImmediateChild(C).updateChild(A,r);C===".priority"?p=y.updatePriority(d.getNode(),P):p=y.updateChild(d.getNode(),C,P,A,H_,null)}const v=L_(e,p,d.isFullyInitialized()||ce(t),y.filtersNodes()),b=new Xc(o,v,a);return $_(n,v,t,o,b,h)}function vc(n,e,t,r,o,a,c){const h=e.eventCache;let d,p;const y=new Xc(o,e,a);if(ce(t))p=n.filter.updateFullNode(e.eventCache.getNode(),r,c),d=Mr(e,p,!0,n.filter.filtersNodes());else{const v=oe(t);if(v===".priority")p=n.filter.updatePriority(e.eventCache.getNode(),r),d=Mr(e,p,h.isFullyInitialized(),h.isFiltered());else{const b=Se(t),C=h.getNode().getImmediateChild(v);let A;if(ce(b))A=r;else{const U=y.getCompleteChild(v);U!=null?Bc(b)===".priority"&&U.getChild(S_(b)).isEmpty()?A=U:A=U.updateChild(b,r):A=X.EMPTY_NODE}if(C.equals(A))d=e;else{const U=n.filter.updateChild(h.getNode(),v,A,b,y,c);d=Mr(e,U,h.isFullyInitialized(),n.filter.filtersNodes())}}}return d}function $f(n,e){return n.eventCache.isCompleteForChild(e)}function IA(n,e,t,r,o,a,c){let h=e;return r.foreach((d,p)=>{const y=Me(t,d);$f(e,oe(y))&&(h=vc(n,h,y,p,o,a,c))}),r.foreach((d,p)=>{const y=Me(t,d);$f(e,oe(y))||(h=vc(n,h,y,p,o,a,c))}),h}function Vf(n,e,t){return t.foreach((r,o)=>{e=e.updateChild(r,o)}),e}function yc(n,e,t,r,o,a,c,h){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let d=e,p;ce(t)?p=r:p=new Te(null).setTree(t,r);const y=e.serverCache.getNode();return p.children.inorderTraversal((v,b)=>{if(y.hasChild(v)){const C=e.serverCache.getNode().getImmediateChild(v),A=Vf(n,C,b);d=No(n,d,new we(v),A,o,a,c,h)}}),p.children.inorderTraversal((v,b)=>{const C=!e.serverCache.isCompleteForChild(v)&&b.value===null;if(!y.hasChild(v)&&!C){const A=e.serverCache.getNode().getImmediateChild(v),U=Vf(n,A,b);d=No(n,d,new we(v),U,o,a,c,h)}}),d}function CA(n,e,t,r,o,a,c){if(Ro(o,t)!=null)return e;const h=e.serverCache.isFiltered(),d=e.serverCache;if(r.value!=null){if(ce(t)&&d.isFullyInitialized()||d.isCompleteForPath(t))return No(n,e,t,d.getNode().getChild(t),o,a,h,c);if(ce(t)){let p=new Te(null);return d.getNode().forEachChild(qi,(y,v)=>{p=p.set(new we(y),v)}),yc(n,e,t,p,o,a,h,c)}else return e}else{let p=new Te(null);return r.foreach((y,v)=>{const b=Me(t,y);d.isCompleteForPath(b)&&(p=p.set(y,d.getNode().getChild(b)))}),yc(n,e,t,p,o,a,h,c)}}function TA(n,e,t,r,o){const a=e.serverCache,c=L_(e,a.getNode(),a.isFullyInitialized()||ce(t),a.isFiltered());return $_(n,c,t,r,H_,o)}function SA(n,e,t,r,o,a){let c;if(Ro(r,t)!=null)return e;{const h=new Xc(r,e,o),d=e.eventCache.getNode();let p;if(ce(t)||oe(t)===".priority"){let y;if(e.serverCache.isFullyInitialized())y=Ao(r,vi(e));else{const v=e.serverCache.getNode();M(v instanceof X,"serverChildren would be complete if leaf node"),y=jc(r,v)}y=y,p=n.filter.updateFullNode(d,y,a)}else{const y=oe(t);let v=Qc(r,y,e.serverCache);v==null&&e.serverCache.isCompleteForChild(y)&&(v=d.getImmediateChild(y)),v!=null?p=n.filter.updateChild(d,y,v,Se(t),h,a):e.eventCache.getNode().hasChild(y)?p=n.filter.updateChild(d,y,X.EMPTY_NODE,Se(t),h,a):p=d,p.isEmpty()&&e.serverCache.isFullyInitialized()&&(c=Ao(r,vi(e)),c.isLeafNode()&&(p=n.filter.updateFullNode(p,c,a)))}return c=e.serverCache.isFullyInitialized()||Ro(r,pe())!=null,Mr(e,p,c,n.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Oo;function BA(n){M(!Oo,"__referenceConstructor has already been defined"),Oo=n}function WA(){return M(Oo,"Reference.ts has not been loaded"),Oo}let HA=1;class Kf{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Te(null),this.pendingWriteTree_=_A(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function K_(n,e,t,r,o){return iA(n.pendingWriteTree_,e,t,r,o),o?sr(n,new gi(Gc(),e,t)):[]}function $A(n,e,t,r){rA(n.pendingWriteTree_,e,t,r);const o=Te.fromObject(t);return sr(n,new Ji(Gc(),e,o))}function $n(n,e,t=!1){const r=sA(n.pendingWriteTree_,e);if(oA(n.pendingWriteTree_,e)){let a=new Te(null);return r.snap!=null?a=a.set(pe(),!0):tt(r.children,c=>{a=a.set(new we(c),!0)}),sr(n,new So(r.path,a,t))}else return[]}function Go(n,e,t){return sr(n,new gi(zc(),e,t))}function VA(n,e,t){const r=Te.fromObject(t);return sr(n,new Ji(zc(),e,r))}function qA(n,e){return sr(n,new Yr(zc(),e))}function GA(n,e,t){const r=eu(n,t);if(r){const o=tu(r),a=o.path,c=o.queryId,h=gt(a,e),d=new Yr(Kc(c),h);return nu(n,a,d)}else return[]}function wc(n,e,t,r,o=!1){const a=e._path,c=n.syncPointTree_.get(a);let h=[];if(c&&(e._queryIdentifier==="default"||z_(c,e))){const d=FA(c,e,t,r);LA(c)&&(n.syncPointTree_=n.syncPointTree_.remove(a));const p=d.removed;if(h=d.events,!o){const y=p.findIndex(b=>b._queryParams.loadsAllData())!==-1,v=n.syncPointTree_.findOnPath(a,(b,C)=>jn(C));if(y&&!v){const b=n.syncPointTree_.subtree(a);if(!b.isEmpty()){const C=YA(b);for(let A=0;A<C.length;++A){const U=C[A],P=U.query,Y=Q_(n,U);n.listenProvider_.startListening(Fr(P),xo(n,P),Y.hashFn,Y.onComplete)}}}!v&&p.length>0&&!r&&(y?n.listenProvider_.stopListening(Fr(e),null):p.forEach(b=>{const C=n.queryToTagMap.get(zo(b));n.listenProvider_.stopListening(Fr(b),C)}))}jA(n,p)}return h}function zA(n,e,t,r){const o=eu(n,r);if(o!=null){const a=tu(o),c=a.path,h=a.queryId,d=gt(c,e),p=new gi(Kc(h),d,t);return nu(n,c,p)}else return[]}function KA(n,e,t,r){const o=eu(n,r);if(o){const a=tu(o),c=a.path,h=a.queryId,d=gt(c,e),p=Te.fromObject(t),y=new Ji(Kc(h),d,p);return nu(n,c,y)}else return[]}function Yf(n,e,t,r=!1){const o=e._path;let a=null,c=!1;n.syncPointTree_.foreachOnPath(o,(b,C)=>{const A=gt(b,o);a=a||Gi(C,A),c=c||jn(C)});let h=n.syncPointTree_.get(o);h?(c=c||jn(h),a=a||Gi(h,pe())):(h=new xA,n.syncPointTree_=n.syncPointTree_.set(o,h));let d;a!=null?d=!0:(d=!1,a=X.EMPTY_NODE,n.syncPointTree_.subtree(o).foreachChild((C,A)=>{const U=Gi(A,pe());U&&(a=a.updateImmediateChild(C,U))}));const p=z_(h,e);if(!p&&!e._queryParams.loadsAllData()){const b=zo(e);M(!n.queryToTagMap.has(b),"View does not exist, but we have a tag");const C=QA();n.queryToTagMap.set(b,C),n.tagToQueryMap.set(C,b)}const y=Yc(n.pendingWriteTree_,o);let v=UA(h,e,t,y,a,d);if(!p&&!c&&!r){const b=G_(h,e);v=v.concat(XA(n,e,b))}return v}function Zc(n,e,t){const o=n.pendingWriteTree_,a=n.syncPointTree_.findOnPath(e,(c,h)=>{const d=gt(c,e),p=Gi(h,d);if(p)return p});return F_(o,e,a,t,!0)}function sr(n,e){return Y_(e,n.syncPointTree_,null,Yc(n.pendingWriteTree_,pe()))}function Y_(n,e,t,r){if(ce(n.path))return j_(n,e,t,r);{const o=e.get(pe());t==null&&o!=null&&(t=Gi(o,pe()));let a=[];const c=oe(n.path),h=n.operationForChild(c),d=e.children.get(c);if(d&&h){const p=t?t.getImmediateChild(c):null,y=B_(r,c);a=a.concat(Y_(h,d,p,y))}return o&&(a=a.concat(Jc(o,n,r,t))),a}}function j_(n,e,t,r){const o=e.get(pe());t==null&&o!=null&&(t=Gi(o,pe()));let a=[];return e.children.inorderTraversal((c,h)=>{const d=t?t.getImmediateChild(c):null,p=B_(r,c),y=n.operationForChild(c);y&&(a=a.concat(j_(y,h,d,p)))}),o&&(a=a.concat(Jc(o,n,r,t))),a}function Q_(n,e){const t=e.query,r=xo(n,t);return{hashFn:()=>(RA(e)||X.EMPTY_NODE).hash(),onComplete:o=>{if(o==="ok")return r?GA(n,t._path,r):qA(n,t._path);{const a=VT(o,t);return wc(n,t,null,a)}}}}function xo(n,e){const t=zo(e);return n.queryToTagMap.get(t)}function zo(n){return n._path.toString()+"$"+n._queryIdentifier}function eu(n,e){return n.tagToQueryMap.get(e)}function tu(n){const e=n.indexOf("$");return M(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new we(n.substr(0,e))}}function nu(n,e,t){const r=n.syncPointTree_.get(e);M(r,"Missing sync point for query tag that we're tracking");const o=Yc(n.pendingWriteTree_,e);return Jc(r,t,o,null)}function YA(n){return n.fold((e,t,r)=>{if(t&&jn(t))return[qo(t)];{let o=[];return t&&(o=q_(t)),tt(r,(a,c)=>{o=o.concat(c)}),o}})}function Fr(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(WA())(n._repo,n._path):n}function jA(n,e){for(let t=0;t<e.length;++t){const r=e[t];if(!r._queryParams.loadsAllData()){const o=zo(r),a=n.queryToTagMap.get(o);n.queryToTagMap.delete(o),n.tagToQueryMap.delete(a)}}}function QA(){return HA++}function XA(n,e,t){const r=e._path,o=xo(n,e),a=Q_(n,t),c=n.listenProvider_.startListening(Fr(e),o,a.hashFn,a.onComplete),h=n.syncPointTree_.subtree(r);if(o)M(!jn(h.value),"If we're adding a query, it shouldn't be shadowed");else{const d=h.fold((p,y,v)=>{if(!ce(p)&&y&&jn(y))return[qo(y).query];{let b=[];return y&&(b=b.concat(q_(y).map(C=>C.query))),tt(v,(C,A)=>{b=b.concat(A)}),b}});for(let p=0;p<d.length;++p){const y=d[p];n.listenProvider_.stopListening(Fr(y),xo(n,y))}}return c}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rR=/[\[\].#$\/\u0000-\u001F\u007F]/,sR=/[\[\].#$\u0000-\u001F\u007F]/,Hl=10*1024*1024,lu=function(n){return typeof n=="string"&&n.length!==0&&!rR.test(n)},ng=function(n){return typeof n=="string"&&n.length!==0&&!sR.test(n)},oR=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),ng(n)},aR=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!Dc(n)||n&&typeof n=="object"&&tn(n,".sv")},ig=function(n,e,t,r){r&&e===void 0||Yo(Bo(n,"value"),e,t)},Yo=function(n,e,t){const r=t instanceof we?new IS(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+li(r));if(typeof e=="function")throw new Error(n+"contains a function "+li(r)+" with contents = "+e.toString());if(Dc(e))throw new Error(n+"contains "+e.toString()+" "+li(r));if(typeof e=="string"&&e.length>Hl/3&&Wo(e)>Hl)throw new Error(n+"contains a string greater than "+Hl+" utf8 bytes "+li(r)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let o=!1,a=!1;if(tt(e,(c,h)=>{if(c===".value")o=!0;else if(c!==".priority"&&c!==".sv"&&(a=!0,!lu(c)))throw new Error(n+" contains an invalid key ("+c+") "+li(r)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);CS(r,c),Yo(n,h,r),TS(r)}),o&&a)throw new Error(n+' contains ".value" child '+li(r)+" in addition to actual children.")}},lR=function(n,e){let t,r;for(t=0;t<e.length;t++){r=e[t];const a=qr(r);for(let c=0;c<a.length;c++)if(!(a[c]===".priority"&&c===a.length-1)){if(!lu(a[c]))throw new Error(n+"contains an invalid key ("+a[c]+") in path "+r.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(bS);let o=null;for(t=0;t<e.length;t++){if(r=e[t],o!==null&&Lt(o,r))throw new Error(n+"contains a path "+o.toString()+" that is ancestor of another path "+r.toString());o=r}},cR=function(n,e,t,r){if(r&&e===void 0)return;const o=Bo(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(o+" must be an object containing the children to replace.");const a=[];tt(e,(c,h)=>{const d=new we(c);if(Yo(o,h,Me(t,d)),Bc(d)===".priority"&&!aR(h))throw new Error(o+"contains an invalid value for '"+d.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");a.push(d)}),lR(o,a)},rg=function(n,e,t,r){if(!(r&&t===void 0)&&!ng(t))throw new Error(Bo(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},uR=function(n,e,t,r){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),rg(n,e,t,r)},sg=function(n,e){if(oe(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},hR=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!lu(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!oR(t))throw new Error(Bo(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pR="repo_interrupt",_R=25;class gR{constructor(e,t,r,o){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=r,this.appCheckProvider_=o,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new dR,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=To(),this.transactionQueueTree_=new ou,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function mR(n,e,t){if(n.stats_=Uc(n.repoInfo_),n.forceRestClient_||KT())n.server_=new Co(n.repoInfo_,(r,o,a,c)=>{Qf(n,r,o,a,c)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>Xf(n,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Qe(t)}catch(r){throw new Error("Invalid authOverride provided: "+r)}}n.persistentConnection_=new yn(n.repoInfo_,e,(r,o,a,c)=>{Qf(n,r,o,a,c)},r=>{Xf(n,r)},r=>{vR(n,r)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(r=>{n.server_.refreshAuthToken(r)}),n.appCheckProvider_.addTokenChangeListener(r=>{n.server_.refreshAppCheckToken(r.token)}),n.statsReporter_=JT(n.repoInfo_,()=>new XS(n.stats_,n.server_)),n.infoData_=new zS,n.infoSyncTree_=new Kf({startListening:(r,o,a,c)=>{let h=[];const d=n.infoData_.getNode(r._path);return d.isEmpty()||(h=Go(n.infoSyncTree_,r._path,d),setTimeout(()=>{c("ok")},0)),h},stopListening:()=>{}}),cu(n,"connected",!1),n.serverSyncTree_=new Kf({startListening:(r,o,a,c)=>(n.server_.listen(r,a,o,(h,d)=>{const p=c(h,d);zt(n.eventQueue_,r._path,p)}),[]),stopListening:(r,o)=>{n.server_.unlisten(r,o)}})}function lg(n){const t=n.infoData_.getNode(new we(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function Qo(n){return JA({timestamp:lg(n)})}function Qf(n,e,t,r,o){n.dataUpdateCount++;const a=new we(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let c=[];if(o)if(r){const d=vo(t,p=>je(p));c=KA(n.serverSyncTree_,a,d,o)}else{const d=je(t);c=zA(n.serverSyncTree_,a,d,o)}else if(r){const d=vo(t,p=>je(p));c=VA(n.serverSyncTree_,a,d)}else{const d=je(t);c=Go(n.serverSyncTree_,a,d)}let h=a;c.length>0&&(h=er(n,a)),zt(n.eventQueue_,h,c)}function Xf(n,e){cu(n,"connected",e),e===!1&&ER(n)}function vR(n,e){tt(e,(t,r)=>{cu(n,t,r)})}function cu(n,e,t){const r=new we("/.info/"+e),o=je(t);n.infoData_.updateSnapshot(r,o);const a=Go(n.infoSyncTree_,r,o);zt(n.eventQueue_,r,a)}function uu(n){return n.nextWriteId_++}function yR(n,e,t,r,o){Xo(n,"set",{path:e.toString(),value:t,priority:r});const a=Qo(n),c=je(t,r),h=Zc(n.serverSyncTree_,e),d=J_(c,h,a),p=uu(n),y=K_(n.serverSyncTree_,e,d,p,!0);jo(n.eventQueue_,y),n.server_.put(e.toString(),c.val(!0),(b,C)=>{const A=b==="ok";A||ht("set at "+e+" failed: "+b);const U=$n(n.serverSyncTree_,p,!A);zt(n.eventQueue_,e,U),bc(n,o,b,C)});const v=du(n,e);er(n,v),zt(n.eventQueue_,v,[])}function wR(n,e,t,r){Xo(n,"update",{path:e.toString(),value:t});let o=!0;const a=Qo(n),c={};if(tt(t,(h,d)=>{o=!1,c[h]=X_(Me(e,h),je(d),n.serverSyncTree_,a)}),o)Ze("update() called with empty data.  Don't do anything."),bc(n,r,"ok",void 0);else{const h=uu(n),d=$A(n.serverSyncTree_,e,c,h);jo(n.eventQueue_,d),n.server_.merge(e.toString(),t,(p,y)=>{const v=p==="ok";v||ht("update at "+e+" failed: "+p);const b=$n(n.serverSyncTree_,h,!v),C=b.length>0?er(n,e):e;zt(n.eventQueue_,C,b),bc(n,r,p,y)}),tt(t,p=>{const y=du(n,Me(e,p));er(n,y)}),zt(n.eventQueue_,e,[])}}function ER(n){Xo(n,"onDisconnectEvents");const e=Qo(n),t=To();fc(n.onDisconnect_,pe(),(o,a)=>{const c=X_(o,a,n.serverSyncTree_,e);D_(t,o,c)});let r=[];fc(t,pe(),(o,a)=>{r=r.concat(Go(n.serverSyncTree_,o,a));const c=du(n,o);er(n,c)}),n.onDisconnect_=To(),zt(n.eventQueue_,pe(),r)}function bR(n,e,t){let r;oe(e._path)===".info"?r=Yf(n.infoSyncTree_,e,t):r=Yf(n.serverSyncTree_,e,t),og(n.eventQueue_,e._path,r)}function Jf(n,e,t){let r;oe(e._path)===".info"?r=wc(n.infoSyncTree_,e,t):r=wc(n.serverSyncTree_,e,t),og(n.eventQueue_,e._path,r)}function IR(n){n.persistentConnection_&&n.persistentConnection_.interrupt(pR)}function Xo(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),Ze(t,...e)}function bc(n,e,t,r){e&&rr(()=>{if(t==="ok")e(null);else{const o=(t||"error").toUpperCase();let a=o;r&&(a+=": "+r);const c=new Error(a);c.code=o,e(c)}})}function cg(n,e,t){return Zc(n.serverSyncTree_,e,t)||X.EMPTY_NODE}function hu(n,e=n.transactionQueueTree_){if(e||Jo(n,e),or(e)){const t=hg(n,e);M(t.length>0,"Sending zero length transaction queue"),t.every(o=>o.status===0)&&CR(n,rs(e),t)}else eg(e)&&Ko(e,t=>{hu(n,t)})}function CR(n,e,t){const r=t.map(p=>p.currentWriteId),o=cg(n,e,r);let a=o;const c=o.hash();for(let p=0;p<t.length;p++){const y=t[p];M(y.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),y.status=1,y.retryCount++;const v=gt(e,y.path);a=a.updateChild(v,y.currentOutputSnapshotRaw)}const h=a.val(!0),d=e;n.server_.put(d.toString(),h,p=>{Xo(n,"transaction put response",{path:d.toString(),status:p});let y=[];if(p==="ok"){const v=[];for(let b=0;b<t.length;b++)t[b].status=2,y=y.concat($n(n.serverSyncTree_,t[b].currentWriteId)),t[b].onComplete&&v.push(()=>t[b].onComplete(null,!0,t[b].currentOutputSnapshotResolved)),t[b].unwatcher();Jo(n,au(n.transactionQueueTree_,e)),hu(n,n.transactionQueueTree_),zt(n.eventQueue_,e,y);for(let b=0;b<v.length;b++)rr(v[b])}else{if(p==="datastale")for(let v=0;v<t.length;v++)t[v].status===3?t[v].status=4:t[v].status=0;else{ht("transaction at "+d.toString()+" failed: "+p);for(let v=0;v<t.length;v++)t[v].status=4,t[v].abortReason=p}er(n,e)}},c)}function er(n,e){const t=ug(n,e),r=rs(t),o=hg(n,t);return TR(n,o,r),r}function TR(n,e,t){if(e.length===0)return;const r=[];let o=[];const c=e.filter(h=>h.status===0).map(h=>h.currentWriteId);for(let h=0;h<e.length;h++){const d=e[h],p=gt(t,d.path);let y=!1,v;if(M(p!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),d.status===4)y=!0,v=d.abortReason,o=o.concat($n(n.serverSyncTree_,d.currentWriteId,!0));else if(d.status===0)if(d.retryCount>=_R)y=!0,v="maxretry",o=o.concat($n(n.serverSyncTree_,d.currentWriteId,!0));else{const b=cg(n,d.path,c);d.currentInputSnapshot=b;const C=e[h].update(b.val());if(C!==void 0){Yo("transaction failed: Data returned ",C,d.path);let A=je(C);typeof C=="object"&&C!=null&&tn(C,".priority")||(A=A.updatePriority(b.getPriority()));const P=d.currentWriteId,Y=Qo(n),W=J_(A,b,Y);d.currentOutputSnapshotRaw=A,d.currentOutputSnapshotResolved=W,d.currentWriteId=uu(n),c.splice(c.indexOf(P),1),o=o.concat(K_(n.serverSyncTree_,d.path,W,d.currentWriteId,d.applyLocally)),o=o.concat($n(n.serverSyncTree_,P,!0))}else y=!0,v="nodata",o=o.concat($n(n.serverSyncTree_,d.currentWriteId,!0))}zt(n.eventQueue_,t,o),o=[],y&&(e[h].status=2,function(b){setTimeout(b,Math.floor(0))}(e[h].unwatcher),e[h].onComplete&&(v==="nodata"?r.push(()=>e[h].onComplete(null,!1,e[h].currentInputSnapshot)):r.push(()=>e[h].onComplete(new Error(v),!1,null))))}Jo(n,n.transactionQueueTree_);for(let h=0;h<r.length;h++)rr(r[h]);hu(n,n.transactionQueueTree_)}function ug(n,e){let t,r=n.transactionQueueTree_;for(t=oe(e);t!==null&&or(r)===void 0;)r=au(r,t),e=Se(e),t=oe(e);return r}function hg(n,e){const t=[];return dg(n,e,t),t.sort((r,o)=>r.order-o.order),t}function dg(n,e,t){const r=or(e);if(r)for(let o=0;o<r.length;o++)t.push(r[o]);Ko(e,o=>{dg(n,o,t)})}function Jo(n,e){const t=or(e);if(t){let r=0;for(let o=0;o<t.length;o++)t[o].status!==2&&(t[r]=t[o],r++);t.length=r,Z_(e,t.length>0?t:void 0)}Ko(e,r=>{Jo(n,r)})}function du(n,e){const t=rs(ug(n,e)),r=au(n.transactionQueueTree_,e);return nR(r,o=>{$l(n,o)}),$l(n,r),tg(r,o=>{$l(n,o)}),t}function $l(n,e){const t=or(e);if(t){const r=[];let o=[],a=-1;for(let c=0;c<t.length;c++)t[c].status===3||(t[c].status===1?(M(a===c-1,"All SENT items should be at beginning of queue."),a=c,t[c].status=3,t[c].abortReason="set"):(M(t[c].status===0,"Unexpected transaction status in abort"),t[c].unwatcher(),o=o.concat($n(n.serverSyncTree_,t[c].currentWriteId,!0)),t[c].onComplete&&r.push(t[c].onComplete.bind(null,new Error("set"),!1,null))));a===-1?Z_(e,void 0):t.length=a+1,zt(n.eventQueue_,rs(e),o);for(let c=0;c<r.length;c++)rr(r[c])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fu{constructor(e,t,r,o){this._repo=e,this._path=t,this._queryParams=r,this._orderByCalled=o}get key(){return ce(this._path)?null:Bc(this._path)}get ref(){return new Cn(this._repo,this._path)}get _queryIdentifier(){const e=Uf(this._queryParams),t=Lc(e);return t==="{}"?"default":t}get _queryObject(){return Uf(this._queryParams)}isEqual(e){if(e=st(e),!(e instanceof fu))return!1;const t=this._repo===e._repo,r=Wc(this._path,e._path),o=this._queryIdentifier===e._queryIdentifier;return t&&r&&o}toJSON(){return this.toString()}toString(){return this._repo.toString()+ES(this._path)}}class Cn extends fu{constructor(e,t){super(e,t,new qc,!1)}get parent(){const e=S_(this._path);return e===null?null:new Cn(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class jr{constructor(e,t,r){this._node=e,this.ref=t,this._index=r}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new we(e),r=tr(this.ref,e);return new jr(this._node.getChild(t),r,Ue)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(r,o)=>e(new jr(o,tr(this.ref,r),Ue)))}hasChild(e){const t=new we(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Qr(n,e){return n=st(n),n._checkNotDeleted("ref"),e!==void 0?tr(n._root,e):n._root}function tr(n,e){return n=st(n),oe(n._path)===null?uR("child","path",e,!1):rg("child","path",e,!1),new Cn(n._repo,Me(n._path,e))}function _g(n,e){n=st(n),sg("push",n._path),ig("push",e,n._path,!0);const t=lg(n._repo),r=NR(t),o=tr(n,r),a=tr(n,r);let c;return e!=null?c=OR(a,e).then(()=>a):c=Promise.resolve(a),o.then=c.then.bind(c),o.catch=c.then.bind(c,void 0),o}function OR(n,e){n=st(n),sg("set",n._path),ig("set",e,n._path,!1);const t=new Zr;return yR(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function xR(n,e){cR("update",e,n._path,!1);const t=new Zr;return wR(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}class pu{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const r=t._queryParams.getIndex();return new fg("value",this,new jr(e.snapshotNode,new Cn(t._repo,t._path),r))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new pg(this,e,t):null}matches(e){return e instanceof pu?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class _u{constructor(e,t){this.eventType=e,this.callbackContext=t}respondsTo(e){let t=e==="children_added"?"child_added":e;return t=t==="children_removed"?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new pg(this,e,t):null}createEvent(e,t){M(e.childName!=null,"Child events should have a childName.");const r=tr(new Cn(t._repo,t._path),e.childName),o=t._queryParams.getIndex();return new fg(e.type,this,new jr(e.snapshotNode,r,o),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof _u?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function PR(n,e,t,r,o){let a;if(typeof r=="object"&&(a=void 0,o=r),typeof r=="function"&&(a=r),o&&o.onlyOnce){const d=t,p=(y,v)=>{Jf(n._repo,n,h),d(y,v)};p.userCallback=t.userCallback,p.context=t.context,t=p}const c=new kR(t,a||void 0),h=e==="value"?new pu(c):new _u(e,c);return bR(n._repo,n,h),()=>Jf(n._repo,n,h)}function gg(n,e,t,r){return PR(n,"value",e,t,r)}PA(Cn);BA(Cn);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tt{constructor(e,t){this.bucket=e,this.path_=t}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,t){let r;try{r=Tt.makeFromUrl(e,t)}catch{return new Tt(e,"")}if(r.path==="")return r;throw eN(e)}static makeFromUrl(e,t){let r=null;const o="([A-Za-z0-9.\\-_]+)";function a(L){L.path.charAt(L.path.length-1)==="/"&&(L.path_=L.path_.slice(0,-1))}const c="(/(.*))?$",h=new RegExp("^gs://"+o+c,"i"),d={bucket:1,path:3};function p(L){L.path_=decodeURIComponent(L.path)}const y="v[A-Za-z0-9_]+",v=t.replace(/[.]/g,"\\."),b="(/([^?#]*).*)?$",C=new RegExp(`^https?://${v}/${y}/b/${o}/o${b}`,"i"),A={bucket:1,path:3},U=t===mg?"(?:storage.googleapis.com|storage.cloud.google.com)":t,P="([^?#]*)",Y=new RegExp(`^https?://${U}/${o}/${P}`,"i"),B=[{regex:h,indices:d,postModify:a},{regex:C,indices:A,postModify:p},{regex:Y,indices:{bucket:1,path:2},postModify:p}];for(let L=0;L<B.length;L++){const V=B[L],x=V.regex.exec(e);if(x){const D=x[V.indices.bucket];let $=x[V.indices.path];$||($=""),r=new Tt(D,$),V.postModify(r);break}}if(r==null)throw ZR(e);return r}}class oN{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function aN(n,e,t){let r=1,o=null,a=null,c=!1,h=0;function d(){return h===2}let p=!1;function y(...P){p||(p=!0,e.apply(null,P))}function v(P){o=setTimeout(()=>{o=null,n(C,d())},P)}function b(){a&&clearTimeout(a)}function C(P,...Y){if(p){b();return}if(P){b(),y.call(null,P,...Y);return}if(d()||c){b(),y.call(null,P,...Y);return}r<64&&(r*=2);let B;h===1?(h=2,B=0):B=(r+Math.random())*1e3,v(B)}let A=!1;function U(P){A||(A=!0,b(),!p&&(o!==null?(P||(h=2),clearTimeout(o),v(0)):P||(h=1)))}return v(0),a=setTimeout(()=>{c=!0,U(!0)},t),U}function lN(n){n(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cN(n){return n!==void 0}function uN(n){return typeof n=="object"&&!Array.isArray(n)}function mu(n){return typeof n=="string"||n instanceof String}function tp(n){return vu()&&n instanceof Blob}function vu(){return typeof Blob<"u"}function np(n,e,t,r){if(r<e)throw Cc(`Invalid value for '${n}'. Expected ${e} or greater.`);if(r>t)throw Cc(`Invalid value for '${n}'. Expected ${t} or less.`)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Po=new Oc("@firebase/auth");function r1(n,...e){Po.logLevel<=ye.WARN&&Po.warn(`Auth (${Ei}): ${n}`,...e)}function uo(n,...e){Po.logLevel<=ye.ERROR&&Po.error(`Auth (${Ei}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tc(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.href)||""}function s1(){return op()==="http:"||op()==="https:"}function op(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ss{constructor(e,t){this.shortDelay=e,this.longDelay=t,bn(t>e,"Short delay should be less than long delay!"),this.isMobile=kc()||jp()}get(){return o1()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wr(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function d1(n,e=!1){const t=st(n),r=await t.getIdToken(e),o=Cu(r);ee(o&&o.exp&&o.auth_time&&o.iat,t.auth,"internal-error");const a=typeof o.firebase=="object"?o.firebase:void 0,c=a==null?void 0:a.sign_in_provider;return{claims:o,token:r,authTime:Wr(Gl(o.auth_time)),issuedAtTime:Wr(Gl(o.iat)),expirationTime:Wr(Gl(o.exp)),signInProvider:c||null,signInSecondFactor:(a==null?void 0:a.sign_in_second_factor)||null}}function Gl(n){return Number(n)*1e3}function Cu(n){const[e,t,r]=n.split(".");if(e===void 0||t===void 0||r===void 0)return uo("JWT malformed, contained fewer than 3 sections"),null;try{const o=mo(t);return o?JSON.parse(o):(uo("Failed to decode base64 JWT payload"),null)}catch(o){return uo("Caught error parsing JWT payload as JSON",o==null?void 0:o.toString()),null}}function ap(n){const e=Cu(n);return ee(e,"internal-error"),ee(typeof e.exp<"u","internal-error"),ee(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mn(n,e){ee(typeof n=="string"||typeof n>"u","internal-error",{appName:e})}class mn{constructor(e){var{uid:t,auth:r,stsTokenManager:o}=e,a=Eu(e,["uid","auth","stsTokenManager"]);this.providerId="firebase",this.proactiveRefresh=new p1(this),this.reloadUserInfo=null,this.reloadListener=null,this.uid=t,this.auth=r,this.stsTokenManager=o,this.accessToken=o.accessToken,this.displayName=a.displayName||null,this.email=a.email||null,this.emailVerified=a.emailVerified||!1,this.phoneNumber=a.phoneNumber||null,this.photoURL=a.photoURL||null,this.isAnonymous=a.isAnonymous||!1,this.tenantId=a.tenantId||null,this.providerData=a.providerData?[...a.providerData]:[],this.metadata=new Sc(a.createdAt||void 0,a.lastLoginAt||void 0)}async getIdToken(e){const t=await Xr(this,this.stsTokenManager.getToken(this.auth,e));return ee(t,this.auth,"internal-error"),this.accessToken!==t&&(this.accessToken=t,await this.auth._persistUserIfCurrent(this),this.auth._notifyListenersIfCurrent(this)),t}getIdTokenResult(e){return d1(this,e)}reload(){return _1(this)}_assign(e){this!==e&&(ee(this.uid===e.uid,this.auth,"internal-error"),this.displayName=e.displayName,this.photoURL=e.photoURL,this.email=e.email,this.emailVerified=e.emailVerified,this.phoneNumber=e.phoneNumber,this.isAnonymous=e.isAnonymous,this.tenantId=e.tenantId,this.providerData=e.providerData.map(t=>Object.assign({},t)),this.metadata._copy(e.metadata),this.stsTokenManager._assign(e.stsTokenManager))}_clone(e){const t=new mn(Object.assign(Object.assign({},this),{auth:e,stsTokenManager:this.stsTokenManager._clone()}));return t.metadata._copy(this.metadata),t}_onReload(e){ee(!this.reloadListener,this.auth,"internal-error"),this.reloadListener=e,this.reloadUserInfo&&(this._notifyReloadListener(this.reloadUserInfo),this.reloadUserInfo=null)}_notifyReloadListener(e){this.reloadListener?this.reloadListener(e):this.reloadUserInfo=e}_startProactiveRefresh(){this.proactiveRefresh._start()}_stopProactiveRefresh(){this.proactiveRefresh._stop()}async _updateTokensIfNecessary(e,t=!1){let r=!1;e.idToken&&e.idToken!==this.stsTokenManager.accessToken&&(this.stsTokenManager.updateFromServerResponse(e),r=!0),t&&await Do(this),await this.auth._persistUserIfCurrent(this),r&&this.auth._notifyListenersIfCurrent(this)}async delete(){if(pn(this.auth.app))return Promise.reject(zn(this.auth));const e=await this.getIdToken();return await Xr(this,h1(this.auth,{idToken:e})),this.stsTokenManager.clearRefreshToken(),this.auth.signOut()}toJSON(){return Object.assign(Object.assign({uid:this.uid,email:this.email||void 0,emailVerified:this.emailVerified,displayName:this.displayName||void 0,isAnonymous:this.isAnonymous,photoURL:this.photoURL||void 0,phoneNumber:this.phoneNumber||void 0,tenantId:this.tenantId||void 0,providerData:this.providerData.map(e=>Object.assign({},e)),stsTokenManager:this.stsTokenManager.toJSON(),_redirectEventId:this._redirectEventId},this.metadata.toJSON()),{apiKey:this.auth.config.apiKey,appName:this.auth.name})}get refreshToken(){return this.stsTokenManager.refreshToken||""}static _fromJSON(e,t){var r,o,a,c,h,d,p,y;const v=(r=t.displayName)!==null&&r!==void 0?r:void 0,b=(o=t.email)!==null&&o!==void 0?o:void 0,C=(a=t.phoneNumber)!==null&&a!==void 0?a:void 0,A=(c=t.photoURL)!==null&&c!==void 0?c:void 0,U=(h=t.tenantId)!==null&&h!==void 0?h:void 0,P=(d=t._redirectEventId)!==null&&d!==void 0?d:void 0,Y=(p=t.createdAt)!==null&&p!==void 0?p:void 0,W=(y=t.lastLoginAt)!==null&&y!==void 0?y:void 0,{uid:B,emailVerified:L,isAnonymous:V,providerData:x,stsTokenManager:D}=t;ee(B&&D,e,"internal-error");const $=zi.fromJSON(this.name,D);ee(typeof B=="string",e,"internal-error"),Mn(v,e.name),Mn(b,e.name),ee(typeof L=="boolean",e,"internal-error"),ee(typeof V=="boolean",e,"internal-error"),Mn(C,e.name),Mn(A,e.name),Mn(U,e.name),Mn(P,e.name),Mn(Y,e.name),Mn(W,e.name);const J=new mn({uid:B,auth:e,email:b,emailVerified:L,displayName:v,isAnonymous:V,photoURL:A,phoneNumber:C,tenantId:U,stsTokenManager:$,createdAt:Y,lastLoginAt:W});return x&&Array.isArray(x)&&(J.providerData=x.map(me=>Object.assign({},me))),P&&(J._redirectEventId=P),J}static async _fromIdTokenResponse(e,t,r=!1){const o=new zi;o.updateFromServerResponse(t);const a=new mn({uid:t.localId,auth:e,stsTokenManager:o,isAnonymous:r});return await Do(a),a}static async _fromGetAccountInfoResponse(e,t,r){const o=t.users[0];ee(o.localId!==void 0,"internal-error");const a=o.providerUserInfo!==void 0?Vg(o.providerUserInfo):[],c=!(o.email&&o.passwordHash)&&!(a!=null&&a.length),h=new zi;h.updateFromIdToken(r);const d=new mn({uid:o.localId,auth:e,stsTokenManager:h,isAnonymous:c}),p={uid:o.localId,displayName:o.displayName||null,photoURL:o.photoUrl||null,email:o.email||null,emailVerified:o.emailVerified||!1,phoneNumber:o.phoneNumber||null,tenantId:o.tenantId||null,providerData:a,metadata:new Sc(o.createdAt,o.lastLoginAt),isAnonymous:!(o.email&&o.passwordHash)&&!(a!=null&&a.length)};return Object.assign(d,p),d}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function up(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Kg(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Gg(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(jg(e))return"Blackberry";if(Qg(e))return"Webos";if(Tu(e))return"Safari";if((e.includes("chrome/")||zg(e))&&!e.includes("edge/"))return"Chrome";if(Yg(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function Gg(n=rt()){return/firefox\//i.test(n)}function Tu(n=rt()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function zg(n=rt()){return/crios\//i.test(n)}function Kg(n=rt()){return/iemobile/i.test(n)}function Yg(n=rt()){return/android/i.test(n)}function jg(n=rt()){return/blackberry/i.test(n)}function Qg(n=rt()){return/webos/i.test(n)}function ea(n=rt()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function y1(n=rt()){var e;return ea(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function w1(){return fC()&&document.documentMode===10}function Xg(n=rt()){return ea(n)||Yg(n)||Qg(n)||jg(n)||/windows phone/i.test(n)||Kg(n)}function E1(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jg(n,e=[]){let t;switch(n){case"Browser":t=up(rt());break;case"Worker":t=`${up(rt())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${Ei}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function B1(n,e,t=!1){const{auth:r}=n;if(pn(r.app))return Promise.reject(zn(r));const o="reauthenticate";try{const a=await Xr(n,nm(r,o,e,n),t);ee(a.idToken,r,"internal-error");const c=Cu(a.idToken);ee(c,r,"internal-error");const{sub:h}=c;return ee(n.uid===h,r,"user-mismatch"),Qn._forOperation(n,o,a)}catch(a){throw(a==null?void 0:a.code)==="auth/user-not-found"&&En(r,"user-mismatch"),a}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $k="__/auth/handler",Vk="emulator/auth/handler",qk=encodeURIComponent("fac");async function yp(n,e,t,r,o,a){ee(n.config.authDomain,n,"auth-domain-config-required"),ee(n.config.apiKey,n,"invalid-api-key");const c={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:r,v:Ei,eventId:o};if(e instanceof tm){e.setDefaultLanguage(n.languageCode),c.providerId=e.providerId||"",ic(e.getCustomParameters())||(c.customParameters=JSON.stringify(e.getCustomParameters()));for(const[y,v]of Object.entries(a||{}))c[y]=v}if(e instanceof os){const y=e.getScopes().filter(v=>v!=="");y.length>0&&(c.scopes=y.join(","))}n.tenantId&&(c.tid=n.tenantId);const h=c;for(const y of Object.keys(h))h[y]===void 0&&delete h[y];const d=await n._getAppCheckToken(),p=d?`#${qk}=${encodeURIComponent(d)}`:"";return`${Gk(n)}?${ir(h).slice(1)}${p}`}function Gk({config:n}){return n.emulator?Iu(n,Vk):`https://${n.authDomain}/${$k}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zl="webStorageSupport";class zk{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=om,this._completeRedirectFn=gk,this._overrideRedirectResult=fk}async _openPopup(e,t,r,o){var a;bn((a=this.eventManagers[e._key()])===null||a===void 0?void 0:a.manager,"_initialize() not called before _openPopup()");const c=await yp(e,t,r,Tc(),o);return Wk(e,c,Au())}async _openRedirect(e,t,r,o){await this._originValidation(e);const a=await yp(e,t,r,Tc(),o);return j1(a),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:o,promise:a}=this.eventManagers[t];return o?Promise.resolve(o):(bn(a,"If manager is not set, promise should be"),a)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await Dk(e),r=new vk(e);return t.register("authEvent",o=>(ee(o==null?void 0:o.authEvent,e,"invalid-auth-event"),{status:r.onEvent(o.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(zl,{type:zl},o=>{var a;const c=(a=o==null?void 0:o[0])===null||a===void 0?void 0:a[zl];c!==void 0&&t(!!c),En(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Ik(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Xg()||Tu()||ea()}}const Kk=zk;var wp="@firebase/auth",Ep="1.7.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xk=5*60,Jk=Kp("authIdTokenMaxAge")||Xk;let bp=null;const Zk=n=>async e=>{const t=e&&await e.getIdTokenResult(),r=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(r&&r>Jk)return;const o=t==null?void 0:t.token;bp!==o&&(bp=o,await fetch(n,{method:o?"POST":"DELETE",headers:o?{Authorization:`Bearer ${o}`}:{}}))};function eO(n=Pc()){const e=Ho(n,"auth");if(e.isInitialized())return e.getImmediate();const t=O1(n,{popupRedirectResolver:Kk,persistence:[rk,z1,om]}),r=Kp("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const a=new URL(r,location.origin);if(location.origin===a.origin){const c=Zk(a.toString());$1(t,c,()=>c(t.currentUser)),H1(t,h=>c(h))}}const o=qp("auth");return o&&P1(t,`http://${o}`),t}function tO(){var n,e;return(e=(n=document.getElementsByTagName("head"))===null||n===void 0?void 0:n[0])!==null&&e!==void 0?e:document}A1({loadJS(n){return new Promise((e,t)=>{const r=document.createElement("script");r.setAttribute("src",n),r.onload=e,r.onerror=o=>{const a=Zt("internal-error");a.customData=o,t(a)},r.type="text/javascript",r.charset="UTF-8",tO().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Qk("Browser");const nO={apiKey:"AIzaSyD1bUd4QHmDnXtuA1SZgvxiaRcmuEVLpWo",authDomain:"instagram-imitation-180e8.firebaseapp.com",databaseURL:"https://instagram-imitation-180e8-default-rtdb.firebaseio.com",projectId:"instagram-imitation-180e8",storageBucket:"instagram-imitation-180e8.appspot.com",messagingSenderId:"266282768545",appId:"1:266282768545:web:07dbf92d25e2a93b3078e0"},ra=e_(nO),Sx=eO(ra),Jr=HR(ra);Dg(ra);const iO="/Instagram-Imitation/assets/Instagram_logo_light-WGj1KLTg.png";var fm={exports:{}},oo={exports:{}};/*!
  * Bootstrap index.js v5.2.3 (https://getbootstrap.com/)
  * Copyright 2011-2022 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
  */var Ip;function Xn(){return Ip||(Ip=1,function(n,e){(function(t,r){r(e)})(et,function(t){const a="transitionend",c=R=>R==null?`${R}`:Object.prototype.toString.call(R).match(/\s([a-z]+)/i)[1].toLowerCase(),h=R=>{do R+=Math.floor(Math.random()*1e6);while(document.getElementById(R));return R},d=R=>{let z=R.getAttribute("data-bs-target");if(!z||z==="#"){let Z=R.getAttribute("href");if(!Z||!Z.includes("#")&&!Z.startsWith("."))return null;Z.includes("#")&&!Z.startsWith("#")&&(Z=`#${Z.split("#")[1]}`),z=Z&&Z!=="#"?Z.trim():null}return z},p=R=>{const z=d(R);return z&&document.querySelector(z)?z:null},y=R=>{const z=d(R);return z?document.querySelector(z):null},v=R=>{if(!R)return 0;let{transitionDuration:z,transitionDelay:Z}=window.getComputedStyle(R);const Ae=Number.parseFloat(z),be=Number.parseFloat(Z);return!Ae&&!be?0:(z=z.split(",")[0],Z=Z.split(",")[0],(Number.parseFloat(z)+Number.parseFloat(Z))*1e3)},b=R=>{R.dispatchEvent(new Event(a))},C=R=>!R||typeof R!="object"?!1:(typeof R.jquery<"u"&&(R=R[0]),typeof R.nodeType<"u"),A=R=>C(R)?R.jquery?R[0]:R:typeof R=="string"&&R.length>0?document.querySelector(R):null,U=R=>{if(!C(R)||R.getClientRects().length===0)return!1;const z=getComputedStyle(R).getPropertyValue("visibility")==="visible",Z=R.closest("details:not([open])");if(!Z)return z;if(Z!==R){const Ae=R.closest("summary");if(Ae&&Ae.parentNode!==Z||Ae===null)return!1}return z},P=R=>!R||R.nodeType!==Node.ELEMENT_NODE||R.classList.contains("disabled")?!0:typeof R.disabled<"u"?R.disabled:R.hasAttribute("disabled")&&R.getAttribute("disabled")!=="false",Y=R=>{if(!document.documentElement.attachShadow)return null;if(typeof R.getRootNode=="function"){const z=R.getRootNode();return z instanceof ShadowRoot?z:null}return R instanceof ShadowRoot?R:R.parentNode?Y(R.parentNode):null},W=()=>{},B=R=>{R.offsetHeight},L=()=>window.jQuery&&!document.body.hasAttribute("data-bs-no-jquery")?window.jQuery:null,V=[],x=R=>{document.readyState==="loading"?(V.length||document.addEventListener("DOMContentLoaded",()=>{for(const z of V)z()}),V.push(R)):R()},D=()=>document.documentElement.dir==="rtl",$=R=>{x(()=>{const z=L();if(z){const Z=R.NAME,Ae=z.fn[Z];z.fn[Z]=R.jQueryInterface,z.fn[Z].Constructor=R,z.fn[Z].noConflict=()=>(z.fn[Z]=Ae,R.jQueryInterface)}})},J=R=>{typeof R=="function"&&R()},me=(R,z,Z=!0)=>{if(!Z){J(R);return}const be=v(z)+5;let Ie=!1;const Pe=({target:Mt})=>{Mt===z&&(Ie=!0,z.removeEventListener(a,Pe),J(R))};z.addEventListener(a,Pe),setTimeout(()=>{Ie||b(z)},be)},ve=(R,z,Z,Ae)=>{const be=R.length;let Ie=R.indexOf(z);return Ie===-1?!Z&&Ae?R[be-1]:R[0]:(Ie+=Z?1:-1,Ae&&(Ie=(Ie+be)%be),R[Math.max(0,Math.min(Ie,be-1))])};t.defineJQueryPlugin=$,t.execute=J,t.executeAfterTransition=me,t.findShadowRoot=Y,t.getElement=A,t.getElementFromSelector=y,t.getNextActiveElement=ve,t.getSelectorFromElement=p,t.getTransitionDurationFromElement=v,t.getUID=h,t.getjQuery=L,t.isDisabled=P,t.isElement=C,t.isRTL=D,t.isVisible=U,t.noop=W,t.onDOMContentLoaded=x,t.reflow=B,t.toType=c,t.triggerTransitionEnd=b,Object.defineProperties(t,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})})}(oo,oo.exports)),oo.exports}var Kl={exports:{}};/*!
  * Bootstrap event-handler.js v5.2.3 (https://getbootstrap.com/)
  * Copyright 2011-2022 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
  */var Cp;function ls(){return Cp||(Cp=1,function(n,e){(function(t,r){n.exports=r(Xn())})(et,function(t){const r=/[^.]*(?=\..*)\.|.*/,o=/\..*/,a=/::\d+$/,c={};let h=1;const d={mouseenter:"mouseover",mouseleave:"mouseout"},p=new Set(["click","dblclick","mouseup","mousedown","contextmenu","mousewheel","DOMMouseScroll","mouseover","mouseout","mousemove","selectstart","selectend","keydown","keypress","keyup","orientationchange","touchstart","touchmove","touchend","touchcancel","pointerdown","pointermove","pointerup","pointerleave","pointercancel","gesturestart","gesturechange","gestureend","focus","blur","change","reset","select","submit","focusin","focusout","load","unload","beforeunload","resize","move","DOMContentLoaded","readystatechange","error","abort","scroll"]);function y(x,D){return D&&`${D}::${h++}`||x.uidEvent||h++}function v(x){const D=y(x);return x.uidEvent=D,c[D]=c[D]||{},c[D]}function b(x,D){return function $(J){return V(J,{delegateTarget:x}),$.oneOff&&L.off(x,J.type,D),D.apply(x,[J])}}function C(x,D,$){return function J(me){const ve=x.querySelectorAll(D);for(let{target:R}=me;R&&R!==this;R=R.parentNode)for(const z of ve)if(z===R)return V(me,{delegateTarget:R}),J.oneOff&&L.off(x,me.type,D,$),$.apply(R,[me])}}function A(x,D,$=null){return Object.values(x).find(J=>J.callable===D&&J.delegationSelector===$)}function U(x,D,$){const J=typeof D=="string",me=J?$:D||$;let ve=B(x);return p.has(ve)||(ve=x),[J,me,ve]}function P(x,D,$,J,me){if(typeof D!="string"||!x)return;let[ve,R,z]=U(D,$,J);D in d&&(R=(Tn=>function($e){if(!$e.relatedTarget||$e.relatedTarget!==$e.delegateTarget&&!$e.delegateTarget.contains($e.relatedTarget))return Tn.call(this,$e)})(R));const Z=v(x),Ae=Z[z]||(Z[z]={}),be=A(Ae,R,ve?$:null);if(be){be.oneOff=be.oneOff&&me;return}const Ie=y(R,D.replace(r,"")),Pe=ve?C(x,$,R):b(x,R);Pe.delegationSelector=ve?$:null,Pe.callable=R,Pe.oneOff=me,Pe.uidEvent=Ie,Ae[Ie]=Pe,x.addEventListener(z,Pe,ve)}function Y(x,D,$,J,me){const ve=A(D[$],J,me);ve&&(x.removeEventListener($,ve,!!me),delete D[$][ve.uidEvent])}function W(x,D,$,J){const me=D[$]||{};for(const ve of Object.keys(me))if(ve.includes(J)){const R=me[ve];Y(x,D,$,R.callable,R.delegationSelector)}}function B(x){return x=x.replace(o,""),d[x]||x}const L={on(x,D,$,J){P(x,D,$,J,!1)},one(x,D,$,J){P(x,D,$,J,!0)},off(x,D,$,J){if(typeof D!="string"||!x)return;const[me,ve,R]=U(D,$,J),z=R!==D,Z=v(x),Ae=Z[R]||{},be=D.startsWith(".");if(typeof ve<"u"){if(!Object.keys(Ae).length)return;Y(x,Z,R,ve,me?$:null);return}if(be)for(const Ie of Object.keys(Z))W(x,Z,Ie,D.slice(1));for(const Ie of Object.keys(Ae)){const Pe=Ie.replace(a,"");if(!z||D.includes(Pe)){const Mt=Ae[Ie];Y(x,Z,R,Mt.callable,Mt.delegationSelector)}}},trigger(x,D,$){if(typeof D!="string"||!x)return null;const J=t.getjQuery(),me=B(D),ve=D!==me;let R=null,z=!0,Z=!0,Ae=!1;ve&&J&&(R=J.Event(D,$),J(x).trigger(R),z=!R.isPropagationStopped(),Z=!R.isImmediatePropagationStopped(),Ae=R.isDefaultPrevented());let be=new Event(D,{bubbles:z,cancelable:!0});return be=V(be,$),Ae&&be.preventDefault(),Z&&x.dispatchEvent(be),be.defaultPrevented&&R&&R.preventDefault(),be}};function V(x,D){for(const[$,J]of Object.entries(D||{}))try{x[$]=J}catch{Object.defineProperty(x,$,{configurable:!0,get(){return J}})}return x}return L})}(Kl)),Kl.exports}var Yl={exports:{}};/*!
  * Bootstrap selector-engine.js v5.2.3 (https://getbootstrap.com/)
  * Copyright 2011-2022 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
  */var Tp;function Nu(){return Tp||(Tp=1,function(n,e){(function(t,r){n.exports=r(Xn())})(et,function(t){return{find(o,a=document.documentElement){return[].concat(...Element.prototype.querySelectorAll.call(a,o))},findOne(o,a=document.documentElement){return Element.prototype.querySelector.call(a,o)},children(o,a){return[].concat(...o.children).filter(c=>c.matches(a))},parents(o,a){const c=[];let h=o.parentNode.closest(a);for(;h;)c.push(h),h=h.parentNode.closest(a);return c},prev(o,a){let c=o.previousElementSibling;for(;c;){if(c.matches(a))return[c];c=c.previousElementSibling}return[]},next(o,a){let c=o.nextElementSibling;for(;c;){if(c.matches(a))return[c];c=c.nextElementSibling}return[]},focusableChildren(o){const a=["a","button","input","textarea","select","details","[tabindex]",'[contenteditable="true"]'].map(c=>`${c}:not([tabindex^="-"])`).join(",");return this.find(a,o).filter(c=>!t.isDisabled(c)&&t.isVisible(c))}}})}(Yl)),Yl.exports}var jl={exports:{}},Ql={exports:{}};/*!
  ...
  * Copyright 2011-2022 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
  */var Ap;function rO(){return Ap||(Ap=1,function(n,e){(function(t,r){n.exports=r(Nu(),pm(),Xn())})(et,function(t,r,o){const a=C=>C&&typeof C=="object"&&"default"in C?C:{default:C},c=a(t),h=a(r),d=".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",p=".sticky-top",y="padding-right",v="margin-right";class b{constructor(){this._element=document.body}getWidth(){const A=document.documentElement.clientWidth;return Math.abs(window.innerWidth-A)}hide(){const A=this.getWidth();this._disableOverFlow(),this._setElementAttributes(this._element,y,U=>U+A),this._setElementAttributes(d,y,U=>U+A),this._setElementAttributes(p,v,U=>U-A)}reset(){this._resetElementAttributes(this._element,"overflow"),this._resetElementAttributes(this._element,y),this._resetElementAttributes(d,y),this._resetElementAttributes(p,v)}isOverflowing(){return this.getWidth()>0}_disableOverFlow(){this._saveInitialAttribute(this._element,"overflow"),this._element.style.overflow="hidden"}_setElementAttributes(A,U,P){const Y=this.getWidth(),W=B=>{if(B!==this._element&&window.innerWidth>B.clientWidth+Y)return;this._saveInitialAttribute(B,U);const L=window.getComputedStyle(B).getPropertyValue(U);B.style.setProperty(U,`${P(Number.parseFloat(L))}px`)};this._applyManipulationCallback(A,W)}_saveInitialAttribute(A,U){const P=A.style.getPropertyValue(U);P&&h.default.setDataAttribute(A,U,P)}_resetElementAttributes(A,U){const P=Y=>{const W=h.default.getDataAttribute(Y,U);if(W===null){Y.style.removeProperty(U);return}h.default.removeDataAttribute(Y,U),Y.style.setProperty(U,W)};this._applyManipulationCallback(A,P)}_applyManipulationCallback(A,U){if(o.isElement(A)){U(A);return}for(const P of c.default.find(A,this._element))U(P)}}return b})}(jl)),jl.exports}var Xl={exports:{}},Jl={exports:{}};/*!
  ...
  * Copyright 2011-2022 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
  */var Np;function ku(){return Np||(Np=1,function(n,e){(function(t,r){n.exports=r(Xn(),pm())})(et,function(t,r){const a=(h=>h&&typeof h=="object"&&"default"in h?h:{default:h})(r);class c{static get Default(){return{}}static get DefaultType(){return{}}static get NAME(){throw new Error('You have to implement the static method "NAME", for each component!')}_getConfig(d){return d=this._mergeConfigObj(d),d=this._configAfterMerge(d),this._typeCheckConfig(d),d}_configAfterMerge(d){return d}_mergeConfigObj(d,p){const y=t.isElement(p)?a.default.getDataAttribute(p,"config"):{};return{...this.constructor.Default,...typeof y=="object"?y:{},...t.isElement(p)?a.default.getDataAttributes(p):{},...typeof d=="object"?d:{}}}_typeCheckConfig(d,p=this.constructor.DefaultType){for(const y of Object.keys(p)){const v=p[y],b=d[y],C=t.isElement(b)?"element":t.toType(b);if(!new RegExp(v).test(C))throw new TypeError(`${this.constructor.NAME.toUpperCase()}: Option "${y}" provided type "${C}" but expected type "${v}".`)}}}return c})}(Zl)),Zl.exports}/*!
  * Bootstrap base-component.js v5.2.3 (https://getbootstrap.com/)
  * Copyright 2011-2022 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
  */var kp;function oO(){return kp||(kp=1,function(n,e){(function(t,r){n.exports=r(sO(),Xn(),ls(),ku())})(et,function(t,r,o,a){const c=b=>b&&typeof b=="object"&&"default"in b?b:{default:b},h=c(t),d=c(o),p=c(a),y="5.2.3";class v extends p.default{constructor(C,A){super(),C=r.getElement(C),C&&(this._element=C,this._config=this._getConfig(A),h.default.set(this._element,this.constructor.DATA_KEY,this))}dispose(){h.default.remove(this._element,this.constructor.DATA_KEY),d.default.off(this._element,this.constructor.EVENT_KEY);for(const C of Object.getOwnPropertyNames(this))this[C]=null}_queueCallback(C,A,U=!0){r.executeAfterTransition(C,A,U)}_getConfig(C){return C=this._mergeConfigObj(C,this._element),C=this._configAfterMerge(C),this._typeCheckConfig(C),C}static getInstance(C){return h.default.get(r.getElement(C),this.DATA_KEY)}static getOrCreateInstance(C,A={}){return this.getInstance(C)||new this(C,typeof A=="object"?A:null)}static get VERSION(){return y}static get DATA_KEY(){return`bs.${this.NAME}`}static get EVENT_KEY(){return`.${this.DATA_KEY}`}static eventName(C){return`${C}${this.EVENT_KEY}`}}return v})}(Xl)),Xl.exports}var ec={exports:{}};/*!
  * Bootstrap backdrop.js v5.2.3 (https://getbootstrap.com/)
  * Copyright 2011-2022 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
  */var Op;function aO(){return Op||(Op=1,function(n,e){(function(t,r){n.exports=r(ls(),Xn(),ku())})(et,function(t,r,o){const a=U=>U&&typeof U=="object"&&"default"in U?U:{default:U},c=a(t),h=a(o),d="backdrop",p="fade",y="show",v=`mousedown.bs.${d}`,b={className:"modal-backdrop",clickCallback:null,isAnimated:!1,isVisible:!0,rootElement:"body"},C={className:"string",clickCallback:"(function|null)",isAnimated:"boolean",isVisible:"boolean",rootElement:"(element|string)"};class A extends h.default{constructor(P){super(),this._config=this._getConfig(P),this._isAppended=!1,this._element=null}static get Default(){return b}static get DefaultType(){return C}static get NAME(){return d}show(P){if(!this._config.isVisible){r.execute(P);return}this._append();const Y=this._getElement();this._config.isAnimated&&r.reflow(Y),Y.classList.add(y),this._emulateAnimation(()=>{r.execute(P)})}hide(P){if(!this._config.isVisible){r.execute(P);return}this._getElement().classList.remove(y),this._emulateAnimation(()=>{this.dispose(),r.execute(P)})}dispose(){this._isAppended&&(c.default.off(this._element,v),this._element.remove(),this._isAppended=!1)}_getElement(){if(!this._element){const P=document.createElement("div");P.className=this._config.className,this._config.isAnimated&&P.classList.add(p),this._element=P}return this._element}_configAfterMerge(P){return P.rootElement=r.getElement(P.rootElement),P}_append(){if(this._isAppended)return;const P=this._getElement();this._config.rootElement.append(P),c.default.on(P,v,()=>{r.execute(this._config.clickCallback)}),this._isAppended=!0}_emulateAnimation(P){r.executeAfterTransition(P,this._getElement(),this._config.isAnimated)}}return A})}(ec)),ec.exports}var tc={exports:{}};/*!
  * Bootstrap focustrap.js v5.2.3 (https://getbootstrap.com/)
  * Copyright 2011-2022 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
  */var xp;function lO(){return xp||(xp=1,function(n,e){(function(t,r){n.exports=r(ls(),Nu(),ku())})(et,function(t,r,o){const a=L=>L&&typeof L=="object"&&"default"in L?L:{default:L},c=a(t),h=a(r),d=a(o),p="focustrap",v=".bs.focustrap",b=`focusin${v}`,C=`keydown.tab${v}`,A="Tab",U="forward",P="backward",Y={autofocus:!0,trapElement:null},W={autofocus:"boolean",trapElement:"element"};class B extends d.default{constructor(V){super(),this._config=this._getConfig(V),this._isActive=!1,this._lastTabNavDirection=null}static get Default(){return Y}static get DefaultType(){return W}static get NAME(){return p}activate(){this._isActive||(this._config.autofocus&&this._config.trapElement.focus(),c.default.off(document,v),c.default.on(document,b,V=>this._handleFocusin(V)),c.default.on(document,C,V=>this._handleKeydown(V)),this._isActive=!0)}deactivate(){this._isActive&&(this._isActive=!1,c.default.off(document,v))}_handleFocusin(V){const{trapElement:x}=this._config;if(V.target===document||V.target===x||x.contains(V.target))return;const D=h.default.focusableChildren(x);D.length===0?x.focus():this._lastTabNavDirection===P?D[D.length-1].focus():D[0].focus()}_handleKeydown(V){V.key===A&&(this._lastTabNavDirection=V.shiftKey?P:U)}}return B})}(tc)),tc.exports}var ao={exports:{}};/*!
  * Bootstrap component-functions.js v5.2.3 (https://getbootstrap.com/)
  * Copyright 2011-2022 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
  */var Pp;function cO(){return Pp||(Pp=1,function(n,e){(function(t,r){r(e,ls(),Xn())})(et,function(t,r,o){const c=(d=>d&&typeof d=="object"&&"default"in d?d:{default:d})(r),h=(d,p="hide")=>{const y=`click.dismiss${d.EVENT_KEY}`,v=d.NAME;c.default.on(document,y,`[data-bs-dismiss="${v}"]`,function(b){if(["A","AREA"].includes(this.tagName)&&b.preventDefault(),o.isDisabled(this))return;const C=o.getElementFromSelector(this)||this.closest(`.${v}`);d.getOrCreateInstance(C)[p]()})};t.enableDismissTrigger=h,Object.defineProperties(t,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})})}(ao,ao.exports)),ao.exports}/*!
  * Bootstrap modal.js v5.2.3 (https://getbootstrap.com/)
  * Copyright 2011-2022 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
  */(function(n,e){(function(t,r){n.exports=r(Xn(),ls(),Nu(),rO(),oO(),aO(),lO(),cO())})(et,function(t,r,o,a,c,h,d,p){const y=nn=>nn&&typeof nn=="object"&&"default"in nn?nn:{default:nn},v=y(r),b=y(o),C=y(a),A=y(c),U=y(h),P=y(d),Y="modal",B=".bs.modal",L=".data-api",V="Escape",x=`hide${B}`,D=`hidePrevented${B}`,$=`hidden${B}`,J=`show${B}`,me=`shown${B}`,ve=`resize${B}`,R=`click.dismiss${B}`,z=`mousedown.dismiss${B}`,Z=`keydown.dismiss${B}`,Ae=`click${B}${L}`,be="modal-open",Ie="fade",Pe="show",Mt="modal-static",Tn=".modal.show",$e=".modal-dialog",sa=".modal-body",oa='[data-bs-toggle="modal"]',aa={backdrop:!0,focus:!0,keyboard:!0},Sn={backdrop:"(boolean|string)",focus:"boolean",keyboard:"boolean"};class St extends A.default{constructor(ue,Oe){super(ue,Oe),this._dialog=b.default.findOne($e,this._element),this._backdrop=this._initializeBackDrop(),this._focustrap=this._initializeFocusTrap(),this._isShown=!1,this._isTransitioning=!1,this._scrollBar=new C.default,this._addEventListeners()}static get Default(){return aa}static get DefaultType(){return Sn}static get NAME(){return Y}toggle(ue){return this._isShown?this.hide():this.show(ue)}show(ue){this._isShown||this._isTransitioning||v.default.trigger(this._element,J,{relatedTarget:ue}).defaultPrevented||(this._isShown=!0,this._isTransitioning=!0,this._scrollBar.hide(),document.body.classList.add(be),this._adjustDialog(),this._backdrop.show(()=>this._showElement(ue)))}hide(){!this._isShown||this._isTransitioning||v.default.trigger(this._element,x).defaultPrevented||(this._isShown=!1,this._isTransitioning=!0,this._focustrap.deactivate(),this._element.classList.remove(Pe),this._queueCallback(()=>this._hideModal(),this._element,this._isAnimated()))}dispose(){for(const ue of[window,this._dialog])v.default.off(ue,B);this._backdrop.dispose(),this._focustrap.deactivate(),super.dispose()}handleUpdate(){this._adjustDialog()}_initializeBackDrop(){return new U.default({isVisible:!!this._config.backdrop,isAnimated:this._isAnimated()})}_initializeFocusTrap(){return new P.default({trapElement:this._element})}_showElement(ue){document.body.contains(this._element)||document.body.append(this._element),this._element.style.display="block",this._element.removeAttribute("aria-hidden"),this._element.setAttribute("aria-modal",!0),this._element.setAttribute("role","dialog"),this._element.scrollTop=0;const Oe=b.default.findOne(sa,this._dialog);Oe&&(Oe.scrollTop=0),t.reflow(this._element),this._element.classList.add(Pe);const vt=()=>{this._config.focus&&this._focustrap.activate(),this._isTransitioning=!1,v.default.trigger(this._element,me,{relatedTarget:ue})};this._queueCallback(vt,this._dialog,this._isAnimated())}_addEventListeners(){v.default.on(this._element,Z,ue=>{if(ue.key===V){if(this._config.keyboard){ue.preventDefault(),this.hide();return}this._triggerBackdropTransition()}}),v.default.on(window,ve,()=>{this._isShown&&!this._isTransitioning&&this._adjustDialog()}),v.default.on(this._element,z,ue=>{v.default.one(this._element,R,Oe=>{if(!(this._element!==ue.target||this._element!==Oe.target)){if(this._config.backdrop==="static"){this._triggerBackdropTransition();return}this._config.backdrop&&this.hide()}})})}_hideModal(){this._element.style.display="none",this._element.setAttribute("aria-hidden",!0),this._element.removeAttribute("aria-modal"),this._element.removeAttribute("role"),this._isTransitioning=!1,this._backdrop.hide(()=>{document.body.classList.remove(be),this._resetAdjustments(),this._scrollBar.reset(),v.default.trigger(this._element,$)})}_isAnimated(){return this._element.classList.contains(Ie)}_triggerBackdropTransition(){if(v.default.trigger(this._element,D).defaultPrevented)return;const Oe=this._element.scrollHeight>document.documentElement.clientHeight,vt=this._element.style.overflowY;vt==="hidden"||this._element.classList.contains(Mt)||(Oe||(this._element.style.overflowY="hidden"),this._element.classList.add(Mt),this._queueCallback(()=>{this._element.classList.remove(Mt),this._queueCallback(()=>{this._element.style.overflowY=vt},this._dialog)},this._dialog),this._element.focus())}_adjustDialog(){const ue=this._element.scrollHeight>document.documentElement.clientHeight,Oe=this._scrollBar.getWidth(),vt=Oe>0;if(vt&&!ue){const Kt=t.isRTL()?"paddingLeft":"paddingRight";this._element.style[Kt]=`${Oe}px`}if(!vt&&ue){const Kt=t.isRTL()?"paddingRight":"paddingLeft";this._element.style[Kt]=`${Oe}px`}}_resetAdjustments(){this._element.style.paddingLeft="",this._element.style.paddingRight=""}static jQueryInterface(ue,Oe){return this.each(function(){const vt=St.getOrCreateInstance(this,ue);if(typeof ue=="string"){if(typeof vt[ue]>"u")throw new TypeError(`No method named "${ue}"`);vt[ue](Oe)}})}}return v.default.on(document,Ae,oa,function(nn){const ue=t.getElementFromSelector(this);["A","AREA"].includes(this.tagName)&&nn.preventDefault(),v.default.one(ue,J,Kt=>{Kt.defaultPrevented||v.default.one(ue,$,()=>{t.isVisible(this)&&this.focus()})});const Oe=b.default.findOne(Tn);Oe&&St.getInstance(Oe).hide(),St.getOrCreateInstance(ue).toggle(this)}),p.enableDismissTrigger(St),t.defineJQueryPlugin(St),St})})(fm);var uO=fm.exports;const hO=JI(uO),dO=ZI("userDataList",()=>{const n=Ke(null);async function e(){try{const o=localStorage.getItem("long-lived-access-token"),a=localStorage.getItem("user_id");if(!o||!a)throw new Error("Access token or user ID is missing.");const c=await eC.get(`https://graph.instagram.com/${a}?fields=account_type,id,media_count,username&access_token=${o}`);n.value=c.data,t(c.data.id)}catch(o){console.error("Error fetching user data:",o)}}async function t(o){const a=Qr(Jr,"userData");gg(a,async c=>{const h=[];c.forEach(p=>{const y=p.key,v=p.val();h.push({key:y,...v})});const d=h.find(p=>p.id===o);d||await r(o),n.value={...n.value,...d}})}async function r(o){const a=Qr(Jr,"userData");if(!n.value){console.error("User data is null.");return}const c={id:o.toString(),media_url:"https://firebasestorage.googleapis.com/v0/b/instagram-imitation-180e8.appspot.com/o/user%2Fkarsten-winegeart-NE0XGVKTmcA-unsplash.jpg?alt=media&token=9f250d7f-e2e5-46fa-bad9-bcae3001951f",username:n.value.username};try{await _g(a,c),console.log("Data successfully written to Firebase!")}catch(h){console.error("Error writing data to Firebase:",h)}}return{userData:n,getUserData:e}}),cs=n=>(Fp("data-v-c58eca6b"),n=n(),Bp(),n),fO=cs(()=>q("button",{type:"button",class:"btn-close btn-close-white position-absolute top-0 end-0 m-3","data-bs-dismiss":"modal","aria-label":"Close"},null,-1)),pO={class:"modal-content my-5"},_O={class:"modal-header d-flex justify-content-center"},gO=cs(()=>q("h5",{class:"modal-title",id:"exampleModalLabel"},"建立新貼文",-1)),mO={class:"d-flex flex-sm-column flex-md-row"},vO=cs(()=>q("i",{class:"bi bi-image pic-icon"},null,-1)),yO=cs(()=>q("span",null,"將相片和影片拖曳到這裡",-1)),wO=cs(()=>q("label",{for:"file-input",class:"file-input-button btn btn-primary m-3"},"從電腦選擇",-1)),EO={key:1,class:"modal-body d-flex flex-column align-items-center input-img-area p-0"},bO=["src"],IO={key:2,class:"border-start p-2 w-100"},CO={class:"d-flex align-self-center align-middle"},TO={class:"rounded-circle user-pic"},SO=["src"],AO={class:"align-middle my-auto ms-2 fw-bold"},RO={__name:"addNewModalComponent",setup(n,{expose:e}){const t=Ke(!1),r=Ke(null),o=Ke(null);e({showModal:function(){r.value.show(),c.value="",A.value=!1,C.value.style.maxWidth="700px",h.value=null}}),nc(()=>{r.value=new hO(o.value)});const c=Ke(null),h=Ke(null),d=function(V){t.value=!0;let x=V;if(h.value=V.files[0],x.files){let D=new FileReader;D.onload=$=>{c.value=$.target.result,t.value=!1},D.readAsDataURL(x.files[0])}},p=Ke(!1),y=V=>{p.value=!0,V.preventDefault()},v=V=>{p.value=!1,V.preventDefault(),console.log("DragLeave")},b=V=>{V.preventDefault(),d(V.dataTransfer)},C=Ke(null),A=Ke(!1),U=function(){A.value===!0?Y():(C.value.style.maxWidth="1000px",A.value=!0)},P=()=>{A.value===!0&&(C.value.style.maxWidth="700px",A.value=!1),c.value=null},Y=async()=>{t.value=!0;const V=h.value;if(!V){console.error("No file selected.");return}const x=Dg(ra),D=ZN(x,"posts/"+V.name);try{await XN(D,V);const $=await JN(D);console.log($),$&&L($)}catch($){t.value=!1,console.error("Error uploading image:",$)}},W=dO(),B=Ke(""),L=function(V){const x=Date.now(),D=Qr(Jr,"postsData"),$={caption:B.value,id:x+W.userData.id,isThumb:!1,media_type:"IMAGE",media_url:[V],permalink:"",postownerid:W.userData.id,timestamp:new Date().toISOString(),username:W.userData.username};_g(D,$).then(()=>{console.log("Data successfully written to Firebase!"),r.value.hide(),B.value="",t.value=!1}).catch(J=>{t.value=!1,console.error("Error writing data to Firebase:",J)})};return(V,x)=>{const D=Lp("loading-overlay");return Ne(),ke(Dr,null,[q("div",{class:"modal fade",id:"exampleModal",tabindex:"-1","aria-labelledby":"exampleModalLabel","aria-hidden":"true",ref_key:"addNewModal",ref:o},[fO,q("div",{class:"modal-dialog",ref_key:"modalDialog",ref:C},[q("div",pO,[q("div",_O,[c.value?(Ne(),ke("button",{key:0,class:"btn position-absolute start-0 mx-3 text-primary",onClick:P}," 上一步 ")):ut("",!0),gO,c.value?(Ne(),ke("button",{key:1,class:"btn position-absolute end-0 mx-3 text-primary",onClick:U}," 下一步 ")):ut("",!0)]),q("div",mO,[c.value?(Ne(),ke("div",EO,[q("img",{src:c.value,alt:"",class:"input-img"},null,8,bO)])):(Ne(),ke("div",{key:0,class:"modal-body align-items-center p-5",onDragover:ui(y,["prevent"]),onDragleave:ui(v,["prevent"]),onDrop:ui(b,["prevent"])},[q("div",{class:lo(["d-flex flex-column align-items-center justify-content-center",p.value?"text-primary":""])},[vO,yO,wO,q("input",{type:"file",id:"file-input",accept:"audio/*,video/*,image/*",onChange:x[0]||(x[0]=$=>d($.target))},null,32)],2)],32)),A.value?(Ne(),ke("div",IO,[q("div",CO,[q("div",TO,[q("img",{src:_o(W).userData.media_url,alt:""},null,8,SO)]),q("p",AO,co(_o(W).userData.username),1)]),Mp(q("textarea",{type:"text",placeholder:"撰寫說明文字......",class:"postDescriptionInput py-2 w-100","onUpdate:modelValue":x[1]||(x[1]=$=>B.value=$)},null,512),[[Up,B.value]])])):ut("",!0)])])],512)],512),Pr(D,{active:t.value,"is-full-page":!0},null,8,["active"])],64)}}},NO=Dp(RO,[["__scopeId","data-v-c58eca6b"]]),kO={class:"col-md-1 col-lg-2 nav-all p-md-3 overflow-hidden position-relative"},OO=q("div",{class:"navbar navbar-light header-nav width-inherit start-0"},[q("img",{src:iO,alt:"",class:"header-logo d-md-none d-lg-block d-sm-block ms-md-3"}),q("svg",{"aria-label":"Instagram",class:"d-none d-lg-none d-md-block header-logo headerLogoIcon",fill:"currentColor",height:"24",role:"img",viewBox:"0 0 24 24",width:"24"},[q("title",null,"Instagram"),q("path",{d:"M12 2.982c2.937 0 3.285.011 4.445.064a6.087 6.087 0 0 1 2.042.379 3.408 3.408 0 0 1 1.265.823 3.408 3.408 0 0 1 .823 1.265 6.087 6.087 0 0 1 .379 2.042c.053 1.16.064 1.508.064 4.445s-.011 3.285-.064 4.445a6.087 6.087 0 0 1-.379 2.042 3.643 3.643 0 0 1-2.088 2.088 6.087 6.087 0 0 1-2.042.379c-1.16.053-1.508.064-4.445.064s-3.285-.011-4.445-.064a6.087 6.087 0 0 1-2.043-.379 3.408 3.408 0 0 1-1.264-.823 3.408 3.408 0 0 1-.823-1.265 6.087 6.087 0 0 1-.379-2.042c-.053-1.16-.064-1.508-.064-4.445s.011-3.285.064-4.445a6.087 6.087 0 0 1 .379-2.042 3.408 3.408 0 0 1 .823-1.265 3.408 3.408 0 0 1 1.265-.823 6.087 6.087 0 0 1 2.042-.379c1.16-.053 1.508-.064 4.445-.064M12 1c-2.987 0-3.362.013-4.535.066a8.074 8.074 0 0 0-2.67.511 5.392 5.392 0 0 0-1.949 1.27 5.392 5.392 0 0 0-1.269 1.948 8.074 8.074 0 0 0-.51 2.67C1.012 8.638 1 9.013 1 12s.013 3.362.066 4.535a8.074 8.074 0 0 0 .511 2.67 5.392 5.392 0 0 0 1.27 1.949 5.392 5.392 0 0 0 1.948 1.269 8.074 8.074 0 0 0 2.67.51C8.638 22.988 9.013 23 12 23s3.362-.013 4.535-.066a8.074 8.074 0 0 0 2.67-.511 5.625 5.625 0 0 0 3.218-3.218 8.074 8.074 0 0 0 .51-2.67C22.988 15.362 23 14.987 23 12s-.013-3.362-.066-4.535a8.074 8.074 0 0 0-.511-2.67 5.392 5.392 0 0 0-1.27-1.949 5.392 5.392 0 0 0-1.948-1.269 8.074 8.074 0 0 0-2.67-.51C15.362 1.012 14.987 1 12 1Zm0 5.351A5.649 5.649 0 1 0 17.649 12 5.649 5.649 0 0 0 12 6.351Zm0 9.316A3.667 3.667 0 1 1 15.667 12 3.667 3.667 0 0 1 12 15.667Zm5.872-10.859a1.32 1.32 0 1 0 1.32 1.32 1.32 1.32 0 0 0-1.32-1.32Z"})])],-1),xO={class:"bg-body d-flex flex-md-column position-fixed nav-selection bottom-0 start-0 justify-content-evenly justify-content-md-start width-inherit"},PO={class:"nav-item rounded px-2 mx-md-3"},DO=q("div",null,[q("i",{class:"bi bi-house-door icon-size m-0"})],-1),LO=q("div",{class:"position-absolute ms-4"},[q("span",{class:"d-none d-lg-inline p-2"},"首頁")],-1),MO={class:"nav-item rounded px-2 mx-md-3"},UO=q("div",null,[q("i",{class:"bi bi-plus-square icon-size m-0"})],-1),FO=q("div",{class:"position-absolute ms-4"},[q("span",{class:"d-none d-lg-inline p-2"},"建立")],-1),BO={class:"nav-item rounded px-2 mx-md-3"},WO=q("div",null,[q("i",{class:"bi bi-person-circle icon-size m-0"})],-1),HO=q("div",{class:"position-absolute ms-4"},[q("span",{class:"d-none d-lg-inline p-2"},"個人檔案")],-1),Ax={__name:"navComponent",setup(n){const e=Ke(null),t=function(){e.value.showModal()};return(r,o)=>{const a=Lp("RouterLink");return Ne(),ke(Dr,null,[q("nav",kO,[OO,q("div",xO,[q("div",PO,[Pr(a,{to:"/",class:"text-decoration-none text-secondary d-flex text-dark justify-content-md-center justify-content-lg-start"},{default:Nl(()=>[DO,LO]),_:1})]),q("div",MO,[Pr(a,{to:"/",class:"text-decoration-none text-secondary d-flex text-dark justify-content-md-center justify-content-lg-start",onClick:ui(t,["prevent"])},{default:Nl(()=>[UO,FO]),_:1})]),q("div",BO,[Pr(a,{to:"/profile",class:"text-decoration-none text-secondary d-flex text-dark justify-content-md-center justify-content-lg-start"},{default:Nl(()=>[WO,HO]),_:1})])])]),Pr(NO,{ref_key:"addNewModal",ref:e},null,512)],64)}}};var Fo={exports:{}};/**
 * @license
 ...
 */Fo.exports;(function(n,e){(function(){var t,r="4.17.21",o=200,a="Unsupported core-js use. Try https://npms.io/search?q=ponyfill.",c="Expected a function",h="Invalid `variable` option passed into `_.template`",d="__lodash_hash_undefined__",p=500,y="__lodash_placeholder__",v=1,b=2,C=4,A=1,U=2,P=1,Y=2,W=4,B=8,L=16,V=32,x=64,D=128,$=256,J=512,me=30,ve="...",R=800,z=16,Z=1,Ae=2,be=3,Ie=1/0,Pe=9007199254740991,Mt=17976931348623157e292,Tn=NaN,$e=4294967295,sa=$e-1,oa=$e>>>1,aa=[["ary",D],["bind",P],["bindKey",Y],["curry",B],["curryRight",L],["flip",J],["partial",V],["partialRight",x],["rearg",$]],Sn="[object Arguments]",St="[object Array]",nn="[object AsyncFunction]",ue="[object Boolean]",Oe="[object Date]",vt="[object DOMException]",Kt="[object Error]",hs="[object Function]",Ou="[object GeneratorFunction]",Ut="[object Map]",lr="[object Number]",_m="[object Null]",rn="[object Object]",xu="[object Promise]",gm="[object Proxy]",cr="[object RegExp]",Ft="[object Set]",ur="[object String]",ds="[object Symbol]",mm="[object Undefined]",hr="[object WeakMap]",vm="[object WeakSet]",dr="[object ArrayBuffer]",Ci="[object DataView]",la="[object Float32Array]",ca="[object Float64Array]",ua="[object Int8Array]",ha="[object Int16Array]",da="[object Int32Array]",fa="[object Uint8Array]",pa="[object Uint8ClampedArray]",_a="[object Uint16Array]",ga="[object Uint32Array]",ym=/\b__p \+= '';/g,wm=/\b(__p \+=) '' \+/g,Em=/(__e\(.*?\)|\b__t\)) \+\n'';/g,Pu=/&(?:amp|lt|gt|quot|#39);/g,Du=/[&<>"']/g,bm=RegExp(Pu.source),Im=RegExp(Du.source),Cm=/<%-([\s\S]+?)%>/g,Tm=/<%([\s\S]+?)%>/g,Lu=/<%=([\s\S]+?)%>/g,Sm=/\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,Am=/^\w*$/,Rm=/[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g,ma=/[\\^$.*+?()[\]{}|]/g,Nm=RegExp(ma.source),va=/^\s+/,km=/\s/,Om=/\{(?:\n\/\* \[wrapped with .+\] \*\/)?\n?/,xm=/\{\n\/\* \[wrapped with (.+)\] \*/,Pm=/,? & /,Dm=/[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g,Lm=/[()=,{}\[\]\/\s]/,Mm=/\\(\\)?/g,Um=/\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g,Mu=/\w*$/,Fm=/^[-+]0x[0-9a-f]+$/i,Bm=/^0b[01]+$/i,Wm=/^\[object .+?Constructor\]$/,Hm=/^0o[0-7]+$/i,$m=/^(?:0|[1-9]\d*)$/,Vm=/[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g,fs=/($^)/,qm=/['\n\r\u2028\u2029\\]/g,ps="\\ud800-\\udfff",Gm="\\u0300-\\u036f",zm="\\ufe20-\\ufe2f",Km="\\u20d0-\\u20ff",Uu=Gm+zm+Km,Fu="\\u2700-\\u27bf",Bu="a-z\\xdf-\\xf6\\xf8-\\xff",Ym="\\xac\\xb1\\xd7\\xf7",jm="\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf",Qm="\\u2000-\\u206f",Xm=" \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000",Wu="A-Z\\xc0-\\xd6\\xd8-\\xde",Hu="\\ufe0e\\ufe0f",$u=Ym+jm+Qm+Xm,ya="['’]",Jm="["+ps+"]",Vu="["+$u+"]",_s="["+Uu+"]",qu="\\d+",Zm="["+Fu+"]",Gu="["+Bu+"]",zu="[^"+ps+$u+qu+Fu+Bu+Wu+"]",wa="\\ud83c[\\udffb-\\udfff]",ev="(?:"+_s+"|"+wa+")",Ku="[^"+ps+"]",Ea="(?:\\ud83c[\\udde6-\\uddff]){2}",ba="[\\ud800-\\udbff][\\udc00-\\udfff]",Ti="["+Wu+"]",Yu="\\u200d",ju="(?:"+Gu+"|"+zu+")",tv="(?:"+Ti+"|"+zu+")",Qu="(?:"+ya+"(?:d|ll|m|re|s|t|ve))?",Xu="(?:"+ya+"(?:D|LL|M|RE|S|T|VE))?",Ju=ev+"?",Zu="["+Hu+"]?",nv="(?:"+Yu+"(?:"+[Ku,Ea,ba].join("|")+")"+Zu+Ju+")*",iv="\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])",rv="\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])",eh=Zu+Ju+nv,sv="(?:"+[Zm,Ea,ba].join("|")+")"+eh,ov="(?:"+[Ku+_s+"?",_s,Ea,ba,Jm].join("|")+")",av=RegExp(ya,"g"),lv=RegExp(_s,"g"),Ia=RegExp(wa+"(?="+wa+")|"+ov+eh,"g"),cv=RegExp([Ti+"?"+Gu+"+"+Qu+"(?="+[Vu,Ti,"$"].join("|")+")",tv+"+"+Xu+"(?="+[Vu,Ti+ju,"$"].join("|")+")",Ti+"?"+ju+"+"+Qu,Ti+"+"+Xu,rv,iv,qu,sv].join("|"),"g"),uv=RegExp("["+Yu+ps+Uu+Hu+"]"),hv=/[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/,dv=["Array","Buffer","DataView","Date","Error","Float32Array","Float64Array","Function","Int8Array","Int16Array","Int32Array","Map","Math","Object","Promise","RegExp","Set","String","Symbol","TypeError","Uint8Array","Uint8ClampedArray","Uint16Array","Uint32Array","WeakMap","_","clearTimeout","isFinite","parseInt","setTimeout"],fv=-1,Re={};Re[la]=Re[ca]=Re[ua]=Re[ha]=Re[da]=Re[fa]=Re[pa]=Re[_a]=Re[ga]=!0,Re[Sn]=Re[St]=Re[dr]=Re[ue]=Re[Ci]=Re[Oe]=Re[Kt]=Re[hs]=Re[Ut]=Re[lr]=Re[rn]=Re[cr]=Re[Ft]=Re[ur]=Re[hr]=!1;var Ce={};Ce[Sn]=Ce[St]=Ce[dr]=Ce[Ci]=Ce[ue]=Ce[Oe]=Ce[la]=Ce[ca]=Ce[ua]=Ce[ha]=Ce[da]=Ce[Ut]=Ce[lr]=Ce[rn]=Ce[cr]=Ce[Ft]=Ce[ur]=Ce[ds]=Ce[fa]=Ce[pa]=Ce[_a]=Ce[ga]=!0,Ce[Kt]=Ce[hs]=Ce[hr]=!1;var pv={À:"A",Á:"A",Â:"A",Ã:"A",Ä:"A",Å:"A",à:"a",á:"a",â:"a",ã:"a",ä:"a",å:"a",Ç:"C",ç:"c",Ð:"D",ð:"d",È:"E",É:"E",Ê:"E",Ë:"E",è:"e",é:"e",ê:"e",ë:"e",Ì:"I",Í:"I",Î:"I",Ï:"I",ì:"i",í:"i",î:"i",ï:"i",Ñ:"N",ñ:"n",Ò:"O",Ó:"O",Ô:"O",Õ:"O",Ö:"O",Ø:"O",ò:"o",ó:"o",ô:"o",õ:"o",ö:"o",ø:"o",Ù:"U",Ú:"U",Û:"U",Ü:"U",ù:"u",ú:"u",û:"u",ü:"u",Ý:"Y",ý:"y",ÿ:"y",Æ:"Ae",æ:"ae",Þ:"Th",þ:"th",ß:"ss",Ā:"A",Ă:"A",Ą:"A",ā:"a",ă:"a",ą:"a",Ć:"C",Ĉ:"C",Ċ:"C",Č:"C",ć:"c",ĉ:"c",ċ:"c",č:"c",Ď:"D",Đ:"D",ď:"d",đ:"d",Ē:"E",Ĕ:"E",Ė:"E",Ę:"E",Ě:"E",ē:"e",ĕ:"e",ė:"e",ę:"e",ě:"e",Ĝ:"G",Ğ:"G",Ġ:"G",Ģ:"G",ĝ:"g",ğ:"g",ġ:"g",ģ:"g",Ĥ:"H",Ħ:"H",ĥ:"h",ħ:"h",Ĩ:"I",Ī:"I",Ĭ:"I",Į:"I",İ:"I",ĩ:"i",ī:"i",ĭ:"i",į:"i",ı:"i",Ĵ:"J",ĵ:"j",Ķ:"K",ķ:"k",ĸ:"k",Ĺ:"L",Ļ:"L",Ľ:"L",Ŀ:"L",Ł:"L",ĺ:"l",ļ:"l",ľ:"l",ŀ:"l",ł:"l",Ń:"N",Ņ:"N",Ň:"N",Ŋ:"N",ń:"n",ņ:"n",ň:"n",ŋ:"n",Ō:"O",Ŏ:"O",Ő:"O",ō:"o",ŏ:"o",ő:"o",Ŕ:"R",Ŗ:"R",Ř:"R",ŕ:"r",ŗ:"r",ř:"r",Ś:"S",Ŝ:"S",Ş:"S",Š:"S",ś:"s",ŝ:"s",ş:"s",š:"s",Ţ:"T",Ť:"T",Ŧ:"T",ţ:"t",ť:"t",ŧ:"t",Ũ:"U",Ū:"U",Ŭ:"U",Ů:"U",Ű:"U",Ų:"U",ũ:"u",ū:"u",ŭ:"u",ů:"u",ű:"u",ų:"u",Ŵ:"W",ŵ:"w",Ŷ:"Y",ŷ:"y",Ÿ:"Y",Ź:"Z",Ż:"Z",Ž:"Z",ź:"z",ż:"z",ž:"z",Ĳ:"IJ",ĳ:"ij",Œ:"Oe",œ:"oe",ŉ:"'n",ſ:"s"},_v={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},gv={"&amp;":"&","&lt;":"<","&gt;":">","&quot;":'"',"&#39;":"'"},mv={"\\":"\\","'":"'","\n":"n","\r":"r","\u2028":"u2028","\u2029":"u2029"},vv=parseFloat,yv=parseInt,th=typeof et=="object"&&et&&et.Object===Object&&et,wv=typeof self=="object"&&self&&self.Object===Object&&self,Xe=th||wv||Function("return this")(),Ca=e&&!e.nodeType&&e,Jn=Ca&&!0&&n&&!n.nodeType&&n,nh=Jn&&Jn.exports===Ca,Ta=nh&&th.process,At=function(){try{var E=Jn&&Jn.require&&Jn.require("util").types;return E||Ta&&Ta.binding&&Ta.binding("util")}catch{}}(),ih=At&&At.isArrayBuffer,rh=At&&At.isDate,sh=At&&At.isMap,oh=At&&At.isRegExp,ah=At&&At.isSet,lh=At&&At.isTypedArray;function yt(E,S,T){switch(T.length){case 0:return E.call(S);case 1:return E.call(S,T[0]);case 2:return E.call(S,T[0],T[1]);case 3:return E.call(S,T[0],T[1],T[2])}return E.apply(S,T)}function Ev(E,S,T,H){for(var te=-1,fe=E==null?0:E.length;++te<fe;){var Ve=E[te];S(H,Ve,T(Ve),E)}return H}function Rt(E,S){for(var T=-1,H=E==null?0:E.length;++T<H&&S(E[T],T,E)!==!1;);return E}function bv(E,S){for(var T=E==null?0:E.length;T--&&S(E[T],T,E)!==!1;);return E}function ch(E,S){for(var T=-1,H=E==null?0:E.length;++T<H;)if(!S(E[T],T,E))return!1;return!0}function An(E,S){for(var T=-1,H=E==null?0:E.length,te=0,fe=[];++T<H;){var Ve=E[T];S(Ve,T,E)&&(fe[te++]=Ve)}return fe}function gs(E,S){var T=E==null?0:E.length;return!!T&&Si(E,S,0)>-1}function Sa(E,S,T){for(var H=-1,te=E==null?0:E.length;++H<te;)if(T(S,E[H]))return!0;return!1}function xe(E,S){for(var T=-1,H=E==null?0:E.length,te=Array(H);++T<H;)te[T]=S(E[T],T,E);return te}function Rn(E,S){for(var T=-1,H=S.length,te=E.length;++T<H;)E[te+T]=S[T];return E}function Aa(E,S,T,H){var te=-1,fe=E==null?0:E.length;for(H&&fe&&(T=E[++te]);++te<fe;)T=S(T,E[te],te,E);return T}function Iv(E,S,T,H){var te=E==null?0:E.length;for(H&&te&&(T=E[--te]);te--;)T=S(T,E[te],te,E);return T}function Ra(E,S){for(var T=-1,H=E==null?0:E.length;++T<H;)if(S(E[T],T,E))return!0;return!1}var Cv=Na("length");function Tv(E){return E.split("")}function Sv(E){return E.match(Dm)||[]}function uh(E,S,T){var H;return T(E,function(te,fe,Ve){if(S(te,fe,Ve))return H=fe,!1}),H}function ms(E,S,T,H){for(var te=E.length,fe=T+(H?1:-1);H?fe--:++fe<te;)if(S(E[fe],fe,E))return fe;return-1}function Si(E,S,T){return S===S?Fv(E,S,T):ms(E,hh,T)}function Av(E,S,T,H){for(var te=T-1,fe=E.length;++te<fe;)if(H(E[te],S))return te;return-1}function hh(E){return E!==E}function dh(E,S){var T=E==null?0:E.length;return T?Oa(E,S)/T:Tn}function Na(E){return function(S){return S==null?t:S[E]}}function ka(E){return function(S){return E==null?t:E[S]}}function fh(E,S,T,H,te){return te(E,function(fe,Ve,Ee){T=H?(H=!1,fe):S(T,fe,Ve,Ee)}),T}function Rv(E,S){var T=E.length;for(E.sort(S);T--;)E[T]=E[T].value;return E}function Oa(E,S){for(var T,H=-1,te=E.length;++H<te;){var fe=S(E[H]);fe!==t&&(T=T===t?fe:T+fe)}return T}function xa(E,S){for(var T=-1,H=Array(E);++T<E;)H[T]=S(T);return H}function Nv(E,S){return xe(S,function(T){return[T,E[T]]})}function ph(E){return E&&E.slice(0,vh(E)+1).replace(va,"")}function wt(E){return function(S){return E(S)}}function Pa(E,S){return xe(S,function(T){return E[T]})}function fr(E,S){return E.has(S)}function _h(E,S){for(var T=-1,H=E.length;++T<H&&Si(S,E[T],0)>-1;);return T}function gh(E,S){for(var T=E.length;T--&&Si(S,E[T],0)>-1;);return T}function kv(E,S){for(var T=E.length,H=0;T--;)E[T]===S&&++H;return H}var Ov=ka(pv),xv=ka(_v);function Pv(E){return"\\"+mv[E]}function Dv(E,S){return E==null?t:E[S]}function Ai(E){return uv.test(E)}function Lv(E){return hv.test(E)}function Mv(E){for(var S,T=[];!(S=E.next()).done;)T.push(S.value);return T}function Da(E){var S=-1,T=Array(E.size);return E.forEach(function(H,te){T[++S]=[te,H]}),T}function mh(E,S){return function(T){return E(S(T))}}function Nn(E,S){for(var T=-1,H=E.length,te=0,fe=[];++T<H;){var Ve=E[T];(Ve===S||Ve===y)&&(E[T]=y,fe[te++]=T)}return fe}function vs(E){var S=-1,T=Array(E.size);return E.forEach(function(H){T[++S]=H}),T}function Uv(E){var S=-1,T=Array(E.size);return E.forEach(function(H){T[++S]=[H,H]}),T}function Fv(E,S,T){for(var H=T-1,te=E.length;++H<te;)if(E[H]===S)return H;return-1}function Bv(E,S,T){for(var H=T+1;H--;)if(E[H]===S)return H;return H}function Ri(E){return Ai(E)?Hv(E):Cv(E)}function Bt(E){return Ai(E)?$v(E):Tv(E)}function vh(E){for(var S=E.length;S--&&km.test(E.charAt(S)););return S}var Wv=ka(gv);function Hv(E){for(var S=Ia.lastIndex=0;Ia.test(E);)++S;return S}function $v(E){return E.match(Ia)||[]}function Vv(E){return E.match(cv)||[]}var qv=function E(S){S=S==null?Xe:Ni.defaults(Xe.Object(),S,Ni.pick(Xe,dv));var T=S.Array,H=S.Date,te=S.Error,fe=S.Function,Ve=S.Math,Ee=S.Object,La=S.RegExp,Gv=S.String,Nt=S.TypeError,ys=T.prototype,zv=fe.prototype,ki=Ee.prototype,ws=S["__core-js_shared__"],Es=zv.toString,ge=ki.hasOwnProperty,Kv=0,yh=function(){var i=/[^.]+$/.exec(ws&&ws.keys&&ws.keys.IE_PROTO||"");return i?"Symbol(src)_1."+i:""}(),bs=ki.toString,Yv=Es.call(Ee),jv=Xe._,Qv=La("^"+Es.call(ge).replace(ma,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$"),Is=nh?S.Buffer:t,kn=S.Symbol,Cs=S.Uint8Array,wh=Is?Is.allocUnsafe:t,Ts=mh(Ee.getPrototypeOf,Ee),Eh=Ee.create,bh=ki.propertyIsEnumerable,Ss=ys.splice,Ih=kn?kn.isConcatSpreadable:t,pr=kn?kn.iterator:t,Zn=kn?kn.toStringTag:t,As=function(){try{var i=ri(Ee,"defineProperty");return i({},"",{}),i}catch{}}(),Xv=S.clearTimeout!==Xe.clearTimeout&&S.clearTimeout,Jv=H&&H.now!==Xe.Date.now&&H.now,Zv=S.setTimeout!==Xe.setTimeout&&S.setTimeout,Rs=Ve.ceil,Ns=Ve.floor,Ma=Ee.getOwnPropertySymbols,ey=Is?Is.isBuffer:t,Ch=S.isFinite,ty=ys.join,ny=mh(Ee.keys,Ee),qe=Ve.max,nt=Ve.min,iy=H.now,ry=S.parseInt,Th=Ve.random,sy=ys.reverse,Ua=ri(S,"DataView"),_r=ri(S,"Map"),Fa=ri(S,"Promise"),Oi=ri(S,"Set"),gr=ri(S,"WeakMap"),mr=ri(Ee,"create"),ks=gr&&new gr,xi={},oy=si(Ua),ay=si(_r),ly=si(Fa),cy=si(Oi),uy=si(gr),Os=kn?kn.prototype:t,vr=Os?Os.valueOf:t,Sh=Os?Os.toString:t;function _(i){if(Le(i)&&!ne(i)&&!(i instanceof he)){if(i instanceof kt)return i;if(ge.call(i,"__wrapped__"))return Ad(i)}return new kt(i)}var Pi=function(){function i(){}return function(s){if(!De(s))return{};if(Eh)return Eh(s);i.prototype=s;var l=new i;return i.prototype=t,l}}();function xs(){}function kt(i,s){this.__wrapped__=i,this.__actions__=[],this.__chain__=!!s,this.__index__=0,this.__values__=t}_.templateSettings={escape:Cm,evaluate:Tm,interpolate:Lu,variable:"",imports:{_}},_.prototype=xs.prototype,_.prototype.constructor=_,kt.prototype=Pi(xs.prototype),kt.prototype.constructor=kt;function he(i){this.__wrapped__=i,this.__actions__=[],this.__dir__=1,this.__filtered__=!1,this.__iteratees__=[],this.__takeCount__=$e,this.__views__=[]}function hy(){var i=new he(this.__wrapped__);return i.__actions__=dt(this.__actions__),i.__dir__=this.__dir__,i.__filtered__=this.__filtered__,i.__iteratees__=dt(this.__iteratees__),i.__takeCount__=this.__takeCount__,i.__views__=dt(this.__views__),i}function dy(){if(this.__filtered__){var i=new he(this);i.__dir__=-1,i.__filtered__=!0}else i=this.clone(),i.__dir__*=-1;return i}function fy(){var i=this.__wrapped__.value(),s=this.__dir__,l=ne(i),u=s<0,f=l?i.length:0,g=Tw(0,f,this.__views__),m=g.start,w=g.end,I=w-m,N=u?w:m-1,k=this.__iteratees__,O=k.length,F=0,G=nt(I,this.__takeCount__);if(!l||!u&&f==I&&G==I)return Qh(i,this.__actions__);var j=[];e:for(;I--&&F<G;){N+=s;for(var re=-1,Q=i[N];++re<O;){var le=k[re],de=le.iteratee,It=le.type,lt=de(Q);if(It==Ae)Q=lt;else if(!lt){if(It==Z)continue e;break e}}j[F++]=Q}return j}he.prototype=Pi(xs.prototype),he.prototype.constructor=he;function ei(i){var s=-1,l=i==null?0:i.length;for(this.clear();++s<l;){var u=i[s];this.set(u[0],u[1])}}function py(){this.__data__=mr?mr(null):{},this.size=0}function _y(i){var s=this.has(i)&&delete this.__data__[i];return this.size-=s?1:0,s}function gy(i){var s=this.__data__;if(mr){var l=s[i];return l===d?t:l}return ge.call(s,i)?s[i]:t}function my(i){var s=this.__data__;return mr?s[i]!==t:ge.call(s,i)}function vy(i,s){var l=this.__data__;return this.size+=this.has(i)?0:1,l[i]=mr&&s===t?d:s,this}ei.prototype.clear=py,ei.prototype.delete=_y,ei.prototype.get=gy,ei.prototype.has=my,ei.prototype.set=vy;function sn(i){var s=-1,l=i==null?0:i.length;for(this.clear();++s<l;){var u=i[s];this.set(u[0],u[1])}}function yy(){this.__data__=[],this.size=0}function wy(i){var s=this.__data__,l=Ps(s,i);if(l<0)return!1;var u=s.length-1;return l==u?s.pop():Ss.call(s,l,1),--this.size,!0}function Ey(i){var s=this.__data__,l=Ps(s,i);return l<0?t:s[l][1]}function by(i){return Ps(this.__data__,i)>-1}function Iy(i,s){var l=this.__data__,u=Ps(l,i);return u<0?(++this.size,l.push([i,s])):l[u][1]=s,this}sn.prototype.clear=yy,sn.prototype.delete=wy,sn.prototype.get=Ey,sn.prototype.has=by,sn.prototype.set=Iy;function on(i){var s=-1,l=i==null?0:i.length;for(this.clear();++s<l;){var u=i[s];this.set(u[0],u[1])}}function Cy(){this.size=0,this.__data__={hash:new ei,map:new(_r||sn),string:new ei}}function Ty(i){var s=Gs(this,i).delete(i);return this.size-=s?1:0,s}function Sy(i){return Gs(this,i).get(i)}function Ay(i){return Gs(this,i).has(i)}function Ry(i,s){var l=Gs(this,i),u=l.size;return l.set(i,s),this.size+=l.size==u?0:1,this}on.prototype.clear=Cy,on.prototype.delete=Ty,on.prototype.get=Sy,on.prototype.has=Ay,on.prototype.set=Ry;function ti(i){var s=-1,l=i==null?0:i.length;for(this.__data__=new on;++s<l;)this.add(i[s])}function Ny(i){return this.__data__.set(i,d),this}function ky(i){return this.__data__.has(i)}ti.prototype.add=ti.prototype.push=Ny,ti.prototype.has=ky;function Wt(i){var s=this.__data__=new sn(i);this.size=s.size}function Oy(){this.__data__=new sn,this.size=0}function xy(i){var s=this.__data__,l=s.delete(i);return this.size=s.size,l}function Py(i){return this.__data__.get(i)}function Dy(i){return this.__data__.has(i)}function Ly(i,s){var l=this.__data__;if(l instanceof sn){var u=l.__data__;if(!_r||u.length<o-1)return u.push([i,s]),this.size=++l.size,this;l=this.__data__=new on(u)}return l.set(i,s),this.size=l.size,this}Wt.prototype.clear=Oy,Wt.prototype.delete=xy,Wt.prototype.get=Py,Wt.prototype.has=Dy,Wt.prototype.set=Ly;function Ah(i,s){var l=ne(i),u=!l&&oi(i),f=!l&&!u&&Ln(i),g=!l&&!u&&!f&&Ui(i),m=l||u||f||g,w=m?xa(i.length,Gv):[],I=w.length;for(var N in i)(s||ge.call(i,N))&&!(m&&(N=="length"||f&&(N=="offset"||N=="parent")||g&&(N=="buffer"||N=="byteLength"||N=="byteOffset")||un(N,I)))&&w.push(N);return w}function Rh(i){var s=i.length;return s?i[ja(0,s-1)]:t}function My(i,s){return zs(dt(i),ni(s,0,i.length))}function Uy(i){return zs(dt(i))}function Ba(i,s,l){(l!==t&&!Ht(i[s],l)||l===t&&!(s in i))&&an(i,s,l)}function yr(i,s,l){var u=i[s];(!(ge.call(i,s)&&Ht(u,l))||l===t&&!(s in i))&&an(i,s,l)}function Ps(i,s){for(var l=i.length;l--;)if(Ht(i[l][0],s))return l;return-1}function Fy(i,s,l,u){return On(i,function(f,g,m){s(u,f,l(f),m)}),u}function Nh(i,s){return i&&jt(s,Ge(s),i)}function By(i,s){return i&&jt(s,pt(s),i)}function an(i,s,l){s=="__proto__"&&As?As(i,s,{configurable:!0,enumerable:!0,value:l,writable:!0}):i[s]=l}function Wa(i,s){for(var l=-1,u=s.length,f=T(u),g=i==null;++l<u;)f[l]=g?t:wl(i,s[l]);return f}function ni(i,s,l){return i===i&&(l!==t&&(i=i<=l?i:l),s!==t&&(i=i>=s?i:s)),i}function Ot(i,s,l,u,f,g){var m,w=s&v,I=s&b,N=s&C;if(l&&(m=f?l(i,u,f,g):l(i)),m!==t)return m;if(!De(i))return i;var k=ne(i);if(k){if(m=Aw(i),!w)return dt(i,m)}else{var O=it(i),F=O==hs||O==Ou;if(Ln(i))return Zh(i,w);if(O==rn||O==Sn||F&&!f){if(m=I||F?{}:vd(i),!w)return I?gw(i,By(m,i)):_w(i,Nh(m,i))}else{if(!Ce[O])return f?i:{};m=Rw(i,O,w)}}g||(g=new Wt);var G=g.get(i);if(G)return G;g.set(i,m),Kd(i)?i.forEach(function(Q){m.add(Ot(Q,s,l,Q,i,g))}):Gd(i)&&i.forEach(function(Q,le){m.set(le,Ot(Q,s,l,le,i,g))});var j=N?I?ol:sl:I?pt:Ge,re=k?t:j(i);return Rt(re||i,function(Q,le){re&&(le=Q,Q=i[le]),yr(m,le,Ot(Q,s,l,le,i,g))}),m}function Wy(i){var s=Ge(i);return function(l){return kh(l,i,s)}}function kh(i,s,l){var u=l.length;if(i==null)return!u;for(i=Ee(i);u--;){var f=l[u],g=s[f],m=i[f];if(m===t&&!(f in i)||!g(m))return!1}return!0}function Oh(i,s,l){if(typeof i!="function")throw new Nt(c);return Sr(function(){i.apply(t,l)},s)}function wr(i,s,l,u){var f=-1,g=gs,m=!0,w=i.length,I=[],N=s.length;if(!w)return I;l&&(s=xe(s,wt(l))),u?(g=Sa,m=!1):s.length>=o&&(g=fr,m=!1,s=new ti(s));e:for(;++f<w;){var k=i[f],O=l==null?k:l(k);if(k=u||k!==0?k:0,m&&O===O){for(var F=N;F--;)if(s[F]===O)continue e;I.push(k)}else g(s,O,u)||I.push(k)}return I}var On=rd(Yt),xh=rd($a,!0);function Hy(i,s){var l=!0;return On(i,function(u,f,g){return l=!!s(u,f,g),l}),l}function Ds(i,s,l){for(var u=-1,f=i.length;++u<f;){var g=i[u],m=s(g);if(m!=null&&(w===t?m===m&&!bt(m):l(m,w)))var w=m,I=g}return I}function $y(i,s,l,u){var f=i.length;for(l=ie(l),l<0&&(l=-l>f?0:f+l),u=u===t||u>f?f:ie(u),u<0&&(u+=f),u=l>u?0:jd(u);l<u;)i[l++]=s;return i}function Ph(i,s){var l=[];return On(i,function(u,f,g){s(u,f,g)&&l.push(u)}),l}function Je(i,s,l,u,f){var g=-1,m=i.length;for(l||(l=kw),f||(f=[]);++g<m;){var w=i[g];s>0&&l(w)?s>1?Je(w,s-1,l,u,f):Rn(f,w):u||(f[f.length]=w)}return f}var Ha=sd(),Dh=sd(!0);function Yt(i,s){return i&&Ha(i,s,Ge)}function $a(i,s){return i&&Dh(i,s,Ge)}function Ls(i,s){return An(s,function(l){return hn(i[l])})}function ii(i,s){s=Pn(s,i);for(var l=0,u=s.length;i!=null&&l<u;)i=i[Qt(s[l++])];return l&&l==u?i:t}function Lh(i,s,l){var u=s(i);return ne(i)?u:Rn(u,l(i))}function ot(i){return i==null?i===t?mm:_m:Zn&&Zn in Ee(i)?Cw(i):Uw(i)}function Va(i,s){return i>s}function Vy(i,s){return i!=null&&ge.call(i,s)}function qy(i,s){return i!=null&&s in Ee(i)}function Gy(i,s,l){return i>=nt(s,l)&&i<qe(s,l)}function qa(i,s,l){for(var u=l?Sa:gs,f=i[0].length,g=i.length,m=g,w=T(g),I=1/0,N=[];m--;){var k=i[m];m&&s&&(k=xe(k,wt(s))),I=nt(k.length,I),w[m]=!l&&(s||f>=120&&k.length>=120)?new ti(m&&k):t}k=i[0];var O=-1,F=w[0];e:for(;++O<f&&N.length<I;){var G=k[O],j=s?s(G):G;if(G=l||G!==0?G:0,!(F?fr(F,j):u(N,j,l))){for(m=g;--m;){var re=w[m];if(!(re?fr(re,j):u(i[m],j,l)))continue e}F&&F.push(j),N.push(G)}}return N}function zy(i,s,l,u){return Yt(i,function(f,g,m){s(u,l(f),g,m)}),u}function Er(i,s,l){s=Pn(s,i),i=bd(i,s);var u=i==null?i:i[Qt(Pt(s))];return u==null?t:yt(u,i,l)}function Mh(i){return Le(i)&&ot(i)==Sn}function Ky(i){return Le(i)&&ot(i)==dr}function Yy(i){return Le(i)&&ot(i)==Oe}function br(i,s,l,u,f){return i===s?!0:i==null||s==null||!Le(i)&&!Le(s)?i!==i&&s!==s:jy(i,s,l,u,br,f)}function jy(i,s,l,u,f,g){var m=ne(i),w=ne(s),I=m?St:it(i),N=w?St:it(s);I=I==Sn?rn:I,N=N==Sn?rn:N;var k=I==rn,O=N==rn,F=I==N;if(F&&Ln(i)){if(!Ln(s))return!1;m=!0,k=!1}if(F&&!k)return g||(g=new Wt),m||Ui(i)?_d(i,s,l,u,f,g):bw(i,s,I,l,u,f,g);if(!(l&A)){var G=k&&ge.call(i,"__wrapped__"),j=O&&ge.call(s,"__wrapped__");if(G||j){var re=G?i.value():i,Q=j?s.value():s;return g||(g=new Wt),f(re,Q,l,u,g)}}return F?(g||(g=new Wt),Iw(i,s,l,u,f,g)):!1}function Qy(i){return Le(i)&&it(i)==Ut}function Ga(i,s,l,u){var f=l.length,g=f,m=!u;if(i==null)return!g;for(i=Ee(i);f--;){var w=l[f];if(m&&w[2]?w[1]!==i[w[0]]:!(w[0]in i))return!1}for(;++f<g;){w=l[f];var I=w[0],N=i[I],k=w[1];if(m&&w[2]){if(N===t&&!(I in i))return!1}else{var O=new Wt;if(u)var F=u(N,k,I,i,s,O);if(!(F===t?br(k,N,A|U,u,O):F))return!1}}return!0}function Uh(i){if(!De(i)||xw(i))return!1;var s=hn(i)?Qv:Wm;return s.test(si(i))}function Xy(i){return Le(i)&&ot(i)==cr}function Jy(i){return Le(i)&&it(i)==Ft}function Zy(i){return Le(i)&&Js(i.length)&&!!Re[ot(i)]}function Fh(i){return typeof i=="function"?i:i==null?_t:typeof i=="object"?ne(i)?Hh(i[0],i[1]):Wh(i):af(i)}function za(i){if(!Tr(i))return ny(i);var s=[];for(var l in Ee(i))ge.call(i,l)&&l!="constructor"&&s.push(l);return s}function ew(i){if(!De(i))return Mw(i);var s=Tr(i),l=[];for(var u in i)u=="constructor"&&(s||!ge.call(i,u))||l.push(u);return l}function Ka(i,s){return i<s}function Bh(i,s){var l=-1,u=ft(i)?T(i.length):[];return On(i,function(f,g,m){u[++l]=s(f,g,m)}),u}function Wh(i){var s=ll(i);return s.length==1&&s[0][2]?wd(s[0][0],s[0][1]):function(l){return l===i||Ga(l,i,s)}}function Hh(i,s){return ul(i)&&yd(s)?wd(Qt(i),s):function(l){var u=wl(l,i);return u===t&&u===s?El(l,i):br(s,u,A|U)}}function Ms(i,s,l,u,f){i!==s&&Ha(s,function(g,m){if(f||(f=new Wt),De(g))tw(i,s,m,l,Ms,u,f);else{var w=u?u(dl(i,m),g,m+"",i,s,f):t;w===t&&(w=g),Ba(i,m,w)}},pt)}function tw(i,s,l,u,f,g,m){var w=dl(i,l),I=dl(s,l),N=m.get(I);if(N){Ba(i,l,N);return}var k=g?g(w,I,l+"",i,s,m):t,O=k===t;if(O){var F=ne(I),G=!F&&Ln(I),j=!F&&!G&&Ui(I);k=I,F||G||j?ne(w)?k=w:We(w)?k=dt(w):G?(O=!1,k=Zh(I,!0)):j?(O=!1,k=ed(I,!0)):k=[]:Ar(I)||oi(I)?(k=w,oi(w)?k=Qd(w):(!De(w)||hn(w))&&(k=vd(I))):O=!1}O&&(m.set(I,k),f(k,I,u,g,m),m.delete(I)),Ba(i,l,k)}function $h(i,s){var l=i.length;if(l)return s+=s<0?l:0,un(s,l)?i[s]:t}function Vh(i,s,l){s.length?s=xe(s,function(g){return ne(g)?function(m){return ii(m,g.length===1?g[0]:g)}:g}):s=[_t];var u=-1;s=xe(s,wt(K()));var f=Bh(i,function(g,m,w){var I=xe(s,function(N){return N(g)});return{criteria:I,index:++u,value:g}});return Rv(f,function(g,m){return pw(g,m,l)})}function nw(i,s){return qh(i,s,function(l,u){return El(i,u)})}function qh(i,s,l){for(var u=-1,f=s.length,g={};++u<f;){var m=s[u],w=ii(i,m);l(w,m)&&Ir(g,Pn(m,i),w)}return g}function iw(i){return function(s){return ii(s,i)}}function Ya(i,s,l,u){var f=u?Av:Si,g=-1,m=s.length,w=i;for(i===s&&(s=dt(s)),l&&(w=xe(i,wt(l)));++g<m;)for(var I=0,N=s[g],k=l?l(N):N;(I=f(w,k,I,u))>-1;)w!==i&&Ss.call(w,I,1),Ss.call(i,I,1);return i}function Gh(i,s){for(var l=i?s.length:0,u=l-1;l--;){var f=s[l];if(l==u||f!==g){var g=f;un(f)?Ss.call(i,f,1):Ja(i,f)}}return i}function ja(i,s){return i+Ns(Th()*(s-i+1))}function rw(i,s,l,u){for(var f=-1,g=qe(Rs((s-i)/(l||1)),0),m=T(g);g--;)m[u?g:++f]=i,i+=l;return m}function Qa(i,s){var l="";if(!i||s<1||s>Pe)return l;do s%2&&(l+=i),s=Ns(s/2),s&&(i+=i);while(s);return l}function se(i,s){return fl(Ed(i,s,_t),i+"")}function sw(i){return Rh(Fi(i))}function ow(i,s){var l=Fi(i);return zs(l,ni(s,0,l.length))}function Ir(i,s,l,u){if(!De(i))return i;s=Pn(s,i);for(var f=-1,g=s.length,m=g-1,w=i;w!=null&&++f<g;){var I=Qt(s[f]),N=l;if(I==="__proto__"||I==="constructor"||I==="prototype")return i;if(f!=m){var k=w[I];N=u?u(k,I,w):t,N===t&&(N=De(k)?k:un(s[f+1])?[]:{})}yr(w,I,N),w=w[I]}return i}var zh=ks?function(i,s){return ks.set(i,s),i}:_t,aw=As?function(i,s){return As(i,"toString",{configurable:!0,enumerable:!1,value:Il(s),writable:!0})}:_t;function lw(i){return zs(Fi(i))}function xt(i,s,l){var u=-1,f=i.length;s<0&&(s=-s>f?0:f+s),l=l>f?f:l,l<0&&(l+=f),f=s>l?0:l-s>>>0,s>>>=0;for(var g=T(f);++u<f;)g[u]=i[u+s];return g}function cw(i,s){var l;return On(i,function(u,f,g){return l=s(u,f,g),!l}),!!l}function Us(i,s,l){var u=0,f=i==null?u:i.length;if(typeof s=="number"&&s===s&&f<=oa){for(;u<f;){var g=u+f>>>1,m=i[g];m!==null&&!bt(m)&&(l?m<=s:m<s)?u=g+1:f=g}return f}return Xa(i,s,_t,l)}function Xa(i,s,l,u){var f=0,g=i==null?0:i.length;if(g===0)return 0;s=l(s);for(var m=s!==s,w=s===null,I=bt(s),N=s===t;f<g;){var k=Ns((f+g)/2),O=l(i[k]),F=O!==t,G=O===null,j=O===O,re=bt(O);if(m)var Q=u||j;else N?Q=j&&(u||F):w?Q=j&&F&&(u||!G):I?Q=j&&F&&!G&&(u||!re):G||re?Q=!1:Q=u?O<=s:O<s;Q?f=k+1:g=k}return nt(g,sa)}function Kh(i,s){for(var l=-1,u=i.length,f=0,g=[];++l<u;){var m=i[l],w=s?s(m):m;if(!l||!Ht(w,I)){var I=w;g[f++]=m===0?0:m}}return g}function Yh(i){return typeof i=="number"?i:bt(i)?Tn:+i}function Et(i){if(typeof i=="string")return i;if(ne(i))return xe(i,Et)+"";if(bt(i))return Sh?Sh.call(i):"";var s=i+"";return s=="0"&&1/i==-Ie?"-0":s}function xn(i,s,l){var u=-1,f=gs,g=i.length,m=!0,w=[],I=w;if(l)m=!1,f=Sa;else if(g>=o){var N=s?null:ww(i);if(N)return vs(N);m=!1,f=fr,I=new ti}else I=s?[]:w;e:for(;++u<g;){var k=i[u],O=s?s(k):k;if(k=l||k!==0?k:0,m&&O===O){for(var F=I.length;F--;)if(I[F]===O)continue e;s&&I.push(O),w.push(k)}else f(I,O,l)||(I!==w&&I.push(O),w.push(k))}return w}function Ja(i,s){return s=Pn(s,i),i=bd(i,s),i==null||delete i[Qt(Pt(s))]}function jh(i,s,l,u){return Ir(i,s,l(ii(i,s)),u)}function Fs(i,s,l,u){for(var f=i.length,g=u?f:-1;(u?g--:++g<f)&&s(i[g],g,i););return l?xt(i,u?0:g,u?g+1:f):xt(i,u?g+1:0,u?f:g)}function Qh(i,s){var l=i;return l instanceof he&&(l=l.value()),Aa(s,function(u,f){return f.func.apply(f.thisArg,Rn([u],f.args))},l)}function Za(i,s,l){var u=i.length;if(u<2)return u?xn(i[0]):[];for(var f=-1,g=T(u);++f<u;)for(var m=i[f],w=-1;++w<u;)w!=f&&(g[f]=wr(g[f]||m,i[w],s,l));return xn(Je(g,1),s,l)}function Xh(i,s,l){for(var u=-1,f=i.length,g=s.length,m={};++u<f;){var w=u<g?s[u]:t;l(m,i[u],w)}return m}function el(i){return We(i)?i:[]}function tl(i){return typeof i=="function"?i:_t}function Pn(i,s){return ne(i)?i:ul(i,s)?[i]:Sd(_e(i))}var uw=se;function Dn(i,s,l){var u=i.length;return l=l===t?u:l,!s&&l>=u?i:xt(i,s,l)}var Jh=Xv||function(i){return Xe.clearTimeout(i)};function Zh(i,s){if(s)return i.slice();var l=i.length,u=wh?wh(l):new i.constructor(l);return i.copy(u),u}function nl(i){var s=new i.constructor(i.byteLength);return new Cs(s).set(new Cs(i)),s}function hw(i,s){var l=s?nl(i.buffer):i.buffer;return new i.constructor(l,i.byteOffset,i.byteLength)}function dw(i){var s=new i.constructor(i.source,Mu.exec(i));return s.lastIndex=i.lastIndex,s}function fw(i){return vr?Ee(vr.call(i)):{}}function ed(i,s){var l=s?nl(i.buffer):i.buffer;return new i.constructor(l,i.byteOffset,i.length)}function td(i,s){if(i!==s){var l=i!==t,u=i===null,f=i===i,g=bt(i),m=s!==t,w=s===null,I=s===s,N=bt(s);if(!w&&!N&&!g&&i>s||g&&m&&I&&!w&&!N||u&&m&&I||!l&&I||!f)return 1;if(!u&&!g&&!N&&i<s||N&&l&&f&&!u&&!g||w&&l&&f||!m&&f||!I)return-1}return 0}function pw(i,s,l){for(var u=-1,f=i.criteria,g=s.criteria,m=f.length,w=l.length;++u<m;){var I=td(f[u],g[u]);if(I){if(u>=w)return I;var N=l[u];return I*(N=="desc"?-1:1)}}return i.index-s.index}function nd(i,s,l,u){for(var f=-1,g=i.length,m=l.length,w=-1,I=s.length,N=qe(g-m,0),k=T(I+N),O=!u;++w<I;)k[w]=s[w];for(;++f<m;)(O||f<g)&&(k[l[f]]=i[f]);for(;N--;)k[w++]=i[f++];return k}function id(i,s,l,u){for(var f=-1,g=i.length,m=-1,w=l.length,I=-1,N=s.length,k=qe(g-w,0),O=T(k+N),F=!u;++f<k;)O[f]=i[f];for(var G=f;++I<N;)O[G+I]=s[I];for(;++m<w;)(F||f<g)&&(O[G+l[m]]=i[f++]);return O}function dt(i,s){var l=-1,u=i.length;for(s||(s=T(u));++l<u;)s[l]=i[l];return s}function jt(i,s,l,u){var f=!l;l||(l={});for(var g=-1,m=s.length;++g<m;){var w=s[g],I=u?u(l[w],i[w],w,l,i):t;I===t&&(I=i[w]),f?an(l,w,I):yr(l,w,I)}return l}function _w(i,s){return jt(i,cl(i),s)}function gw(i,s){return jt(i,gd(i),s)}function Bs(i,s){return function(l,u){var f=ne(l)?Ev:Fy,g=s?s():{};return f(l,i,K(u,2),g)}}function Di(i){return se(function(s,l){var u=-1,f=l.length,g=f>1?l[f-1]:t,m=f>2?l[2]:t;for(g=i.length>3&&typeof g=="function"?(f--,g):t,m&&at(l[0],l[1],m)&&(g=f<3?t:g,f=1),s=Ee(s);++u<f;){var w=l[u];w&&i(s,w,u,g)}return s})}function rd(i,s){return function(l,u){if(l==null)return l;if(!ft(l))return i(l,u);for(var f=l.length,g=s?f:-1,m=Ee(l);(s?g--:++g<f)&&u(m[g],g,m)!==!1;);return l}}function sd(i){return function(s,l,u){for(var f=-1,g=Ee(s),m=u(s),w=m.length;w--;){var I=m[i?w:++f];if(l(g[I],I,g)===!1)break}return s}}function mw(i,s,l){var u=s&P,f=Cr(i);function g(){var m=this&&this!==Xe&&this instanceof g?f:i;return m.apply(u?l:this,arguments)}return g}function od(i){return function(s){s=_e(s);var l=Ai(s)?Bt(s):t,u=l?l[0]:s.charAt(0),f=l?Dn(l,1).join(""):s.slice(1);return u[i]()+f}}function Li(i){return function(s){return Aa(sf(rf(s).replace(av,"")),i,"")}}function Cr(i){return function(){var s=arguments;switch(s.length){case 0:return new i;case 1:return new i(s[0]);case 2:return new i(s[0],s[1]);case 3:return new i(s[0],s[1],s[2]);case 4:return new i(s[0],s[1],s[2],s[3]);case 5:return new i(s[0],s[1],s[2],s[3],s[4]);case 6:return new i(s[0],s[1],s[2],s[3],s[4],s[5]);case 7:return new i(s[0],s[1],s[2],s[3],s[4],s[5],s[6])}var l=Pi(i.prototype),u=i.apply(l,s);return De(u)?u:l}}function vw(i,s,l){var u=Cr(i);function f(){for(var g=arguments.length,m=T(g),w=g,I=Mi(f);w--;)m[w]=arguments[w];var N=g<3&&m[0]!==I&&m[g-1]!==I?[]:Nn(m,I);if(g-=N.length,g<l)return hd(i,s,Ws,f.placeholder,t,m,N,t,t,l-g);var k=this&&this!==Xe&&this instanceof f?u:i;return yt(k,this,m)}return f}function ad(i){return function(s,l,u){var f=Ee(s);if(!ft(s)){var g=K(l,3);s=Ge(s),l=function(w){return g(f[w],w,f)}}var m=i(s,l,u);return m>-1?f[g?s[m]:m]:t}}function ld(i){return cn(function(s){var l=s.length,u=l,f=kt.prototype.thru;for(i&&s.reverse();u--;){var g=s[u];if(typeof g!="function")throw new Nt(c);if(f&&!m&&qs(g)=="wrapper")var m=new kt([],!0)}for(u=m?u:l;++u<l;){g=s[u];var w=qs(g),I=w=="wrapper"?al(g):t;I&&hl(I[0])&&I[1]==(D|B|V|$)&&!I[4].length&&I[9]==1?m=m[qs(I[0])].apply(m,I[3]):m=g.length==1&&hl(g)?m[w]():m.thru(g)}return function(){var N=arguments,k=N[0];if(m&&N.length==1&&ne(k))return m.plant(k).value();for(var O=0,F=l?s[O].apply(this,N):k;++O<l;)F=s[O].call(this,F);return F}})}function Ws(i,s,l,u,f,g,m,w,I,N){var k=s&D,O=s&P,F=s&Y,G=s&(B|L),j=s&J,re=F?t:Cr(i);function Q(){for(var le=arguments.length,de=T(le),It=le;It--;)de[It]=arguments[It];if(G)var lt=Mi(Q),Ct=kv(de,lt);if(u&&(de=nd(de,u,f,G)),g&&(de=id(de,g,m,G)),le-=Ct,G&&le<N){var He=Nn(de,lt);return hd(i,s,Ws,Q.placeholder,l,de,He,w,I,N-le)}var $t=O?l:this,fn=F?$t[i]:i;return le=de.length,w?de=Fw(de,w):j&&le>1&&de.reverse(),k&&I<le&&(de.length=I),this&&this!==Xe&&this instanceof Q&&(fn=re||Cr(fn)),fn.apply($t,de)}return Q}function cd(i,s){return function(l,u){return zy(l,i,s(u),{})}}function Hs(i,s){return function(l,u){var f;if(l===t&&u===t)return s;if(l!==t&&(f=l),u!==t){if(f===t)return u;typeof l=="string"||typeof u=="string"?(l=Et(l),u=Et(u)):(l=Yh(l),u=Yh(u)),f=i(l,u)}return f}}function il(i){return cn(function(s){return s=xe(s,wt(K())),se(function(l){var u=this;return i(s,function(f){return yt(f,u,l)})})})}function $s(i,s){s=s===t?" ":Et(s);var l=s.length;if(l<2)return l?Qa(s,i):s;var u=Qa(s,Rs(i/Ri(s)));return Ai(s)?Dn(Bt(u),0,i).join(""):u.slice(0,i)}function yw(i,s,l,u){var f=s&P,g=Cr(i);function m(){for(var w=-1,I=arguments.length,N=-1,k=u.length,O=T(k+I),F=this&&this!==Xe&&this instanceof m?g:i;++N<k;)O[N]=u[N];for(;I--;)O[N++]=arguments[++w];return yt(F,f?l:this,O)}return m}function ud(i){return function(s,l,u){return u&&typeof u!="number"&&at(s,l,u)&&(l=u=t),s=dn(s),l===t?(l=s,s=0):l=dn(l),u=u===t?s<l?1:-1:dn(u),rw(s,l,u,i)}}function Vs(i){return function(s,l){return typeof s=="string"&&typeof l=="string"||(s=Dt(s),l=Dt(l)),i(s,l)}}function hd(i,s,l,u,f,g,m,w,I,N){var k=s&B,O=k?m:t,F=k?t:m,G=k?g:t,j=k?t:g;s|=k?V:x,s&=~(k?x:V),s&W||(s&=~(P|Y));var re=[i,s,f,G,O,j,F,w,I,N],Q=l.apply(t,re);return hl(i)&&Id(Q,re),Q.placeholder=u,Cd(Q,i,s)}function rl(i){var s=Ve[i];return function(l,u){if(l=Dt(l),u=u==null?0:nt(ie(u),292),u&&Ch(l)){var f=(_e(l)+"e").split("e"),g=s(f[0]+"e"+(+f[1]+u));return f=(_e(g)+"e").split("e"),+(f[0]+"e"+(+f[1]-u))}return s(l)}}var ww=Oi&&1/vs(new Oi([,-0]))[1]==Ie?function(i){return new Oi(i)}:Sl;function dd(i){return function(s){var l=it(s);return l==Ut?Da(s):l==Ft?Uv(s):Nv(s,i(s))}}function ln(i,s,l,u,f,g,m,w){var I=s&Y;if(!I&&typeof i!="function")throw new Nt(c);var N=u?u.length:0;if(N||(s&=~(V|x),u=f=t),m=m===t?m:qe(ie(m),0),w=w===t?w:ie(w),N-=f?f.length:0,s&x){var k=u,O=f;u=f=t}var F=I?t:al(i),G=[i,s,l,u,f,k,O,g,m,w];if(F&&Lw(G,F),i=G[0],s=G[1],l=G[2],u=G[3],f=G[4],w=G[9]=G[9]===t?I?0:i.length:qe(G[9]-N,0),!w&&s&(B|L)&&(s&=~(B|L)),!s||s==P)var j=mw(i,s,l);else s==B||s==L?j=vw(i,s,w):(s==V||s==(P|V))&&!f.length?j=yw(i,s,l,u):j=Ws.apply(t,G);var re=F?zh:Id;return Cd(re(j,G),i,s)}function fd(i,s,l,u){return i===t||Ht(i,ki[l])&&!ge.call(u,l)?s:i}function pd(i,s,l,u,f,g){return De(i)&&De(s)&&(g.set(s,i),Ms(i,s,t,pd,g),g.delete(s)),i}function Ew(i){return Ar(i)?t:i}function _d(i,s,l,u,f,g){var m=l&A,w=i.length,I=s.length;if(w!=I&&!(m&&I>w))return!1;var N=g.get(i),k=g.get(s);if(N&&k)return N==s&&k==i;var O=-1,F=!0,G=l&U?new ti:t;for(g.set(i,s),g.set(s,i);++O<w;){var j=i[O],re=s[O];if(u)var Q=m?u(re,j,O,s,i,g):u(j,re,O,i,s,g);if(Q!==t){if(Q)continue;F=!1;break}if(G){if(!Ra(s,function(le,de){if(!fr(G,de)&&(j===le||f(j,le,l,u,g)))return G.push(de)})){F=!1;break}}else if(!(j===re||f(j,re,l,u,g))){F=!1;break}}return g.delete(i),g.delete(s),F}function bw(i,s,l,u,f,g,m){switch(l){case Ci:if(i.byteLength!=s.byteLength||i.byteOffset!=s.byteOffset)return!1;i=i.buffer,s=s.buffer;case dr:return!(i.byteLength!=s.byteLength||!g(new Cs(i),new Cs(s)));case ue:case Oe:case lr:return Ht(+i,+s);case Kt:return i.name==s.name&&i.message==s.message;case cr:case ur:return i==s+"";case Ut:var w=Da;case Ft:var I=u&A;if(w||(w=vs),i.size!=s.size&&!I)return!1;var N=m.get(i);if(N)return N==s;u|=U,m.set(i,s);var k=_d(w(i),w(s),u,f,g,m);return m.delete(i),k;case ds:if(vr)return vr.call(i)==vr.call(s)}return!1}function Iw(i,s,l,u,f,g){var m=l&A,w=sl(i),I=w.length,N=sl(s),k=N.length;if(I!=k&&!m)return!1;for(var O=I;O--;){var F=w[O];if(!(m?F in s:ge.call(s,F)))return!1}var G=g.get(i),j=g.get(s);if(G&&j)return G==s&&j==i;var re=!0;g.set(i,s),g.set(s,i);for(var Q=m;++O<I;){F=w[O];var le=i[F],de=s[F];if(u)var It=m?u(de,le,F,s,i,g):u(le,de,F,i,s,g);if(!(It===t?le===de||f(le,de,l,u,g):It)){re=!1;break}Q||(Q=F=="constructor")}if(re&&!Q){var lt=i.constructor,Ct=s.constructor;lt!=Ct&&"constructor"in i&&"constructor"in s&&!(typeof lt=="function"&&lt instanceof lt&&typeof Ct=="function"&&Ct instanceof Ct)&&(re=!1)}return g.delete(i),g.delete(s),re}function cn(i){return fl(Ed(i,t,kd),i+"")}function sl(i){return Lh(i,Ge,cl)}function ol(i){return Lh(i,pt,gd)}var al=ks?function(i){return ks.get(i)}:Sl;function qs(i){for(var s=i.name+"",l=xi[s],u=ge.call(xi,s)?l.length:0;u--;){var f=l[u],g=f.func;if(g==null||g==i)return f.name}return s}function Mi(i){var s=ge.call(_,"placeholder")?_:i;return s.placeholder}function K(){var i=_.iteratee||Cl;return i=i===Cl?Fh:i,arguments.length?i(arguments[0],arguments[1]):i}function Gs(i,s){var l=i.__data__;return Ow(s)?l[typeof s=="string"?"string":"hash"]:l.map}function ll(i){for(var s=Ge(i),l=s.length;l--;){var u=s[l],f=i[u];s[l]=[u,f,yd(f)]}return s}function ri(i,s){var l=Dv(i,s);return Uh(l)?l:t}function Cw(i){var s=ge.call(i,Zn),l=i[Zn];try{i[Zn]=t;var u=!0}catch{}var f=bs.call(i);return u&&(s?i[Zn]=l:delete i[Zn]),f}var cl=Ma?function(i){return i==null?[]:(i=Ee(i),An(Ma(i),function(s){return bh.call(i,s)}))}:Al,gd=Ma?function(i){for(var s=[];i;)Rn(s,cl(i)),i=Ts(i);return s}:Al,it=ot;(Ua&&it(new Ua(new ArrayBuffer(1)))!=Ci||_r&&it(new _r)!=Ut||Fa&&it(Fa.resolve())!=xu||Oi&&it(new Oi)!=Ft||gr&&it(new gr)!=hr)&&(it=function(i){var s=ot(i),l=s==rn?i.constructor:t,u=l?si(l):"";if(u)switch(u){case oy:return Ci;case ay:return Ut;case ly:return xu;case cy:return Ft;case uy:return hr}return s});function Tw(i,s,l){for(var u=-1,f=l.length;++u<f;){var g=l[u],m=g.size;switch(g.type){case"drop":i+=m;break;case"dropRight":s-=m;break;case"take":s=nt(s,i+m);break;case"takeRight":i=qe(i,s-m);break}}return{start:i,end:s}}function Sw(i){var s=i.match(xm);return s?s[1].split(Pm):[]}function md(i,s,l){s=Pn(s,i);for(var u=-1,f=s.length,g=!1;++u<f;){var m=Qt(s[u]);if(!(g=i!=null&&l(i,m)))break;i=i[m]}return g||++u!=f?g:(f=i==null?0:i.length,!!f&&Js(f)&&un(m,f)&&(ne(i)||oi(i)))}function Aw(i){var s=i.length,l=new i.constructor(s);return s&&typeof i[0]=="string"&&ge.call(i,"index")&&(l.index=i.index,l.input=i.input),l}function vd(i){return typeof i.constructor=="function"&&!Tr(i)?Pi(Ts(i)):{}}function Rw(i,s,l){var u=i.constructor;switch(s){case dr:return nl(i);case ue:case Oe:return new u(+i);case Ci:return hw(i,l);case la:case ca:case ua:case ha:case da:case fa:case pa:case _a:case ga:return ed(i,l);case Ut:return new u;case lr:case ur:return new u(i);case cr:return dw(i);case Ft:return new u;case ds:return fw(i)}}function Nw(i,s){var l=s.length;if(!l)return i;var u=l-1;return s[u]=(l>1?"& ":"")+s[u],s=s.join(l>2?", ":" "),i.replace(Om,`{
/* [wrapped with `+s+`] */
`)}function kw(i){return ne(i)||oi(i)||!!(Ih&&i&&i[Ih])}function un(i,s){var l=typeof i;return s=s??Pe,!!s&&(l=="number"||l!="symbol"&&$m.test(i))&&i>-1&&i%1==0&&i<s}function at(i,s,l){if(!De(l))return!1;var u=typeof s;return(u=="number"?ft(l)&&un(s,l.length):u=="string"&&s in l)?Ht(l[s],i):!1}function ul(i,s){if(ne(i))return!1;var l=typeof i;return l=="number"||l=="symbol"||l=="boolean"||i==null||bt(i)?!0:Am.test(i)||!Sm.test(i)||s!=null&&i in Ee(s)}function Ow(i){var s=typeof i;return s=="string"||s=="number"||s=="symbol"||s=="boolean"?i!=="__proto__":i===null}function hl(i){var s=qs(i),l=_[s];if(typeof l!="function"||!(s in he.prototype))return!1;if(i===l)return!0;var u=al(l);return!!u&&i===u[0]}function xw(i){return!!yh&&yh in i}var Pw=ws?hn:Rl;function Tr(i){var s=i&&i.constructor,l=typeof s=="function"&&s.prototype||ki;return i===l}function yd(i){return i===i&&!De(i)}function wd(i,s){return function(l){return l==null?!1:l[i]===s&&(s!==t||i in Ee(l))}}function Dw(i){var s=Qs(i,function(u){return l.size===p&&l.clear(),u}),l=s.cache;return s}function Lw(i,s){var l=i[1],u=s[1],f=l|u,g=f<(P|Y|D),m=u==D&&l==B||u==D&&l==$&&i[7].length<=s[8]||u==(D|$)&&s[7].length<=s[8]&&l==B;if(!(g||m))return i;u&P&&(i[2]=s[2],f|=l&P?0:W);var w=s[3];if(w){var I=i[3];i[3]=I?nd(I,w,s[4]):w,i[4]=I?Nn(i[3],y):s[4]}return w=s[5],w&&(I=i[5],i[5]=I?id(I,w,s[6]):w,i[6]=I?Nn(i[5],y):s[6]),w=s[7],w&&(i[7]=w),u&D&&(i[8]=i[8]==null?s[8]:nt(i[8],s[8])),i[9]==null&&(i[9]=s[9]),i[0]=s[0],i[1]=f,i}function Mw(i){var s=[];if(i!=null)for(var l in Ee(i))s.push(l);return s}function Uw(i){return bs.call(i)}function Ed(i,s,l){return s=qe(s===t?i.length-1:s,0),function(){for(var u=arguments,f=-1,g=qe(u.length-s,0),m=T(g);++f<g;)m[f]=u[s+f];f=-1;for(var w=T(s+1);++f<s;)w[f]=u[f];return w[s]=l(m),yt(i,this,w)}}function bd(i,s){return s.length<2?i:ii(i,xt(s,0,-1))}function Fw(i,s){for(var l=i.length,u=nt(s.length,l),f=dt(i);u--;){var g=s[u];i[u]=un(g,l)?f[g]:t}return i}function dl(i,s){if(!(s==="constructor"&&typeof i[s]=="function")&&s!="__proto__")return i[s]}var Id=Td(zh),Sr=Zv||function(i,s){return Xe.setTimeout(i,s)},fl=Td(aw);function Cd(i,s,l){var u=s+"";return fl(i,Nw(u,Bw(Sw(u),l)))}function Td(i){var s=0,l=0;return function(){var u=iy(),f=z-(u-l);if(l=u,f>0){if(++s>=R)return arguments[0]}else s=0;return i.apply(t,arguments)}}function zs(i,s){var l=-1,u=i.length,f=u-1;for(s=s===t?u:s;++l<s;){var g=ja(l,f),m=i[g];i[g]=i[l],i[l]=m}return i.length=s,i}var Sd=Dw(function(i){var s=[];return i.charCodeAt(0)===46&&s.push(""),i.replace(Rm,function(l,u,f,g){s.push(f?g.replace(Mm,"$1"):u||l)}),s});function Qt(i){if(typeof i=="string"||bt(i))return i;var s=i+"";return s=="0"&&1/i==-Ie?"-0":s}function si(i){if(i!=null){try{return Es.call(i)}catch{}try{return i+""}catch{}}return""}function Bw(i,s){return Rt(aa,function(l){var u="_."+l[0];s&l[1]&&!gs(i,u)&&i.push(u)}),i.sort()}function Ad(i){if(i instanceof he)return i.clone();var s=new kt(i.__wrapped__,i.__chain__);return s.__actions__=dt(i.__actions__),s.__index__=i.__index__,s.__values__=i.__values__,s}function Ww(i,s,l){(l?at(i,s,l):s===t)?s=1:s=qe(ie(s),0);var u=i==null?0:i.length;if(!u||s<1)return[];for(var f=0,g=0,m=T(Rs(u/s));f<u;)m[g++]=xt(i,f,f+=s);return m}function Hw(i){for(var s=-1,l=i==null?0:i.length,u=0,f=[];++s<l;){var g=i[s];g&&(f[u++]=g)}return f}function $w(){var i=arguments.length;if(!i)return[];for(var s=T(i-1),l=arguments[0],u=i;u--;)s[u-1]=arguments[u];return Rn(ne(l)?dt(l):[l],Je(s,1))}var Vw=se(function(i,s){return We(i)?wr(i,Je(s,1,We,!0)):[]}),qw=se(function(i,s){var l=Pt(s);return We(l)&&(l=t),We(i)?wr(i,Je(s,1,We,!0),K(l,2)):[]}),Gw=se(function(i,s){var l=Pt(s);return We(l)&&(l=t),We(i)?wr(i,Je(s,1,We,!0),t,l):[]});function zw(i,s,l){var u=i==null?0:i.length;return u?(s=l||s===t?1:ie(s),xt(i,s<0?0:s,u)):[]}function Kw(i,s,l){var u=i==null?0:i.length;return u?(s=l||s===t?1:ie(s),s=u-s,xt(i,0,s<0?0:s)):[]}function Yw(i,s){return i&&i.length?Fs(i,K(s,3),!0,!0):[]}function jw(i,s){return i&&i.length?Fs(i,K(s,3),!0):[]}function Qw(i,s,l,u){var f=i==null?0:i.length;return f?(l&&typeof l!="number"&&at(i,s,l)&&(l=0,u=f),$y(i,s,l,u)):[]}function Rd(i,s,l){var u=i==null?0:i.length;if(!u)return-1;var f=l==null?0:ie(l);return f<0&&(f=qe(u+f,0)),ms(i,K(s,3),f)}function Nd(i,s,l){var u=i==null?0:i.length;if(!u)return-1;var f=u-1;return l!==t&&(f=ie(l),f=l<0?qe(u+f,0):nt(f,u-1)),ms(i,K(s,3),f,!0)}function kd(i){var s=i==null?0:i.length;return s?Je(i,1):[]}function Xw(i){var s=i==null?0:i.length;return s?Je(i,Ie):[]}function Jw(i,s){var l=i==null?0:i.length;return l?(s=s===t?1:ie(s),Je(i,s)):[]}function Zw(i){for(var s=-1,l=i==null?0:i.length,u={};++s<l;){var f=i[s];u[f[0]]=f[1]}return u}function Od(i){return i&&i.length?i[0]:t}function eE(i,s,l){var u=i==null?0:i.length;if(!u)return-1;var f=l==null?0:ie(l);return f<0&&(f=qe(u+f,0)),Si(i,s,f)}function tE(i){var s=i==null?0:i.length;return s?xt(i,0,-1):[]}var nE=se(function(i){var s=xe(i,el);return s.length&&s[0]===i[0]?qa(s):[]}),iE=se(function(i){var s=Pt(i),l=xe(i,el);return s===Pt(l)?s=t:l.pop(),l.length&&l[0]===i[0]?qa(l,K(s,2)):[]}),rE=se(function(i){var s=Pt(i),l=xe(i,el);return s=typeof s=="function"?s:t,s&&l.pop(),l.length&&l[0]===i[0]?qa(l,t,s):[]});function sE(i,s){return i==null?"":ty.call(i,s)}function Pt(i){var s=i==null?0:i.length;return s?i[s-1]:t}function oE(i,s,l){var u=i==null?0:i.length;if(!u)return-1;var f=u;return l!==t&&(f=ie(l),f=f<0?qe(u+f,0):nt(f,u-1)),s===s?Bv(i,s,f):ms(i,hh,f,!0)}function aE(i,s){return i&&i.length?$h(i,ie(s)):t}var lE=se(xd);function xd(i,s){return i&&i.length&&s&&s.length?Ya(i,s):i}function cE(i,s,l){return i&&i.length&&s&&s.length?Ya(i,s,K(l,2)):i}function uE(i,s,l){return i&&i.length&&s&&s.length?Ya(i,s,t,l):i}var hE=cn(function(i,s){var l=i==null?0:i.length,u=Wa(i,s);return Gh(i,xe(s,function(f){return un(f,l)?+f:f}).sort(td)),u});function dE(i,s){var l=[];if(!(i&&i.length))return l;var u=-1,f=[],g=i.length;for(s=K(s,3);++u<g;){var m=i[u];s(m,u,i)&&(l.push(m),f.push(u))}return Gh(i,f),l}function pl(i){return i==null?i:sy.call(i)}function fE(i,s,l){var u=i==null?0:i.length;return u?(l&&typeof l!="number"&&at(i,s,l)?(s=0,l=u):(s=s==null?0:ie(s),l=l===t?u:ie(l)),xt(i,s,l)):[]}function pE(i,s){return Us(i,s)}function _E(i,s,l){return Xa(i,s,K(l,2))}function gE(i,s){var l=i==null?0:i.length;if(l){var u=Us(i,s);if(u<l&&Ht(i[u],s))return u}return-1}function mE(i,s){return Us(i,s,!0)}function vE(i,s,l){return Xa(i,s,K(l,2),!0)}function yE(i,s){var l=i==null?0:i.length;if(l){var u=Us(i,s,!0)-1;if(Ht(i[u],s))return u}return-1}function wE(i){return i&&i.length?Kh(i):[]}function EE(i,s){return i&&i.length?Kh(i,K(s,2)):[]}function bE(i){var s=i==null?0:i.length;return s?xt(i,1,s):[]}function IE(i,s,l){return i&&i.length?(s=l||s===t?1:ie(s),xt(i,0,s<0?0:s)):[]}function CE(i,s,l){var u=i==null?0:i.length;return u?(s=l||s===t?1:ie(s),s=u-s,xt(i,s<0?0:s,u)):[]}function TE(i,s){return i&&i.length?Fs(i,K(s,3),!1,!0):[]}function SE(i,s){return i&&i.length?Fs(i,K(s,3)):[]}var AE=se(function(i){return xn(Je(i,1,We,!0))}),RE=se(function(i){var s=Pt(i);return We(s)&&(s=t),xn(Je(i,1,We,!0),K(s,2))}),NE=se(function(i){var s=Pt(i);return s=typeof s=="function"?s:t,xn(Je(i,1,We,!0),t,s)});function kE(i){return i&&i.length?xn(i):[]}function OE(i,s){return i&&i.length?xn(i,K(s,2)):[]}function xE(i,s){return s=typeof s=="function"?s:t,i&&i.length?xn(i,t,s):[]}function _l(i){if(!(i&&i.length))return[];var s=0;return i=An(i,function(l){if(We(l))return s=qe(l.length,s),!0}),xa(s,function(l){return xe(i,Na(l))})}function Pd(i,s){if(!(i&&i.length))return[];var l=_l(i);return s==null?l:xe(l,function(u){return yt(s,t,u)})}var PE=se(function(i,s){return We(i)?wr(i,s):[]}),DE=se(function(i){return Za(An(i,We))}),LE=se(function(i){var s=Pt(i);return We(s)&&(s=t),Za(An(i,We),K(s,2))}),ME=se(function(i){var s=Pt(i);return s=typeof s=="function"?s:t,Za(An(i,We),t,s)}),UE=se(_l);function FE(i,s){return Xh(i||[],s||[],yr)}function BE(i,s){return Xh(i||[],s||[],Ir)}var WE=se(function(i){var s=i.length,l=s>1?i[s-1]:t;return l=typeof l=="function"?(i.pop(),l):t,Pd(i,l)});function Dd(i){var s=_(i);return s.__chain__=!0,s}function HE(i,s){return s(i),i}function Ks(i,s){return s(i)}var $E=cn(function(i){var s=i.length,l=s?i[0]:0,u=this.__wrapped__,f=function(g){return Wa(g,i)};return s>1||this.__actions__.length||!(u instanceof he)||!un(l)?this.thru(f):(u=u.slice(l,+l+(s?1:0)),u.__actions__.push({func:Ks,args:[f],thisArg:t}),new kt(u,this.__chain__).thru(function(g){return s&&!g.length&&g.push(t),g}))});function VE(){return Dd(this)}function qE(){return new kt(this.value(),this.__chain__)}function GE(){this.__values__===t&&(this.__values__=Yd(this.value()));var i=this.__index__>=this.__values__.length,s=i?t:this.__values__[this.__index__++];return{done:i,value:s}}function zE(){return this}function KE(i){for(var s,l=this;l instanceof xs;){var u=Ad(l);u.__index__=0,u.__values__=t,s?f.__wrapped__=u:s=u;var f=u;l=l.__wrapped__}return f.__wrapped__=i,s}function YE(){var i=this.__wrapped__;if(i instanceof he){var s=i;return this.__actions__.length&&(s=new he(this)),s=s.reverse(),s.__actions__.push({func:Ks,args:[pl],thisArg:t}),new kt(s,this.__chain__)}return this.thru(pl)}function jE(){return Qh(this.__wrapped__,this.__actions__)}var QE=Bs(function(i,s,l){ge.call(i,l)?++i[l]:an(i,l,1)});function XE(i,s,l){var u=ne(i)?ch:Hy;return l&&at(i,s,l)&&(s=t),u(i,K(s,3))}function JE(i,s){var l=ne(i)?An:Ph;return l(i,K(s,3))}var ZE=ad(Rd),e0=ad(Nd);function t0(i,s){return Je(Ys(i,s),1)}function n0(i,s){return Je(Ys(i,s),Ie)}function i0(i,s,l){return l=l===t?1:ie(l),Je(Ys(i,s),l)}function Ld(i,s){var l=ne(i)?Rt:On;return l(i,K(s,3))}function Md(i,s){var l=ne(i)?bv:xh;return l(i,K(s,3))}var r0=Bs(function(i,s,l){ge.call(i,l)?i[l].push(s):an(i,l,[s])});function s0(i,s,l,u){i=ft(i)?i:Fi(i),l=l&&!u?ie(l):0;var f=i.length;return l<0&&(l=qe(f+l,0)),Zs(i)?l<=f&&i.indexOf(s,l)>-1:!!f&&Si(i,s,l)>-1}var o0=se(function(i,s,l){var u=-1,f=typeof s=="function",g=ft(i)?T(i.length):[];return On(i,function(m){g[++u]=f?yt(s,m,l):Er(m,s,l)}),g}),a0=Bs(function(i,s,l){an(i,l,s)});function Ys(i,s){var l=ne(i)?xe:Bh;return l(i,K(s,3))}function l0(i,s,l,u){return i==null?[]:(ne(s)||(s=s==null?[]:[s]),l=u?t:l,ne(l)||(l=l==null?[]:[l]),Vh(i,s,l))}var c0=Bs(function(i,s,l){i[l?0:1].push(s)},function(){return[[],[]]});function u0(i,s,l){var u=ne(i)?Aa:fh,f=arguments.length<3;return u(i,K(s,4),l,f,On)}function h0(i,s,l){var u=ne(i)?Iv:fh,f=arguments.length<3;return u(i,K(s,4),l,f,xh)}function d0(i,s){var l=ne(i)?An:Ph;return l(i,Xs(K(s,3)))}function f0(i){var s=ne(i)?Rh:sw;return s(i)}function p0(i,s,l){(l?at(i,s,l):s===t)?s=1:s=ie(s);var u=ne(i)?My:ow;return u(i,s)}function _0(i){var s=ne(i)?Uy:lw;return s(i)}function g0(i){if(i==null)return 0;if(ft(i))return Zs(i)?Ri(i):i.length;var s=it(i);return s==Ut||s==Ft?i.size:za(i).length}function m0(i,s,l){var u=ne(i)?Ra:cw;return l&&at(i,s,l)&&(s=t),u(i,K(s,3))}var v0=se(function(i,s){if(i==null)return[];var l=s.length;return l>1&&at(i,s[0],s[1])?s=[]:l>2&&at(s[0],s[1],s[2])&&(s=[s[0]]),Vh(i,Je(s,1),[])}),js=Jv||function(){return Xe.Date.now()};function y0(i,s){if(typeof s!="function")throw new Nt(c);return i=ie(i),function(){if(--i<1)return s.apply(this,arguments)}}function Ud(i,s,l){return s=l?t:s,s=i&&s==null?i.length:s,ln(i,D,t,t,t,t,s)}function Fd(i,s){var l;if(typeof s!="function")throw new Nt(c);return i=ie(i),function(){return--i>0&&(l=s.apply(this,arguments)),i<=1&&(s=t),l}}var gl=se(function(i,s,l){var u=P;if(l.length){var f=Nn(l,Mi(gl));u|=V}return ln(i,u,s,l,f)}),Bd=se(function(i,s,l){var u=P|Y;if(l.length){var f=Nn(l,Mi(Bd));u|=V}return ln(s,u,i,l,f)});function Wd(i,s,l){s=l?t:s;var u=ln(i,B,t,t,t,t,t,s);return u.placeholder=Wd.placeholder,u}function Hd(i,s,l){s=l?t:s;var u=ln(i,L,t,t,t,t,t,s);return u.placeholder=Hd.placeholder,u}function $d(i,s,l){var u,f,g,m,w,I,N=0,k=!1,O=!1,F=!0;if(typeof i!="function")throw new Nt(c);s=Dt(s)||0,De(l)&&(k=!!l.leading,O="maxWait"in l,g=O?qe(Dt(l.maxWait)||0,s):g,F="trailing"in l?!!l.trailing:F);function G(He){var $t=u,fn=f;return u=f=t,N=He,m=i.apply(fn,$t),m}function j(He){return N=He,w=Sr(le,s),k?G(He):m}function re(He){var $t=He-I,fn=He-N,lf=s-$t;return O?nt(lf,g-fn):lf}function Q(He){var $t=He-I,fn=He-N;return I===t||$t>=s||$t<0||O&&fn>=g}function le(){var He=js();if(Q(He))return de(He);w=Sr(le,re(He))}function de(He){return w=t,F&&u?G(He):(u=f=t,m)}function It(){w!==t&&Jh(w),N=0,u=I=f=w=t}function lt(){return w===t?m:de(js())}function Ct(){var He=js(),$t=Q(He);if(u=arguments,f=this,I=He,$t){if(w===t)return j(I);if(O)return Jh(w),w=Sr(le,s),G(I)}return w===t&&(w=Sr(le,s)),m}return Ct.cancel=It,Ct.flush=lt,Ct}var w0=se(function(i,s){return Oh(i,1,s)}),E0=se(function(i,s,l){return Oh(i,Dt(s)||0,l)});function b0(i){return ln(i,J)}function Qs(i,s){if(typeof i!="function"||s!=null&&typeof s!="function")throw new Nt(c);var l=function(){var u=arguments,f=s?s.apply(this,u):u[0],g=l.cache;if(g.has(f))return g.get(f);var m=i.apply(this,u);return l.cache=g.set(f,m)||g,m};return l.cache=new(Qs.Cache||on),l}Qs.Cache=on;function Xs(i){if(typeof i!="function")throw new Nt(c);return function(){var s=arguments;switch(s.length){case 0:return!i.call(this);case 1:return!i.call(this,s[0]);case 2:return!i.call(this,s[0],s[1]);case 3:return!i.call(this,s[0],s[1],s[2])}return!i.apply(this,s)}}function I0(i){return Fd(2,i)}var C0=uw(function(i,s){s=s.length==1&&ne(s[0])?xe(s[0],wt(K())):xe(Je(s,1),wt(K()));var l=s.length;return se(function(u){for(var f=-1,g=nt(u.length,l);++f<g;)u[f]=s[f].call(this,u[f]);return yt(i,this,u)})}),ml=se(function(i,s){var l=Nn(s,Mi(ml));return ln(i,V,t,s,l)}),Vd=se(function(i,s){var l=Nn(s,Mi(Vd));return ln(i,x,t,s,l)}),T0=cn(function(i,s){return ln(i,$,t,t,t,s)});function S0(i,s){if(typeof i!="function")throw new Nt(c);return s=s===t?s:ie(s),se(i,s)}function A0(i,s){if(typeof i!="function")throw new Nt(c);return s=s==null?0:qe(ie(s),0),se(function(l){var u=l[s],f=Dn(l,0,s);return u&&Rn(f,u),yt(i,this,f)})}function R0(i,s,l){var u=!0,f=!0;if(typeof i!="function")throw new Nt(c);return De(l)&&(u="leading"in l?!!l.leading:u,f="trailing"in l?!!l.trailing:f),$d(i,s,{leading:u,maxWait:s,trailing:f})}function N0(i){return Ud(i,1)}function k0(i,s){return ml(tl(s),i)}function O0(){if(!arguments.length)return[];var i=arguments[0];return ne(i)?i:[i]}function x0(i){return Ot(i,C)}function P0(i,s){return s=typeof s=="function"?s:t,Ot(i,C,s)}function D0(i){return Ot(i,v|C)}function L0(i,s){return s=typeof s=="function"?s:t,Ot(i,v|C,s)}function M0(i,s){return s==null||kh(i,s,Ge(s))}function Ht(i,s){return i===s||i!==i&&s!==s}var U0=Vs(Va),F0=Vs(function(i,s){return i>=s}),oi=Mh(function(){return arguments}())?Mh:function(i){return Le(i)&&ge.call(i,"callee")&&!bh.call(i,"callee")},ne=T.isArray,B0=ih?wt(ih):Ky;function ft(i){return i!=null&&Js(i.length)&&!hn(i)}function We(i){return Le(i)&&ft(i)}function W0(i){return i===!0||i===!1||Le(i)&&ot(i)==ue}var Ln=ey||Rl,H0=rh?wt(rh):Yy;function $0(i){return Le(i)&&i.nodeType===1&&!Ar(i)}function V0(i){if(i==null)return!0;if(ft(i)&&(ne(i)||typeof i=="string"||typeof i.splice=="function"||Ln(i)||Ui(i)||oi(i)))return!i.length;var s=it(i);if(s==Ut||s==Ft)return!i.size;if(Tr(i))return!za(i).length;for(var l in i)if(ge.call(i,l))return!1;return!0}function q0(i,s){return br(i,s)}function G0(i,s,l){l=typeof l=="function"?l:t;var u=l?l(i,s):t;return u===t?br(i,s,t,l):!!u}function vl(i){if(!Le(i))return!1;var s=ot(i);return s==Kt||s==vt||typeof i.message=="string"&&typeof i.name=="string"&&!Ar(i)}function z0(i){return typeof i=="number"&&Ch(i)}function hn(i){if(!De(i))return!1;var s=ot(i);return s==hs||s==Ou||s==nn||s==gm}function qd(i){return typeof i=="number"&&i==ie(i)}function Js(i){return typeof i=="number"&&i>-1&&i%1==0&&i<=Pe}function De(i){var s=typeof i;return i!=null&&(s=="object"||s=="function")}function Le(i){return i!=null&&typeof i=="object"}var Gd=sh?wt(sh):Qy;function K0(i,s){return i===s||Ga(i,s,ll(s))}function Y0(i,s,l){return l=typeof l=="function"?l:t,Ga(i,s,ll(s),l)}function j0(i){return zd(i)&&i!=+i}function Q0(i){if(Pw(i))throw new te(a);return Uh(i)}function X0(i){return i===null}function J0(i){return i==null}function zd(i){return typeof i=="number"||Le(i)&&ot(i)==lr}function Ar(i){if(!Le(i)||ot(i)!=rn)return!1;var s=Ts(i);if(s===null)return!0;var l=ge.call(s,"constructor")&&s.constructor;return typeof l=="function"&&l instanceof l&&Es.call(l)==Yv}var yl=oh?wt(oh):Xy;function Z0(i){return qd(i)&&i>=-Pe&&i<=Pe}var Kd=ah?wt(ah):Jy;function Zs(i){return typeof i=="string"||!ne(i)&&Le(i)&&ot(i)==ur}function bt(i){return typeof i=="symbol"||Le(i)&&ot(i)==ds}var Ui=lh?wt(lh):Zy;function eb(i){return i===t}function tb(i){return Le(i)&&it(i)==hr}function nb(i){return Le(i)&&ot(i)==vm}var ib=Vs(Ka),rb=Vs(function(i,s){return i<=s});function Yd(i){if(!i)return[];if(ft(i))return Zs(i)?Bt(i):dt(i);if(pr&&i[pr])return Mv(i[pr]());var s=it(i),l=s==Ut?Da:s==Ft?vs:Fi;return l(i)}function dn(i){if(!i)return i===0?i:0;if(i=Dt(i),i===Ie||i===-Ie){var s=i<0?-1:1;return s*Mt}return i===i?i:0}function ie(i){var s=dn(i),l=s%1;return s===s?l?s-l:s:0}function jd(i){return i?ni(ie(i),0,$e):0}function Dt(i){if(typeof i=="number")return i;if(bt(i))return Tn;if(De(i)){var s=typeof i.valueOf=="function"?i.valueOf():i;i=De(s)?s+"":s}if(typeof i!="string")return i===0?i:+i;i=ph(i);var l=Bm.test(i);return l||Hm.test(i)?yv(i.slice(2),l?2:8):Fm.test(i)?Tn:+i}function Qd(i){return jt(i,pt(i))}function sb(i){return i?ni(ie(i),-Pe,Pe):i===0?i:0}function _e(i){return i==null?"":Et(i)}var ob=Di(function(i,s){if(Tr(s)||ft(s)){jt(s,Ge(s),i);return}for(var l in s)ge.call(s,l)&&yr(i,l,s[l])}),Xd=Di(function(i,s){jt(s,pt(s),i)}),eo=Di(function(i,s,l,u){jt(s,pt(s),i,u)}),ab=Di(function(i,s,l,u){jt(s,Ge(s),i,u)}),lb=cn(Wa);function cb(i,s){var l=Pi(i);return s==null?l:Nh(l,s)}var ub=se(function(i,s){i=Ee(i);var l=-1,u=s.length,f=u>2?s[2]:t;for(f&&at(s[0],s[1],f)&&(u=1);++l<u;)for(var g=s[l],m=pt(g),w=-1,I=m.length;++w<I;){var N=m[w],k=i[N];(k===t||Ht(k,ki[N])&&!ge.call(i,N))&&(i[N]=g[N])}return i}),hb=se(function(i){return i.push(t,pd),yt(Jd,t,i)});function db(i,s){return uh(i,K(s,3),Yt)}function fb(i,s){return uh(i,K(s,3),$a)}function pb(i,s){return i==null?i:Ha(i,K(s,3),pt)}function _b(i,s){return i==null?i:Dh(i,K(s,3),pt)}function gb(i,s){return i&&Yt(i,K(s,3))}function mb(i,s){return i&&$a(i,K(s,3))}function vb(i){return i==null?[]:Ls(i,Ge(i))}function yb(i){return i==null?[]:Ls(i,pt(i))}function wl(i,s,l){var u=i==null?t:ii(i,s);return u===t?l:u}function wb(i,s){return i!=null&&md(i,s,Vy)}function El(i,s){return i!=null&&md(i,s,qy)}var Eb=cd(function(i,s,l){s!=null&&typeof s.toString!="function"&&(s=bs.call(s)),i[s]=l},Il(_t)),bb=cd(function(i,s,l){s!=null&&typeof s.toString!="function"&&(s=bs.call(s)),ge.call(i,s)?i[s].push(l):i[s]=[l]},K),Ib=se(Er);function Ge(i){return ft(i)?Ah(i):za(i)}function pt(i){return ft(i)?Ah(i,!0):ew(i)}function Cb(i,s){var l={};return s=K(s,3),Yt(i,function(u,f,g){an(l,s(u,f,g),u)}),l}function Tb(i,s){var l={};return s=K(s,3),Yt(i,function(u,f,g){an(l,f,s(u,f,g))}),l}var Sb=Di(function(i,s,l){Ms(i,s,l)}),Jd=Di(function(i,s,l,u){Ms(i,s,l,u)}),Ab=cn(function(i,s){var l={};if(i==null)return l;var u=!1;s=xe(s,function(g){return g=Pn(g,i),u||(u=g.length>1),g}),jt(i,ol(i),l),u&&(l=Ot(l,v|b|C,Ew));for(var f=s.length;f--;)Ja(l,s[f]);return l});function Rb(i,s){return Zd(i,Xs(K(s)))}var Nb=cn(function(i,s){return i==null?{}:nw(i,s)});function Zd(i,s){if(i==null)return{};var l=xe(ol(i),function(u){return[u]});return s=K(s),qh(i,l,function(u,f){return s(u,f[0])})}function kb(i,s,l){s=Pn(s,i);var u=-1,f=s.length;for(f||(f=1,i=t);++u<f;){var g=i==null?t:i[Qt(s[u])];g===t&&(u=f,g=l),i=hn(g)?g.call(i):g}return i}function Ob(i,s,l){return i==null?i:Ir(i,s,l)}function xb(i,s,l,u){return u=typeof u=="function"?u:t,i==null?i:Ir(i,s,l,u)}var ef=dd(Ge),tf=dd(pt);function Pb(i,s,l){var u=ne(i),f=u||Ln(i)||Ui(i);if(s=K(s,4),l==null){var g=i&&i.constructor;f?l=u?new g:[]:De(i)?l=hn(g)?Pi(Ts(i)):{}:l={}}return(f?Rt:Yt)(i,function(m,w,I){return s(l,m,w,I)}),l}function Db(i,s){return i==null?!0:Ja(i,s)}function Lb(i,s,l){return i==null?i:jh(i,s,tl(l))}function Mb(i,s,l,u){return u=typeof u=="function"?u:t,i==null?i:jh(i,s,tl(l),u)}function Fi(i){return i==null?[]:Pa(i,Ge(i))}function Ub(i){return i==null?[]:Pa(i,pt(i))}function Fb(i,s,l){return l===t&&(l=s,s=t),l!==t&&(l=Dt(l),l=l===l?l:0),s!==t&&(s=Dt(s),s=s===s?s:0),ni(Dt(i),s,l)}function Bb(i,s,l){return s=dn(s),l===t?(l=s,s=0):l=dn(l),i=Dt(i),Gy(i,s,l)}function Wb(i,s,l){if(l&&typeof l!="boolean"&&at(i,s,l)&&(s=l=t),l===t&&(typeof s=="boolean"?(l=s,s=t):typeof i=="boolean"&&(l=i,i=t)),i===t&&s===t?(i=0,s=1):(i=dn(i),s===t?(s=i,i=0):s=dn(s)),i>s){var u=i;i=s,s=u}if(l||i%1||s%1){var f=Th();return nt(i+f*(s-i+vv("1e-"+((f+"").length-1))),s)}return ja(i,s)}var Hb=Li(function(i,s,l){return s=s.toLowerCase(),i+(l?nf(s):s)});function nf(i){return bl(_e(i).toLowerCase())}function rf(i){return i=_e(i),i&&i.replace(Vm,Ov).replace(lv,"")}function $b(i,s,l){i=_e(i),s=Et(s);var u=i.length;l=l===t?u:ni(ie(l),0,u);var f=l;return l-=s.length,l>=0&&i.slice(l,f)==s}function Vb(i){return i=_e(i),i&&Im.test(i)?i.replace(Du,xv):i}function qb(i){return i=_e(i),i&&Nm.test(i)?i.replace(ma,"\\$&"):i}var Gb=Li(function(i,s,l){return i+(l?"-":"")+s.toLowerCase()}),zb=Li(function(i,s,l){return i+(l?" ":"")+s.toLowerCase()}),Kb=od("toLowerCase");function Yb(i,s,l){i=_e(i),s=ie(s);var u=s?Ri(i):0;if(!s||u>=s)return i;var f=(s-u)/2;return $s(Ns(f),l)+i+$s(Rs(f),l)}function jb(i,s,l){i=_e(i),s=ie(s);var u=s?Ri(i):0;return s&&u<s?i+$s(s-u,l):i}function Qb(i,s,l){i=_e(i),s=ie(s);var u=s?Ri(i):0;return s&&u<s?$s(s-u,l)+i:i}function Xb(i,s,l){return l||s==null?s=0:s&&(s=+s),ry(_e(i).replace(va,""),s||0)}function Jb(i,s,l){return(l?at(i,s,l):s===t)?s=1:s=ie(s),Qa(_e(i),s)}function Zb(){var i=arguments,s=_e(i[0]);return i.length<3?s:s.replace(i[1],i[2])}var eI=Li(function(i,s,l){return i+(l?"_":"")+s.toLowerCase()});function tI(i,s,l){return l&&typeof l!="number"&&at(i,s,l)&&(s=l=t),l=l===t?$e:l>>>0,l?(i=_e(i),i&&(typeof s=="string"||s!=null&&!yl(s))&&(s=Et(s),!s&&Ai(i))?Dn(Bt(i),0,l):i.split(s,l)):[]}var nI=Li(function(i,s,l){return i+(l?" ":"")+bl(s)});function iI(i,s,l){return i=_e(i),l=l==null?0:ni(ie(l),0,i.length),s=Et(s),i.slice(l,l+s.length)==s}function rI(i,s,l){var u=_.templateSettings;l&&at(i,s,l)&&(s=t),i=_e(i),s=eo({},s,u,fd);var f=eo({},s.imports,u.imports,fd),g=Ge(f),m=Pa(f,g),w,I,N=0,k=s.interpolate||fs,O="__p += '",F=La((s.escape||fs).source+"|"+k.source+"|"+(k===Lu?Um:fs).source+"|"+(s.evaluate||fs).source+"|$","g"),G="//# sourceURL="+(ge.call(s,"sourceURL")?(s.sourceURL+"").replace(/\s/g," "):"lodash.templateSources["+ ++fv+"]")+`
`;i.replace(F,function(Q,le,de,It,lt,Ct){return de||(de=It),O+=i.slice(N,Ct).replace(qm,Pv),le&&(w=!0,O+=`' +
__e(`+le+`) +
'`),lt&&(I=!0,O+=`';
`+lt+`;
__p += '`),de&&(O+=`' +
((__t = (`+de+`)) == null ? '' : __t) +
'`),N=Ct+Q.length,Q}),O+=`';
`;var j=ge.call(s,"variable")&&s.variable;if(!j)O=`with (obj) {
`+O+`
}
`;else if(Lm.test(j))throw new te(h);O=(I?O.replace(ym,""):O).replace(wm,"$1").replace(Em,"$1;"),O="function("+(j||"obj")+`) {
`+(j?"":`obj || (obj = {});
`)+"var __t, __p = ''"+(w?", __e = _.escape":"")+(I?`, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
`:`;
`)+O+`return __p
}`;var re=of(function(){return fe(g,G+"return "+O).apply(t,m)});if(re.source=O,vl(re))throw re;return re}function sI(i){return _e(i).toLowerCase()}function oI(i){return _e(i).toUpperCase()}function aI(i,s,l){if(i=_e(i),i&&(l||s===t))return ph(i);if(!i||!(s=Et(s)))return i;var u=Bt(i),f=Bt(s),g=_h(u,f),m=gh(u,f)+1;return Dn(u,g,m).join("")}function lI(i,s,l){if(i=_e(i),i&&(l||s===t))return i.slice(0,vh(i)+1);if(!i||!(s=Et(s)))return i;var u=Bt(i),f=gh(u,Bt(s))+1;return Dn(u,0,f).join("")}function cI(i,s,l){if(i=_e(i),i&&(l||s===t))return i.replace(va,"");if(!i||!(s=Et(s)))return i;var u=Bt(i),f=_h(u,Bt(s));return Dn(u,f).join("")}function uI(i,s){var l=me,u=ve;if(De(s)){var f="separator"in s?s.separator:f;l="length"in s?ie(s.length):l,u="omission"in s?Et(s.omission):u}i=_e(i);var g=i.length;if(Ai(i)){var m=Bt(i);g=m.length}if(l>=g)return i;var w=l-Ri(u);if(w<1)return u;var I=m?Dn(m,0,w).join(""):i.slice(0,w);if(f===t)return I+u;if(m&&(w+=I.length-w),yl(f)){if(i.slice(w).search(f)){var N,k=I;for(f.global||(f=La(f.source,_e(Mu.exec(f))+"g")),f.lastIndex=0;N=f.exec(k);)var O=N.index;I=I.slice(0,O===t?w:O)}}else if(i.indexOf(Et(f),w)!=w){var F=I.lastIndexOf(f);F>-1&&(I=I.slice(0,F))}return I+u}function hI(i){return i=_e(i),i&&bm.test(i)?i.replace(Pu,Wv):i}var dI=Li(function(i,s,l){return i+(l?" ":"")+s.toUpperCase()}),bl=od("toUpperCase");function sf(i,s,l){return i=_e(i),s=l?t:s,s===t?Lv(i)?Vv(i):Sv(i):i.match(s)||[]}var of=se(function(i,s){try{return yt(i,t,s)}catch(l){return vl(l)?l:new te(l)}}),fI=cn(function(i,s){return Rt(s,function(l){l=Qt(l),an(i,l,gl(i[l],i))}),i});function pI(i){var s=i==null?0:i.length,l=K();return i=s?xe(i,function(u){if(typeof u[1]!="function")throw new Nt(c);return[l(u[0]),u[1]]}):[],se(function(u){for(var f=-1;++f<s;){var g=i[f];if(yt(g[0],this,u))return yt(g[1],this,u)}})}function _I(i){return Wy(Ot(i,v))}function Il(i){return function(){return i}}function gI(i,s){return i==null||i!==i?s:i}var mI=ld(),vI=ld(!0);function _t(i){return i}function Cl(i){return Fh(typeof i=="function"?i:Ot(i,v))}function yI(i){return Wh(Ot(i,v))}function wI(i,s){return Hh(i,Ot(s,v))}var EI=se(function(i,s){return function(l){return Er(l,i,s)}}),bI=se(function(i,s){return function(l){return Er(i,l,s)}});function Tl(i,s,l){var u=Ge(s),f=Ls(s,u);l==null&&!(De(s)&&(f.length||!u.length))&&(l=s,s=i,i=this,f=Ls(s,Ge(s)));var g=!(De(l)&&"chain"in l)||!!l.chain,m=hn(i);return Rt(f,function(w){var I=s[w];i[w]=I,m&&(i.prototype[w]=function(){var N=this.__chain__;if(g||N){var k=i(this.__wrapped__),O=k.__actions__=dt(this.__actions__);return O.push({func:I,args:arguments,thisArg:i}),k.__chain__=N,k}return I.apply(i,Rn([this.value()],arguments))})}),i}function II(){return Xe._===this&&(Xe._=jv),this}function Sl(){}function CI(i){return i=ie(i),se(function(s){return $h(s,i)})}var TI=il(xe),SI=il(ch),AI=il(Ra);function af(i){return ul(i)?Na(Qt(i)):iw(i)}function RI(i){return function(s){return i==null?t:ii(i,s)}}var NI=ud(),kI=ud(!0);function Al(){return[]}function Rl(){return!1}function OI(){return{}}function xI(){return""}function PI(){return!0}function DI(i,s){if(i=ie(i),i<1||i>Pe)return[];var l=$e,u=nt(i,$e);s=K(s),i-=$e;for(var f=xa(u,s);++l<i;)s(l);return f}function LI(i){return ne(i)?xe(i,Qt):bt(i)?[i]:dt(Sd(_e(i)))}function MI(i){var s=++Kv;return _e(i)+s}var UI=Hs(function(i,s){return i+s},0),FI=rl("ceil"),BI=Hs(function(i,s){return i/s},1),WI=rl("floor");function HI(i){return i&&i.length?Ds(i,_t,Va):t}function $I(i,s){return i&&i.length?Ds(i,K(s,2),Va):t}function VI(i){return dh(i,_t)}function qI(i,s){return dh(i,K(s,2))}function GI(i){return i&&i.length?Ds(i,_t,Ka):t}function zI(i,s){return i&&i.length?Ds(i,K(s,2),Ka):t}var KI=Hs(function(i,s){return i*s},1),YI=rl("round"),jI=Hs(function(i,s){return i-s},0);function QI(i){return i&&i.length?Oa(i,_t):0}function XI(i,s){return i&&i.length?Oa(i,K(s,2)):0}return _.after=y0,_.ary=Ud,_.assign=ob,_.assignIn=Xd,_.assignInWith=eo,_.assignWith=ab,_.at=lb,_.before=Fd,_.bind=gl,_.bindAll=fI,_.bindKey=Bd,_.castArray=O0,_.chain=Dd,_.chunk=Ww,_.compact=Hw,_.concat=$w,_.cond=pI,_.conforms=_I,_.constant=Il,_.countBy=QE,_.create=cb,_.curry=Wd,_.curryRight=Hd,_.debounce=$d,_.defaults=ub,_.defaultsDeep=hb,_.defer=w0,_.delay=E0,_.difference=Vw,_.differenceBy=qw,_.differenceWith=Gw,_.drop=zw,_.dropRight=Kw,_.dropRightWhile=Yw,_.dropWhile=jw,_.fill=Qw,_.filter=JE,_.flatMap=t0,_.flatMapDeep=n0,_.flatMapDepth=i0,_.flatten=kd,_.flattenDeep=Xw,_.flattenDepth=Jw,_.flip=b0,_.flow=mI,_.flowRight=vI,_.fromPairs=Zw,_.functions=vb,_.functionsIn=yb,_.groupBy=r0,_.initial=tE,_.intersection=nE,_.intersectionBy=iE,_.intersectionWith=rE,_.invert=Eb,_.invertBy=bb,_.invokeMap=o0,_.iteratee=Cl,_.keyBy=a0,_.keys=Ge,_.keysIn=pt,_.map=Ys,_.mapKeys=Cb,_.mapValues=Tb,_.matches=yI,_.matchesProperty=wI,_.memoize=Qs,_.merge=Sb,_.mergeWith=Jd,_.method=EI,_.methodOf=bI,_.mixin=Tl,_.negate=Xs,_.nthArg=CI,_.omit=Ab,_.omitBy=Rb,_.once=I0,_.orderBy=l0,_.over=TI,_.overArgs=C0,_.overEvery=SI,_.overSome=AI,_.partial=ml,_.partialRight=Vd,_.partition=c0,_.pick=Nb,_.pickBy=Zd,_.property=af,_.propertyOf=RI,_.pull=lE,_.pullAll=xd,_.pullAllBy=cE,_.pullAllWith=uE,_.pullAt=hE,_.range=NI,_.rangeRight=kI,_.rearg=T0,_.reject=d0,_.remove=dE,_.rest=S0,_.reverse=pl,_.sampleSize=p0,_.set=Ob,_.setWith=xb,_.shuffle=_0,_.slice=fE,_.sortBy=v0,_.sortedUniq=wE,_.sortedUniqBy=EE,_.split=tI,_.spread=A0,_.tail=bE,_.take=IE,_.takeRight=CE,_.takeRightWhile=TE,_.takeWhile=SE,_.tap=HE,_.throttle=R0,_.thru=Ks,_.toArray=Yd,_.toPairs=ef,_.toPairsIn=tf,_.toPath=LI,_.toPlainObject=Qd,_.transform=Pb,_.unary=N0,_.union=AE,_.unionBy=RE,_.unionWith=NE,_.uniq=kE,_.uniqBy=OE,_.uniqWith=xE,_.unset=Db,_.unzip=_l,_.unzipWith=Pd,_.update=Lb,_.updateWith=Mb,_.values=Fi,_.valuesIn=Ub,_.without=PE,_.words=sf,_.wrap=k0,_.xor=DE,_.xorBy=LE,_.xorWith=ME,_.zip=UE,_.zipObject=FE,_.zipObjectDeep=BE,_.zipWith=WE,_.entries=ef,_.entriesIn=tf,_.extend=Xd,_.extendWith=eo,Tl(_,_),_.add=UI,_.attempt=of,_.camelCase=Hb,_.capitalize=nf,_.ceil=FI,_.clamp=Fb,_.clone=x0,_.cloneDeep=D0,_.cloneDeepWith=L0,_.cloneWith=P0,_.conformsTo=M0,_.deburr=rf,_.defaultTo=gI,_.divide=BI,_.endsWith=$b,_.eq=Ht,_.escape=Vb,_.escapeRegExp=qb,_.every=XE,_.find=ZE,_.findIndex=Rd,_.findKey=db,_.findLast=e0,_.findLastIndex=Nd,_.findLastKey=fb,_.floor=WI,_.forEach=Ld,_.forEachRight=Md,_.forIn=pb,_.forInRight=_b,_.forOwn=gb,_.forOwnRight=mb,_.get=wl,_.gt=U0,_.gte=F0,_.has=wb,_.hasIn=El,_.head=Od,_.identity=_t,_.includes=s0,_.indexOf=eE,_.inRange=Bb,_.invoke=Ib,_.isArguments=oi,_.isArray=ne,_.isArrayBuffer=B0,_.isArrayLike=ft,_.isArrayLikeObject=We,_.isBoolean=W0,_.isBuffer=Ln,_.isDate=H0,_.isElement=$0,_.isEmpty=V0,_.isEqual=q0,_.isEqualWith=G0,_.isError=vl,_.isFinite=z0,_.isFunction=hn,_.isInteger=qd,_.isLength=Js,_.isMap=Gd,_.isMatch=K0,_.isMatchWith=Y0,_.isNaN=j0,_.isNative=Q0,_.isNil=J0,_.isNull=X0,_.isNumber=zd,_.isObject=De,_.isObjectLike=Le,_.isPlainObject=Ar,_.isRegExp=yl,_.isSafeInteger=Z0,_.isSet=Kd,_.isString=Zs,_.isSymbol=bt,_.isTypedArray=Ui,_.isUndefined=eb,_.isWeakMap=tb,_.isWeakSet=nb,_.join=sE,_.kebabCase=Gb,_.last=Pt,_.lastIndexOf=oE,_.lowerCase=zb,_.lowerFirst=Kb,_.lt=ib,_.lte=rb,_.max=HI,_.maxBy=$I,_.mean=VI,_.meanBy=qI,_.min=GI,_.minBy=zI,_.stubArray=Al,_.stubFalse=Rl,_.stubObject=OI,_.stubString=xI,_.stubTrue=PI,_.multiply=KI,_.nth=aE,_.noConflict=II,_.noop=Sl,_.now=js,_.pad=Yb,_.padEnd=jb,_.padStart=Qb,_.parseInt=Xb,_.random=Wb,_.reduce=u0,_.reduceRight=h0,_.repeat=Jb,_.replace=Zb,_.result=kb,_.round=YI,_.runInContext=E,_.sample=f0,_.size=g0,_.snakeCase=eI,_.some=m0,_.sortedIndex=pE,_.sortedIndexBy=_E,_.sortedIndexOf=gE,_.sortedLastIndex=mE,_.sortedLastIndexBy=vE,_.sortedLastIndexOf=yE,_.startCase=nI,_.startsWith=iI,_.subtract=jI,_.sum=QI,_.sumBy=XI,_.template=rI,_.times=DI,_.toFinite=dn,_.toInteger=ie,_.toLength=jd,_.toLower=sI,_.toNumber=Dt,_.toSafeInteger=sb,_.toString=_e,_.toUpper=oI,_.trim=aI,_.trimEnd=lI,_.trimStart=cI,_.truncate=uI,_.unescape=hI,_.uniqueId=MI,_.upperCase=dI,_.upperFirst=bl,_.each=Ld,_.eachRight=Md,_.first=Od,Tl(_,function(){var i={};return Yt(_,function(s,l){ge.call(_.prototype,l)||(i[l]=s)}),i}(),{chain:!1}),_.VERSION=r,Rt(["bind","bindKey","curry","curryRight","partial","partialRight"],function(i){_[i].placeholder=_}),Rt(["drop","take"],function(i,s){he.prototype[i]=function(l){l=l===t?1:qe(ie(l),0);var u=this.__filtered__&&!s?new he(this):this.clone();return u.__filtered__?u.__takeCount__=nt(l,u.__takeCount__):u.__views__.push({size:nt(l,$e),type:i+(u.__dir__<0?"Right":"")}),u},he.prototype[i+"Right"]=function(l){return this.reverse()[i](l).reverse()}}),Rt(["filter","map","takeWhile"],function(i,s){var l=s+1,u=l==Z||l==be;he.prototype[i]=function(f){var g=this.clone();return g.__iteratees__.push({iteratee:K(f,3),type:l}),g.__filtered__=g.__filtered__||u,g}}),Rt(["head","last"],function(i,s){var l="take"+(s?"Right":"");he.prototype[i]=function(){return this[l](1).value()[0]}}),Rt(["initial","tail"],function(i,s){var l="drop"+(s?"":"Right");he.prototype[i]=function(){return this.__filtered__?new he(this):this[l](1)}}),he.prototype.compact=function(){return this.filter(_t)},he.prototype.find=function(i){return this.filter(i).head()},he.prototype.findLast=function(i){return this.reverse().find(i)},he.prototype.invokeMap=se(function(i,s){return typeof i=="function"?new he(this):this.map(function(l){return Er(l,i,s)})}),he.prototype.reject=function(i){return this.filter(Xs(K(i)))},he.prototype.slice=function(i,s){i=ie(i);var l=this;return l.__filtered__&&(i>0||s<0)?new he(l):(i<0?l=l.takeRight(-i):i&&(l=l.drop(i)),s!==t&&(s=ie(s),l=s<0?l.dropRight(-s):l.take(s-i)),l)},he.prototype.takeRightWhile=function(i){return this.reverse().takeWhile(i).reverse()},he.prototype.toArray=function(){return this.take($e)},Yt(he.prototype,function(i,s){var l=/^(?:filter|find|map|reject)|While$/.test(s),u=/^(?:head|last)$/.test(s),f=_[u?"take"+(s=="last"?"Right":""):s],g=u||/^find/.test(s);f&&(_.prototype[s]=function(){var m=this.__wrapped__,w=u?[1]:arguments,I=m instanceof he,N=w[0],k=I||ne(m),O=function(le){var de=f.apply(_,Rn([le],w));return u&&F?de[0]:de};k&&l&&typeof N=="function"&&N.length!=1&&(I=k=!1);var F=this.__chain__,G=!!this.__actions__.length,j=g&&!F,re=I&&!G;if(!g&&k){m=re?m:new he(this);var Q=i.apply(m,w);return Q.__actions__.push({func:Ks,args:[O],thisArg:t}),new kt(Q,F)}return j&&re?i.apply(this,w):(Q=this.thru(O),j?u?Q.value()[0]:Q.value():Q)})}),Rt(["pop","push","shift","sort","splice","unshift"],function(i){var s=ys[i],l=/^(?:push|sort|unshift)$/.test(i)?"tap":"thru",u=/^(?:pop|shift)$/.test(i);_.prototype[i]=function(){var f=arguments;if(u&&!this.__chain__){var g=this.value();return s.apply(ne(g)?g:[],f)}return this[l](function(m){return s.apply(ne(m)?m:[],f)})}}),Yt(he.prototype,function(i,s){var l=_[s];if(l){var u=l.name+"";ge.call(xi,u)||(xi[u]=[]),xi[u].push({name:s,func:l})}}),xi[Ws(t,Y).name]=[{name:"wrapper",func:t}],he.prototype.clone=hy,he.prototype.reverse=dy,he.prototype.value=fy,_.prototype.at=$E,_.prototype.chain=VE,_.prototype.commit=qE,_.prototype.next=GE,_.prototype.plant=KE,_.prototype.reverse=YE,_.prototype.toJSON=_.prototype.valueOf=_.prototype.value=jE,_.prototype.first=_.prototype.head,pr&&(_.prototype[pr]=zE),_},Ni=qv();Jn?((Jn.exports=Ni)._=Ni,Ca._=Ni):Xe._=Ni}).call(et)})(Fo,Fo.exports);var $O=Fo.exports;const us=n=>(Fp("data-v-5e73cad0"),n=n(),Bp(),n),VO=["id"],qO={class:"card-header bg-body px-1 d-flex align-items-center px-2 px-md-0"},GO={class:"rounded-circle user-pic"},zO=["src"],KO={class:"ms-2 fw-bold"},YO=["id","onDblclick"],jO=us(()=>q("svg",{xmlns:"http://www.w3.org/2000/svg",width:"50",height:"50",fill:"currentColor",class:"bi bi-heart-fill text-danger",viewBox:"0 0 16 16"},[q("path",{"fill-rule":"evenodd",d:"M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314"})],-1)),QO=[jO],XO={key:0,class:"carousel-indicators"},JO=["data-bs-target","data-bs-slide-to","aria-current","aria-label"],ZO=["src"],ex=["src"],tx={controls:"",class:"d-block w-100"},nx=["src"],ix=["data-bs-target"],rx=us(()=>q("span",{class:"carousel-control-prev-icon","aria-hidden":"true"},null,-1)),sx=us(()=>q("span",{class:"visually-hidden"},"Previous",-1)),ox=[rx,sx],ax=["data-bs-target"],lx=us(()=>q("span",{class:"carousel-control-next-icon","aria-hidden":"true"},null,-1)),cx=us(()=>q("span",{class:"visually-hidden"},"Next",-1)),ux=[lx,cx],hx={class:"card-body px-sm-0 py-1 mb-1"},dx=["onClick"],fx={key:0,class:"bi bi-heart icon-size text-danger"},px={key:1,class:"bi bi-heart-fill icon-size text-danger"},_x={key:0},gx={class:"card-text d-inline fw-bold"},mx={class:"card-text ms-2 d-inline"},vx=["onClick"],yx={class:"position-relative"},wx=["id","onUpdate:modelValue"],Ex=["onClick"],bx={key:0,class:"m-0"},Ix={__name:"postComponent",props:{postDataList:Array,postIdDirection:String},setup(n){const e=n,t=Ke(e.postDataList),r=tC(()=>{const W=[...t.value];return W.sort((B,L)=>new Date(L.timestamp)-new Date(B.timestamp)),W});nC(()=>e.postDataList,(W,B)=>{t.value=W});const o=Ke(new Set),a=W=>{o.value.has(W)?o.value.delete(W):o.value.add(W)},c=W=>o.value.has(W),h=(W,B)=>{if(W)return c(B)?W:W.slice(0,20)},d=Ke(window.innerWidth>=768),p=()=>{d.value=window.innerWidth>=768};nc(()=>{window.addEventListener("resize",p)}),iC(()=>{window.removeEventListener("resize",p)});const y=Ke([]);nc(()=>{const W=Qr(Jr,"userData");gg(W,B=>{const L=[];B.forEach(V=>{const x=V.key,D=V.val();L.push({key:x,...D})}),y.value=L})});let v=!1;const b=W=>{for(const B in y.value)if(v=y.value[B].id===W.postownerid,v)return y.value[B].media_url;return""},C=Ke({}),A=W=>{console.log(W),console.log(C.value[W])},U=Ke({}),P=Ke({}),Y=$O.debounce(function(W){W.isThumb=!W.isThumb;const B=Qr(Jr,`postsData/${W.key}`);xR(B,W).then(()=>{console.log("Data updated successfully!")}).catch(L=>{console.error("Error updating data:",L)}),U.value[W.id]=W.isThumb,P.value[W.id]&&clearTimeout(P.value[W.id]),P.value[W.id]=setTimeout(()=>{U.value[W.id]=!1},2e3)},300);return(W,B)=>(Ne(!0),ke(Dr,null,kl(r.value,(L,V)=>(Ne(),ke("div",{class:"card mt-3 post-card w-100 border-0",key:L.id,id:L.id},[q("div",qO,[q("div",GO,[q("img",{src:b(L),alt:""},null,8,zO)]),q("div",KO,co(L.username),1)]),q("div",{id:"post"+L.id,class:"carousel slide post-pic-area position-relative",onDblclick:x=>_o(Y)(L)},[q("div",{class:lo(["position-absolute heartAnimationDefault",U.value[L.id]?"heartAnimation":""])},QO,2),L.media_type==="CAROUSEL_ALBUM"?(Ne(),ke("div",XO,[(Ne(!0),ke(Dr,null,kl(L.media_children.length,(x,D)=>(Ne(),ke("div",{key:D},[q("button",{class:lo({active:D===0}),type:"button","data-bs-target":"#post"+L.id,"data-bs-slide-to":D,"aria-current":D===1,"aria-label":"Slide"+D},null,10,JO)]))),128))])):ut("",!0),L.media_type==="IMAGE"?(Ne(),ke("div",{key:1,class:"carousel-inner position-relative",ref_for:!0,ref:"postImg"},[q("img",{src:L.media_url,class:"d-block w-100",alt:"..."},null,8,ZO)],512)):ut("",!0),L.media_type==="CAROUSEL_ALBUM"?(Ne(),ke("div",{key:2,class:"carousel-inner position-relative",ref_for:!0,ref:"postImg"},[(Ne(!0),ke(Dr,null,kl(L.media_children,(x,D)=>(Ne(),ke("div",{class:lo(["carousel-item",{active:D===0}]),key:D},[q("img",{src:x,class:"d-block w-100",alt:"..."},null,8,ex)],2))),128))],512)):ut("",!0),L.media_type==="VIDEO"?(Ne(),ke("div",{key:3,class:"carousel-inner position-relative",ref_for:!0,ref:"postImg"},[q("video",tx,[q("source",{src:L.media_url,type:"video/webm"},null,8,nx)])],512)):ut("",!0),L.media_type==="CAROUSEL_ALBUM"?(Ne(),ke("button",{key:4,class:"carousel-control-prev",type:"button","data-bs-target":"#post"+L.id,"data-bs-slide":"prev"},ox,8,ix)):ut("",!0),L.media_type==="CAROUSEL_ALBUM"?(Ne(),ke("button",{key:5,class:"carousel-control-next",type:"button","data-bs-target":"#post"+L.id,"data-bs-slide":"next"},ux,8,ax)):ut("",!0)],40,YO),q("div",hx,[q("a",{href:"",onClick:ui(x=>_o(Y)(L),["prevent"])},[L.isThumb?ut("",!0):(Ne(),ke("i",fx)),L.isThumb?(Ne(),ke("i",px)):ut("",!0)],8,dx),L.caption?(Ne(),ke("div",_x,[q("span",gx,co(L.username),1),q("div",mx,co(h(L.caption,L.id)),1),!c(L.id)&&L.caption&&L.caption.length>20?(Ne(),ke("a",{key:0,class:"text-decoration-none text-secondary fs-6",onClick:ui(x=>a(L.id),["prevent"]),href:"#"}," ...更多 ",8,vx)):ut("",!0)])):ut("",!0),q("div",yx,[Mp(q("input",{type:"text",placeholder:"留言...",class:"w-100 border-0 my-1 py-1 postMessage",id:"#message"+L.id,"onUpdate:modelValue":x=>C.value[L.id]=x},null,8,wx),[[Up,C.value[L.id]]]),C.value[L.id]?(Ne(),ke("a",{key:0,type:"button",class:"position-absolute top-50 end-0 translate-middle-y text-decoration-none",onClick:ui(x=>A(L.id),["prevent"])},"發布",8,Ex)):ut("",!0)])]),V!=t.value.length-1&&d.value?(Ne(),ke("hr",bx)):ut("",!0)],8,VO))),128))}},Rx=Dp(Ix,[["__scopeId","data-v-5e73cad0"]]);export{hO as M,Ax as _,Sx as a,Jr as d,gg as o,Rx as p,Qr as r,Tx as s,dO as u};
