import{c as ue,a as Sa,_ as Na,r as Ie,o as Ra,b as Fe,d as Ue,e as S,j as Rn,p as Aa,v as Da,A as ka,B as xa,C as Oa,m as qt,D as An,k as Pa,F as Ma}from"./index-MA9n4Vjl.js";var fi={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bd(n,e,t){let s=1,i=null,r=null,o=!1,a=0;function l(){return a===2}let c=!1;function h(...g){c||(c=!0,e.apply(null,g))}function u(g){i=setTimeout(()=>{i=null,n(f,l())},g)}function d(){r&&clearTimeout(r)}function f(g,...w){if(c){d();return}if(g){d(),h.call(null,g,...w);return}if(l()||o){d(),h.call(null,g,...w);return}s<64&&(s*=2);let N;a===1?(a=2,N=0):N=(s+Math.random())*1e3,u(N)}let p=!1;function y(g){p||(p=!0,d(),!c&&(i!==null?(g||(a=2),clearTimeout(i),u(0)):g||(a=1)))}return u(0),r=setTimeout(()=>{o=!0,y(!0)},t),y}function Wd(n){n(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const ya="storage";function Df(n,e,t){return n=ye(n),wf(n,e,t)}function kf(n){return n=ye(n),Tf(n)}function xf(n,e){return n=ye(n),Rf(n,e)}function va(n=Wr(),e){n=ye(n);const s=Fr(n,ya).getImmediate({identifier:e}),i=Nr("storage");return i&&Of(s,...i),s}function Of(n,e,t,s={}){Af(n,e,t,s)}function Pf(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),s=n.getProvider("auth-internal"),i=n.getProvider("app-check-internal");return new ci(t,s,i,e,Ur)}function Mf(){Dt(new rt(ya,Pf,"PUBLIC").setMultipleInstances(!0)),De(cr,ur,""),De(cr,ur,"esm2017")}Mf();const Lf={apiKey:"AIzaSyD1bUd4QHmDnXtuA1SZgvxiaRcmuEVLpWo",authDomain:"instagram-imitation-180e8.firebaseapp.com",databaseURL:"https://instagram-imitation-180e8-default-rtdb.firebaseio.com",projectId:"instagram-imitation-180e8",storageBucket:"instagram-imitation-180e8.appspot.com",messagingSenderId:"266282768545",appId:"1:266282768545:web:07dbf92d25e2a93b3078e0"},ui=Br(Lf),Ff=vd(ui);va(ui);const Uf="/Instagram-Imitation/assets/Instagram_logo_light-WGj1KLTg.png";var Ea={exports:{}},Qt={exports:{}};/*!
  ...
  * Copyright 2011-2022 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
  */var pr;function Bf(){return pr||(pr=1,function(n,e){(function(t,s){n.exports=s(hi(),ba(),Pe())})(ue,function(t,s,i){const r=f=>f&&typeof f=="object"&&"default"in f?f:{default:f},o=r(t),a=r(s),l=".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",c=".sticky-top",h="padding-right",u="margin-right";class d{constructor(){this._element=document.body}getWidth(){const p=document.documentElement.clientWidth;return Math.abs(window.innerWidth-p)}hide(){const p=this.getWidth();this._disableOverFlow(),this._setElementAttributes(this._element,h,y=>y+p),this._setElementAttributes(l,h,y=>y+p),this._setElementAttributes(c,u,y=>y-p)}reset(){this._resetElementAttributes(this._element,"overflow"),this._resetElementAttributes(this._element,h),this._resetElementAttributes(l,h),this._resetElementAttributes(c,u)}isOverflowing(){return this.getWidth()>0}_disableOverFlow(){this._saveInitialAttribute(this._element,"overflow"),this._element.style.overflow="hidden"}_setElementAttributes(p,y,g){const w=this.getWidth(),P=N=>{if(N!==this._element&&window.innerWidth>N.clientWidth+w)return;this._saveInitialAttribute(N,y);const x=window.getComputedStyle(N).getPropertyValue(y);N.style.setProperty(y,`${g(Number.parseFloat(x))}px`)};this._applyManipulationCallback(p,P)}_saveInitialAttribute(p,y){const g=p.style.getPropertyValue(y);g&&a.default.setDataAttribute(p,y,g)}_resetElementAttributes(p,y){const g=w=>{const P=a.default.getDataAttribute(w,y);if(P===null){w.style.removeProperty(y);return}a.default.removeDataAttribute(w,y),w.style.setProperty(y,P)};this._applyManipulationCallback(p,g)}_applyManipulationCallback(p,y){if(i.isElement(p)){y(p);return}for(const g of o.default.find(p,this._element))y(g)}}return d})}(qn)),qn.exports}var Gn={exports:{}},Kn={exports:{}};/*!
  ...
  * Copyright 2011-2022 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
  */var vr;function $f(){return vr||(vr=1,function(n,e){(function(t,s){n.exports=s(jt(),Pe(),di())})(ue,function(t,s,i){const r=y=>y&&typeof y=="object"&&"default"in y?y:{default:y},o=r(t),a=r(i),l="backdrop",c="fade",h="show",u=`mousedown.bs.${l}`,d={className:"modal-backdrop",clickCallback:null,isAnimated:!1,isVisible:!0,rootElement:"body"},f={className:"string",clickCallback:"(function|null)",isAnimated:"boolean",isVisible:"boolean",rootElement:"(element|string)"};class p extends a.default{constructor(g){super(),this._config=this._getConfig(g),this._isAppended=!1,this._element=null}static get Default(){return d}static get DefaultType(){return f}static get NAME(){return l}show(g){if(!this._config.isVisible){s.execute(g);return}this._append();const w=this._getElement();this._config.isAnimated&&s.reflow(w),w.classList.add(h),this._emulateAnimation(()=>{s.execute(g)})}hide(g){if(!this._config.isVisible){s.execute(g);return}this._getElement().classList.remove(h),this._emulateAnimation(()=>{this.dispose(),s.execute(g)})}dispose(){this._isAppended&&(o.default.off(this._element,u),this._element.remove(),this._isAppended=!1)}_getElement(){if(!this._element){const g=document.createElement("div");g.className=this._config.className,this._config.isAnimated&&g.classList.add(c),this._element=g}return this._element}_configAfterMerge(g){return g.rootElement=s.getElement(g.rootElement),g}_append(){if(this._isAppended)return;const g=this._getElement();this._config.rootElement.append(g),o.default.on(g,u,()=>{s.execute(this._config.clickCallback)}),this._isAppended=!0}_emulateAnimation(g){s.executeAfterTransition(g,this._getElement(),this._config.isAnimated)}}return p})}(Qn)),Qn.exports}var Xn={exports:{}};/*!
  * Bootstrap focustrap.js v5.2.3 (https://getbootstrap.com/)
  * Copyright 2011-2022 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
  */var Er;function Vf(){return Er||(Er=1,function(n,e){(function(t,s){n.exports=s(jt(),hi(),di())})(ue,function(t,s,i){const r=x=>x&&typeof x=="object"&&"default"in x?x:{default:x},o=r(t),a=r(s),l=r(i),c="focustrap",u=".bs.focustrap",d=`focusin${u}`,f=`keydown.tab${u}`,p="Tab",y="forward",g="backward",w={autofocus:!0,trapElement:null},P={autofocus:"boolean",trapElement:"element"};class N extends l.default{constructor(F){super(),this._config=this._getConfig(F),this._isActive=!1,this._lastTabNavDirection=null}static get Default(){return w}static get DefaultType(){return P}static get NAME(){return c}activate(){this._isActive||(this._config.autofocus&&this._config.trapElement.focus(),o.default.off(document,u),o.default.on(document,d,F=>this._handleFocusin(F)),o.default.on(document,f,F=>this._handleKeydown(F)),this._isActive=!0)}deactivate(){this._isActive&&(this._isActive=!1,o.default.off(document,u))}_handleFocusin(F){const{trapElement:v}=this._config;if(F.target===document||F.target===v||v.contains(F.target))return;const E=a.default.focusableChildren(v);E.length===0?v.focus():this._lastTabNavDirection===g?E[E.length-1].focus():E[0].focus()}_handleKeydown(F){F.key===p&&(this._lastTabNavDirection=F.shiftKey?g:y)}}return N})}(Xn)),Xn.exports}var Xt={exports:{}};/*!
